...
varErrorText = replace(err_txt_004, "#nylinie#", "<br>")
 ...
 case 5
  ...
  varErrorText = "<h4>Your session has expired <br><span style='font-size:11px;'> Sessionen er udløbet.</span></h4>"_
  ...
  &"Sessionen udløber ud hvis TimeOut har været passiv i mere end 12 timer, "_
...
case 201
varErrorText = err_txt_565

case 202
varErrorText = err_txt_566
