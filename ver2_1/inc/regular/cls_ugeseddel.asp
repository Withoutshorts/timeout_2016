                        ...
                        'end if
                         ...
                         <!--  <td valign=top style="border-bottom:1px #cccccc solid;"><%=left(oRec("tmnavn"), 10) %> 
                           ...
                           <td style="text-align:right">
                                ...
                                if (((ugeerAfsl_og_autogk_smil = 0 AND cint(ugegodkendt) <> 1) OR (level = 1)) AND media <> "print") then%>
                                    <a href="#" onclick="Javascript:window.open('rediger_tastede_dage_2006.asp?id=<%=oRec("tid") %>', '', 'width=650,height=600,resizable=yes,scrollbars=no')" class=vmenu><%=formatnumber(oRec("timer"), 2) %></a>
