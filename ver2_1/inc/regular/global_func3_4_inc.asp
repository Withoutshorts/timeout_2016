   ...
   if media <> "export" then%>
    ...
    <td colspan=6>
	 ...
	 <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=afstem_txt_116 %> <br> >> <%=afstem_txt_117 %></b><br />~ <%=afstem_txt_044 %></td>
	  ...
	  <td valign=bottom align=right style="border-bottom:1px silver dashed;" class=lille><%if lto <> "esn" then %><b><%=tsa_txt_282 &" "& tsa_txt_280 %></b><%else %><b>Særlige ferie. Saldo</b><%end if %><br />~ <%=afstem_txt_044 %></td>
