  ...
  <%if (lto <> "cst" AND lto <> "tec") AND instr(akttype_sel, "#13#") <> 0 then 
   ...
   if media <> "export" then%>
    ...
    <td colspan=6>
	 ...
	 <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=afstem_txt_096 %> <br> >> dd.</b><br />~ <%=afstem_txt_044 %></td>
	  ...
	  <td valign=bottom align=right style="border-bottom:1px silver dashed;" class=lille><b><%=tsa_txt_165%></b><br />~ <%=afstem_txt_044 %></td>
	   ...
	   <td valign=bottom align=right style="border-bottom:1px silver dashed;" class=lille><b><%=afstem_txt_008 %></b><br />~ <%=afstem_txt_044 %></td>
	 ...
	 <tr>
	 <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=tsa_txt_152%> <%=tsa_txt_022%></b><br /><%=afstem_txt_044 %></td>
     ...
     <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=tsa_txt_317%><br> >> dd.</b><br /><%=afstem_txt_044 %></td>
	 <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=afstem_txt_112 %></b><br /><%=afstem_txt_044 %></td>
	   <td valign=bottom align=right class=lille style="border-bottom:1px silver dashed;"><b><%=afstem_txt_105 %></b><br /><%=afstem_txt_044 %></td>
	   <td valign=bottom align=right style="border-bottom:1px silver dashed;" class=lille><b><%=afstem_txt_008 %></b><br /><%=afstem_txt_044 %></td>
