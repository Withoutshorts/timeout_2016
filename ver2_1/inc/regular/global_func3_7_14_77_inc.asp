    ...
    '*** Aldersreduktion *****
                           ...
                           if visning = 77 or (visning = 7 and lto = "esn") then 'Kun på afstembning udspec. dage   + ugeseddel
                                 ...
                                 aldersreduktionUdbTxtExp = 0
                                   ...
                                   if visning = 77  then
                                         ...
                                         <td class=lille style="border-bottom:1px silver solid; border-right:1px silver solid; white-space:nowrap;" align=right>Her<%=aldersreduktionUdbTxt %></td>
	 ...
	 ferieFriAfVal_md_tot = ferieFriAfVal_md_tot + ferieFriAfVal_md
	  ...
	  %>
                        ...
                        '**** Kommentar på måneds/uge godkend
                        if visning = 14 then
