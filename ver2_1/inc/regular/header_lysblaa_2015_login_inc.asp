...
<head>
	<title>TimeOut - Tid, Overblik & Fakturering log test</title>
  ...
  <meta name="author" content="">
    ...
    <link href="../inc/menu/css/chronograph.css" rel="stylesheet" type="text/css" />
     ...
     <!-- Google Font: Open Sans -->
      ...
      <!-- Font Awesome CSS -->
      <link rel="stylesheet" href="to_2015/css/font-awesome.min.css" />

   
       <!-- Bootstrap CSS -->
      <link rel="stylesheet" href="to_2015/css/bootstrap.min.css" />

    
      <!-- Plugin CSS -->
      <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/r/bs-3.3.5/dt-1.10.9/datatables.min.css"/>
      <link rel="stylesheet" href="to_2015/css/bootstrap-datepicker3.css" />
      <link rel="stylesheet" href="to_2015/css/bootstrap-timepicker.css" />
      <link rel="stylesheet" href="to_2015/css/bootstrap-colorpicker.css" />
      <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jasny-bootstrap/3.1.3/css/jasny-bootstrap.min.css" />
     
    

      <!-- App CSS -->
      <link rel="stylesheet" href="to_2015/css/mvpready-admin.css" />
      <link rel="stylesheet" href="to_2015/css/mvpready-flat.css" />

     

     <!-- Custom styles for TimeOut  -->
      <link href="to_2015/css/mpvready-style-timeout.css" rel="stylesheet" />
