...
'public manMin, tirMin, onsMin, torMin, freMin, lorMin, sonMin
'public manMinPause, tirMinPause, onsMinPause, torMinPause, freMinPause, lorMinPause, sonMinPause
function fLonTimerPer_2018(stDato, periode, visning, medid)
...
<style>
    ...
    <tr>
		<td colspan="<%=cspsStur %>"><%=tsa_txt_137 %>:</td>
		<td><%call timerogminutberegning(manMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt + manMin/1%>
		<td><%call timerogminutberegning(tirMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt + tirMin/1%>
		<td><%call timerogminutberegning(onsMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt + onsMin/1%>
		<td><%call timerogminutberegning(torMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt +  torMin/1%>
		<td><%call timerogminutberegning(freMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt +  freMin/1%>
		<td><%call timerogminutberegning(lorMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt +  lorMin/1%>
		<td><%call timerogminutberegning(sonMin)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIalt = ugeIalt +  sonMin/1%>
		<td>= 
		<%call timerogminutberegning(ugeIalt)
	...
	<tr bgcolor="#FFFFFF">
		<td colspan="<%=cspsStur %>"><%=tsa_txt_138 %>:</td>
		<td><%call timerogminutberegning(-manMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + manMinPause%>
		<td><%call timerogminutberegning(-tirMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + tirMinPause%>
		<td><%call timerogminutberegning(-onsMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + onsMinPause%>
		<td><%call timerogminutberegning(-torMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + torMinPause%>
		<td><%call timerogminutberegning(-freMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + freMinPause%>
		<td><%call timerogminutberegning(-lorMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + lorMinPause%>
		<td><%call timerogminutberegning(-sonMinPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltPause = ugeIaltPause + sonMinPause%>
		<td>= <%call timerogminutberegning(-ugeIaltPause)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
	</tr>
	<%end if %>
    ...
    <%if cint(showkgtil) = 1 then %>
    <tr bgcolor="#ffffff">
		<td colspan="<%=cspsStur %>"><span id="modal_1" class="picmodal" ><u><%=global_txt_168 %>: +</u></span></td>
		<td><%call timerogminutberegning(manFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (manFraTimer)%>
		<td><%call timerogminutberegning(tirFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (tirFraTimer)%>
		<td><%call timerogminutberegning(onsFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (onsFraTimer)%>
		<td><%call timerogminutberegning(torFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (torFraTimer)%>
		<td><%call timerogminutberegning(freFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (freFraTimer)%>
		<td><%call timerogminutberegning(lorFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (lorFraTimer)%>
		<td><%call timerogminutberegning(sonFraTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		<%ugeIaltFraTilTimer = ugeIaltFraTilTimer + (sonFraTimer)%>
		<td>= <%call timerogminutberegning(ugeIaltFraTilTimer)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
	</tr>
	<%end if %>
	...
	<!-- total -->
	 ...
	 <tr bgcolor="#cccccc">
		<td colspan="<%=cspsStur %>"><b><%=global_txt_167%>:</b></td>
		<td><b><%call timerogminutberegning(totMan)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totTir)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totOns)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totTor)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
	    <td><b><%call timerogminutberegning(totFre)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totLor)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totSon)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td>= <b><%call timerogminutberegning(ugeIalt - (ugeIaltPause - (ugeIaltFraTilTimer)))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
    ...
    <tr bgcolor="#ffffff">
		...
		<td><%call timerogminutberegning(ntimMan*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		<td><%call timerogminutberegning(ntimTir*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		<td><%call timerogminutberegning(ntimOns*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		<td><%call timerogminutberegning(ntimTor*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		<td><%call timerogminutberegning(ntimFre*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		<td><%call timerogminutberegning(ntimLor*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		
		
		<td><%call timerogminutberegning(ntimSon*60)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		...
		<td>= <%call timerogminutberegning(NormTimerWeekTot)
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </td>
		</tr>
	  ...
	  <tr bgcolor="#DCF5BD">
		<td colspan="<%=cspsStur %>" style="height:20px;"><b><%=global_txt_163 %>:</b></td>
		<td><b><%call timerogminutberegning(totMan - (ntimMan*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totTir - (ntimTir*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totOns - (ntimOns*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totTor - (ntimTor*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
	    <td><b><%call timerogminutberegning(totFre - (ntimFre*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totLor - (ntimLor*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td><b><%call timerogminutberegning(totSon - (ntimSon*60))
		Response.write ""& thoursTot &":"& left(tminTot, 2)%> </b></td>
		<td>=
        <%
        call timerogminutberegning((ugeIalt - (ugeIaltPause - (ugeIaltFraTilTimer))) - NormTimerWeekTot)
	            ...
	            <table class="table dataTable table-bordered table-hover ui-datatable">    
                    ...
                    <thead>
	                    <tr>
		                    ...
		                    <td><b><%=tsa_txt_128 %> d. <%=formatdatetime(stDato, 2) %></b></td>
		                    <td><b><%=tsa_txt_129 %> d. <%=formatdatetime(dateadd("d", 1, stDato), 2) %></b></td>
		                    <td><b><%=tsa_txt_130 %> d. <%=formatdatetime(dateadd("d", 2, stDato), 2) %></b></td>
		                    <td><b><%=tsa_txt_131 %> d. <%=formatdatetime(dateadd("d", 3, stDato), 2) %></b></td>
		                    <td><b><%=tsa_txt_132 %> d. <%=formatdatetime(dateadd("d", 4, stDato), 2) %></b></td>
	                        <td><b><%=tsa_txt_133 %> d. <%=formatdatetime(dateadd("d", 5, stDato), 2) %></b></td>
		                    <td><b><%=tsa_txt_127 %> d. <%=formatdatetime(dateadd("d", 6, stDato), 2) %></b></td>
                    ...
                    <tbody>
	                    ...
	                    <tr>
		                    <td><%=global_txt_147 &" "& aty_fleks_tf%></td>
		                    <td><%call timerogminutberegning(manFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (manFlekstimer)%>
		                    <td><%call timerogminutberegning(tirFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (tirFlekstimer)%>
		                    <td><%call timerogminutberegning(onsFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (onsFlekstimer)%>
		                    <td><%call timerogminutberegning(torFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (torFlekstimer)%>
		                    <td><%call timerogminutberegning(freFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (freFlekstimer)%>
		                    <td><%call timerogminutberegning(lorFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (lorFlekstimer)%>
		                    <td><%call timerogminutberegning(sonFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFlekstimer = ugeIaltFlekstimer + (sonFlekstimer)%>
		                    <td><%call timerogminutberegning(ugeIaltFlekstimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_135 &" "& aty_Ferie_tf %></td>
		                    <td><%call timerogminutberegning(manFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (manFerietimer)%>
		                    <td><%call timerogminutberegning(tirFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (tirFerietimer)%>
		                    <td><%call timerogminutberegning(onsFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (onsFerietimer)%>
		                    <td><%call timerogminutberegning(torFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (torFerietimer)%>
		                    <td><%call timerogminutberegning(freFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (freFerietimer)%>
		                    <td><%call timerogminutberegning(lorFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (lorFerietimer)%>
		                    <td><%call timerogminutberegning(sonFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFerietimer = ugeIaltFerietimer + (sonFerietimer)%>
		                    <td><%call timerogminutberegning(ugeIaltFerietimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_138 &" "& aty_Syg_tf %></td>
		                    <td><%call timerogminutberegning(manSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (manSygtimer)%>
		                    <td><%call timerogminutberegning(tirSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (tirSygtimer)%>
		                    <td><%call timerogminutberegning(onsSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (onsSygtimer)%>
		                    <td><%call timerogminutberegning(torSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (torSygtimer)%>
		                    <td><%call timerogminutberegning(freSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (freSygtimer)%>
		                    <td><%call timerogminutberegning(lorSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (lorSygtimer)%>
		                    <td><%call timerogminutberegning(sonSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSygtimer = ugeIaltSygtimer + (sonSygtimer)%>
		                    <td><%call timerogminutberegning(ugeIaltSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_139 &" "& aty_BarnSyg_tf %></td>
		                    <td><%call timerogminutberegning(manBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (manBarnSygtimer)%>
		                    <td><%call timerogminutberegning(tirBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (tirBarnSygtimer)%>
		                    <td><%call timerogminutberegning(onsBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (onsBarnSygtimer)%>
		                    <td><%call timerogminutberegning(torBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (torBarnSygtimer)%>
		                    <td><%call timerogminutberegning(freBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (freBarnSygtimer)%>
		                    <td><%call timerogminutberegning(lorBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (lorBarnSygtimer)%>
		                    <td><%call timerogminutberegning(sonBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltBarnSygtimer = ugeIaltBarnSygtimer + (sonBarnSygtimer)%>
		                    <td><%call timerogminutberegning(ugeIaltBarnSygtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_160 &" "& aty_Lage_tf %></td>
		                    <td><%call timerogminutberegning(manLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (manLagetimer)%>
		                    <td><%call timerogminutberegning(tirLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (tirLagetimer)%>
		                    <td><%call timerogminutberegning(onsLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (onsLagetimer)%>
		                    <td><%call timerogminutberegning(torLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (torLagetimer)%>
		                    <td><%call timerogminutberegning(freLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (freLagetimer)%>
		                    <td><%call timerogminutberegning(lorLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (lorLagetimer)%>
		                    <td><%call timerogminutberegning(sonLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltLagetimer = ugeIaltLagetimer + (sonLagetimer)%>
		                    <td><%call timerogminutberegning(ugeIaltLagetimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_148 &" "& aty_Sund_tf %></td>
		                    <td><%call timerogminutberegning(manSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (manSundtimer)%>
		                    <td><%call timerogminutberegning(tirSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (tirSundtimer)%>
		                    <td><%call timerogminutberegning(onsSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (onsSundtimer)%>
		                    <td><%call timerogminutberegning(torSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (torSundtimer)%>
		                    <td><%call timerogminutberegning(freSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (freSundtimer)%>
		                    <td><%call timerogminutberegning(lorSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (lorSundtimer)%>
		                    <td><%call timerogminutberegning(sonSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltSundtimer = ugeIaltSundtimer + (sonSundtimer)%>
		                    <td><%call timerogminutberegning(ugeIaltSundtimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
	                    ...
	                    <tr>
		                    <td><%=global_txt_133 &" "& aty_Frokost_tf %></td>
		                    <td><%call timerogminutberegning(manFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (manFrokosttimer)%>
		                    <td><%call timerogminutberegning(tirFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (tirFrokosttimer)%>
		                    <td><%call timerogminutberegning(onsFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (onsFrokosttimer)%>
		                    <td><%call timerogminutberegning(torFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (torFrokosttimer)%>
		                    <td><%call timerogminutberegning(freFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (freFrokosttimer)%>
		                    <td><%call timerogminutberegning(lorFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (lorFrokosttimer)%>
		                    <td><%call timerogminutberegning(sonFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
		                    <%ugeIaltFrokosttimer = ugeIaltFrokosttimer + (sonFrokosttimer)%>
		                    <td><%call timerogminutberegning(ugeIaltFrokosttimer)
		                    Response.write "<font class=megetlillesort>"& thoursTot &":"& left(tminTot, 2)%> t</td>
	                    </tr>
