...
<script language="javascript">
	...
	if lastMid <> oRec("lmid") AND x > 0 then
		...
		call tottimer(lastMnavn, lastMnr, totalhours, totalmin, lastMid, sqlDatoStart, sqlDatoSlut)
		totalhours = 0 
		totalmin = 0
	end if
	%>
...
function stPauserProgrp(useMid, p1_grp, p2_grp)
        ...
        p1_prg_on = 1
            ...
            for g = 0 to UBOUND(p1_grpArr)
                ...
                if isInt = 0 then
                call medarbiprojgrp(p1_grpArr(g), useMid)
                end if
                isInt = 0
        ...
        p2_prg_on = 1
            ...
            for g = 0 to UBOUND(p2_grpArr)
                ...
                if isInt = 0 then
                call medarbiprojgrp(p2_grpArr(g), useMid)
                end if
                isInt = 0
            next
