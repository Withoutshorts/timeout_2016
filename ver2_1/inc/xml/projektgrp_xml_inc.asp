...
Set oNodes_progrp = objXmlDom_progrp.documentElement.selectNodes(sXPathQuery_progrp)
    ...
    For Each oNode_progrp in oNodes_progrp
        ...
        progrp_txt_052 = oNode_progrp.selectSingleNode("txt_52").Text
        progrp_txt_053 = oNode_progrp.selectSingleNode("txt_53").Text
        progrp_txt_054 = oNode_progrp.selectSingleNode("txt_54").Text
        progrp_txt_055 = oNode_progrp.selectSingleNode("txt_55").Text
        progrp_txt_056 = oNode_progrp.selectSingleNode("txt_56").Text
        progrp_txt_057 = oNode_progrp.selectSingleNode("txt_57").Text
