...
Set oNodes_medarb_protid = objXmlDom_medarb_protid.documentElement.selectNodes(sXPathQuery_medarb_protid)
    ...
    For Each oNode_medarb_protid in oNodes_medarb_protid
        ...
        medarb_protid_txt_023 = oNode_medarb_protid.selectSingleNode("txt_23").Text
        medarb_protid_txt_024 = oNode_medarb_protid.selectSingleNode("txt_24").Text
        medarb_protid_txt_025 = oNode_medarb_protid.selectSingleNode("txt_25").Text
        medarb_protid_txt_026 = oNode_medarb_protid.selectSingleNode("txt_26").Text
        medarb_protid_txt_027 = oNode_medarb_protid.selectSingleNode("txt_27").Text
        medarb_protid_txt_028 = oNode_medarb_protid.selectSingleNode("txt_28").Text
        medarb_protid_txt_029 = oNode_medarb_protid.selectSingleNode("txt_29").Text
        medarb_protid_txt_030 = oNode_medarb_protid.selectSingleNode("txt_30").Text
        medarb_protid_txt_031 = oNode_medarb_protid.selectSingleNode("txt_31").Text
        medarb_protid_txt_032 = oNode_medarb_protid.selectSingleNode("txt_32").Text
        medarb_protid_txt_033 = oNode_medarb_protid.selectSingleNode("txt_33").Text
        medarb_protid_txt_034 = oNode_medarb_protid.selectSingleNode("txt_34").Text
        medarb_protid_txt_035 = oNode_medarb_protid.selectSingleNode("txt_35").Text
        medarb_protid_txt_036 = oNode_medarb_protid.selectSingleNode("txt_36").Text
        medarb_protid_txt_037 = oNode_medarb_protid.selectSingleNode("txt_37").Text
