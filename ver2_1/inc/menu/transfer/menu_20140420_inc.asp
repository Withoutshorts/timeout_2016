                ...
                'select case lto
                 ...
                 if cint(stempelurOn) = 1 then %>
                    ...
                    <%end select %>
                     ...
                     <%if lto = "cflow" OR lto = "miele" or lto = "outz" or lto = "cool" then%>
                            ...
                            <li><a href="https://timeout.cloud/timeout_xp/wwwroot/ver4_22/to_2015/monitor.asp?func=startside&ltokey=<%=ltokey %>" target="_blank" style="color:orange">NY! Terminal ind/ud stempling m. besøk</a></li>
                            <%end if %>
                     <%end if
                 ...
                 case "tec", "esn", "epi", "epi_uk", "epi_no", "epi_as", "tia", "xintranet - local", "wap", "ddc", "cflow"
                 case else
                 ...
                 <%select case lto
                 case "oko", "epi", "epi2017", "wilke", "outz", "dencker", "essens", "synergi1", "jttek", "hidalgo", "demo", "bf", "plan", "acc", "assurator", "glad", "tia", "eniga", "welcom", "alfanordic", "intranet - local", "cflow", "cisu", "sduuas", "adra", "ddc"
                        ...
                        or (lto = "tia") OR (lto = "eniga") OR (lto = "welcom") OR (lto = "alfanordic") OR (lto = "intranet - local") OR (lto = "cisu") OR (lto = "sduuas") OR (lto = "adra") OR (lto = "ddc") OR (lto = "sdumikjoh") then%>
                   ...
                   <%if level <= 2 OR level = 6 then %> 
                       ...
                       if (lto = "tia" AND level = 7) OR (lto = "alfanordic") OR lto = ("intranet - local") OR lto = ("wap") OR lto = ("cflow") then  
                     ...
                     '**** Ressource forecast    
                         select case lto
                         case "tec", "esn", "nonstop", "epi2017", "ddc"
                         case else
                  ...
                  <%
                   ...
                   '** Ellers kun ferie  
                   if lto = "alfanordic" OR lto = "intranet - local" OR lto = "ddc" OR lto = "cflow" then
     ...
     %>
            ...
            <!-- PROJEKTETER -->
              <ul class="menupkt_n2" id="ul_menu-slider-2" style="display:none; visibility:visible;">
                ...
                <li><a href="<%=toSubVerPath15 %>job_list.asp"><%=tsa_txt_448 %></a></li>
                  ...
                  <%end select %>
                    ...
                    <%if level <= 2 OR level = 6 then %>
                         ...
                         case "intranet - local", "oko"
                             %>
                            <li><a href="<%=toSubVerPath15_399 %>webblik_joblisten.asp" style="color:orange;">Øko BETA: <%=tsa_txt_452 %></a></li>
                            <%
                         end select%>
                ...
                <h3 class="menuh3"><%=tsa_txt_457 %></h3>
                 ...
                 <%else %>
                       ...
                       <%if level = 1 then %>
                        ...
                        <%if level = 1 AND cint(lagemenu_2014) = 1 then %>
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-5" style="display:none; visibility:visible;">
           ...
           <% if session("stempelur") <> 0 then %>
                 ...
                 <%if level = 1 AND lto = "cflow" then%>
                
                 <li><a href='<%=toSubVerPath15_422 %>infoscreen.asp' target="_blank" style="color:orange;">Infoskærm (m. SMS alarm)</a></li>
      ...
      <h3 class="menuh3"><%=tsa_txt_479 %></h3>
           ...
           <h3 class="menuh3"><%=tsa_txt_480 %></h3>
            ...
            <%if (session("stempelur") <> 0 AND lto = "dencker" OR lto = "adra" OR lto = "outz" OR lto = "cool") then %>             
