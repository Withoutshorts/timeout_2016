...
%>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li style="background-color:red;"><a href="stempelur.asp?func=redloginhist&medarbSel=<%=session("mid")%>&showonlyone=1&hidemenu=1&id=0&rdir=sesaba" target="_top">Log ud</a></li>
                        <%else %>
                        <li style="background-color:red;"><a href="../sesaba.asp" target="_top"><%=tsa_txt_435 %></a></li>
                        <%end if %>
    ...
    <div class="fixed-navbar-vert">
        <nav>
            <ul>
                ...
                <li id="menu_1" class="showLeft tooltip-right" tooltip-title="<%=menu_txt_001 %>"><a href="#"><span class="glyph icon-stopwatch"></span></a></li>
                <%end if %>
 ...
 <nav id="menu-slider" class="menu-slider" style="overflow-y:scroll;">
            ...
            <!-- Timeregistrering -->
             <ul class="menupkt_n2" id="ul_menu-slider-1" style="display:none; visibility:visible;">
                ...
                lnkLogind = "logindhist_2011.asp?usemrn="&usemrn&"&varTjDatoUS_man="&stDato_ugeseddel_kommegaa_US_man'&"&varTjDatoUS_son="&varTjDatoUS_son 
                 ...
                 select case lto
                 case "cst"
                    %>   <li><a href="<%=lnkTimeregside %>"><%=tsa_txt_116 &" "& tsa_txt_438 %></a></li><%
                 case "tec", "esn"
                 ...
                 case else
                    %>   <li><a href="<%=lnkTimeregside %>"><%=tsa_txt_116 %></a></li><%
                 end select
           
               

                 %>  <li><a href="<%=lnkUgeseddel%>"><%=tsa_txt_337 %></a></li>
                 ...
                 <li><a href="<%=lnkLogind%>"><%=tsa_txt_340 %></a></li>
                 <%end if %>
                 ...
                 case else
                     ...
                     if level <= 7 then %>
                     <li><a href="materialer_indtast.asp?id=0&fromsdsk=0&aftid=0"><%=tsa_txt_191 %></a></li>
	                 <%end if 
                 end select%>
                ...
                <li><a href="<%=lnkAfstem %>"><%=tsa_txt_389 %></a></li>
                   ...
                   <%if level <= 7 then %>
                    ...
                    <li><a href="ressource_belaeg_jbpla.asp"><%=tsa_txt_440 %></a></li>
                    <%end select %>
                  ...
                  <%'** Afslut periode ***'
                   ...
                   <li><a href="week_real_norm_2010.asp"><%=afslutUgeseddelMenuTxt %></a></li>
	               <%end if %>


                  <%
                   '** Ferie / Sygdoms kalender
                   '** Level 1 har adgang til sygdom 
                   '** Ellers kun ferie  
                   if level = 1 then %>

	                    <li><a href="feriekalender.asp?menu=job"><%=replace(tsa_txt_443, "|", "&") %></a></li>
		                <%else %>
                         ...
                         case else
                          ...
                          %>
		                     ...
		                     <li><a href="feriekalender.asp?menu=job"><%=replace(tsa_txt_444, "|", "&") %></a></li>
            ...
            <li><a href="stat_opdater_igv.asp?func=opdater" target="_blank"><%=tsa_txt_462 %></a>
            <%end if 
    ...
    <%
      ...
      %>
       ...
       %>
       <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2012-1010-TO135" >EPI STA</a></li>
        <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2012-1012-TO136" >EPI NO</a></li>
      ...
      %>
       <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2012-1010-TO135" >EPI STA</a></li>
        <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2010-2004-TO116" >EPI</a></li>
        <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2013-0109-TO142" >EPI AB</a></li>
      <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2014-0331-TO148" >EPI UK</a></li>
       <%
    ...
    %><li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2012-1010-TO135" >EPI STA</a></li>
       <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2012-1012-TO136" >EPI OSL</a></li>
        <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2010-2004-TO116" >EPI</a></li>
        <li><a href="https://outzource.dk/timeout_xp/wwwroot/ver2_14/timereg/timereg_akt_2006.asp?eksterntlnk=aaQWEIOC345345DFNEfjsdf7890sdfv&email=<%=meEmail%>&key=2.2013-0109-TO142" >EPI AB</a></li>
     ...
     %>
            ...
            <!-- PROJEKTETER -->
              <ul class="menupkt_n2" id="ul_menu-slider-2" style="display:none; visibility:visible;">
                ...
                <%if cint(projmenu_2014) = 2 then%>
                     <h3><%=tsa_txt_445 %></h3>
                      <li><a href="job_nt.asp?rapporttype=0"><%=tsa_txt_445 %></a></li>
                      <li><a href="job_nt.asp?func=opret&id=0&rapporttype=0"><%=tsa_txt_446 %></a></li>
                    
                 <%else %>
                 <h3><%=tsa_txt_447 %></h3>
                <li><a href="jobs.asp"><%=tsa_txt_448 %></a></li>
                <li><a href="jobs.asp?func=opret&id=0"><%=tsa_txt_449 %></a></li>
                  
                  <%if level <= 2 OR level = 6 then %>
                  <li><a href="job_print.asp?menu=job&kid=0&id=0"><%=tsa_txt_450 %></a></li>
                  <li><a href="filer.asp"><%=tsa_txt_451 %></a></li>
                  <%end if %>

                    <%if level <= 2 OR level = 6 then %>
                  <h3><%=tsa_txt_439 %></h3>
                   <li><a href="webblik_joblisten.asp"><%=tsa_txt_452 %></a></li>
                 

                 
                 

                  <li><a href="ressource_belaeg_jbpla.asp"><%=tsa_txt_440 %>
                   ...
                   <li><a href="webblik_joblisten21.asp"><%=tsa_txt_454 %></a></li>
                   <li><a href="webblik_milepale.asp"><%=tsa_txt_455 %></a></li>

                  <li><a href="pipeline.asp?menu=webblik&FM_kunde=0&FM_progrupper=10"><%=tsa_txt_456 %></a></li>

                  <%if lto = "outz" OR lto = "intranet - local" then %>
                    <li><a href="jbpla_w.asp">Planlægningskalender (TEST)</a></li>
                  <%end if %>
             ...
             <ul class="menupkt_n2" id="ul_menu-slider-3" style="display:none; visibility:visible;">
                <h3><%=tsa_txt_457 %></h3>
                     ...
                     <%if cint(statmenu_2014) = 2 then 'nt%>
                           ...
                           <%if level = 1 then %>
                                     ...
                                     <li><a href="oms.asp"><%=tsa_txt_459 %></a></li>

                         <%end if %>
                   
                          <!--
                         <li><a href="job_nt.asp?rapporttype=1">Production / Enq. Overview</a></li>
                         <li><a href="job_nt.asp?rapporttype=3">Overview (ext.)</a></li>
                         <li><a href="job_nt.asp?rapporttype=4">Overview</a></li>
                         <li><a href="oms.asp">Sales Budget</a></li> 
                         -->
                ...
                <li><a href="joblog_timetotaler.asp"><%=tsa_txt_458 %></a></li>
                 <li><a href="joblog.asp"><%=tsa_txt_118 %></a></li>
                 ...
                 <%if level = 1 then %>
                             ...
                             <li><a href="fomr.asp?func=stat"><%=tsa_txt_460 %></a></li>

                             <br /><br />
                             <%if session("stempelur") <> 0 then %>
                                <li><a href="stempelur.asp?func=stat"><%=tsa_txt_463 %></a></li>

                            <%end if %>
                 
             

                 <li><a href="saleandvalue.asp"><%=replace(tsa_txt_464, "|", "&") %></a></li>

                 <%if cint(smilaktiv) <> 0 then  %>
                 <li><a href="smileystatus.asp"><%=tsa_txt_465 %></a></li>
                 <%end if %>

                 <li><a href="bal_real_norm_2007.asp?dontdisplayresult=1"><%=replace(tsa_txt_466, "|", "&") %></a></li>
                ...
                <%end if %>
                        ...
                        <li><a href="week_real_norm_2010.asp?menu=stat"><%=tsa_txt_356 %></a></li>
                        <%end if %>

                        <%if level <= 2 OR level = 6 then '** Indtil teamleder er impl. på kørsels siden **"%>
                        <li><a href="stat_korsel.asp?menu=stat" ><%=tsa_txt_265 %></a></li>
                        <%end if %>
                        ...
                        <%if level = 1 then %>
                        <li><a href="materiale_stat.asp?menu=stat" ><%=tsa_txt_156 %></a></li>
                        <%end if %>
                        ...
                        <%if level = 1 AND (lto = "intranet - local" OR lto = "epi" OR lto = "epi_cati") then %>
                         ...
                         <br /><br />
                        <li><a href="timerimperr.asp?menu=stat" ><%=tsa_txt_467 %></a></li>
                        <li><a href="diff_timer_kons.asp?menu=stat" ><%=tsa_txt_468 %></a></li>
                        <%end if %>
                        ...
                        <li><a href="stat_opdater_igv.asp?menu=stat"><%=tsa_txt_462 %></a></li>
                        <%end if %>
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-4" style="display:none; visibility:visible;">
                <h3><%=global_txt_124 %></h3>
            
                
	        <li><a href='kunder.asp?visikkekunder=1'><%=global_txt_124 %></a></li>
           <li><a href='kunder.asp?func=opret&ketype=k'><%=global_txt_180 %></a></li>
            <li><a href='serviceaft_osigt.asp?id=0&func=osigtall'><%=global_txt_181 %></a></li>
            <li><a href='kontaktpers.asp?func=list'><%=global_txt_182 %></a></li>


           <%if cint(crmOnOff) = 1 then %>
           <h3><%=tsa_txt_491 %></h3>
           <!--<li><a href='crmkalender.asp?menu=crm&shokselector=1&ketype=e&selpkt=kal&status=0&id=0&emner=0'>Kalender (gl.)</a></li>-->
           <li><a href='kunder.asp?menu=crm'><%=tsa_txt_469 %></a></li>
           <li><a href='crmhistorik.asp?menu=crm&ketype=e&func=hist&id=0&selpkt=hist'><%=tsa_txt_470 %></a></li>
           <!--<li><a href='crmstat.asp?menu=crm'>CRM statistik</a></li>-->
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-5" style="display:none; visibility:visible;">
           ...
           <%if level = 1 then %>
	        <li><a href='medarb.asp'><%=global_txt_125 %></a></li>

           
           <li><a href='medarb_red.asp?menu=medarb&func=opret'><%=global_txt_183 %></a></li>
           <%else %>
             <li><a href='medarb_red.asp?menu=medarb&func=red&id=<%=session("mid")%>'><%=global_txt_184 %></a></li>
           <%end if %>
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-6" style="display:none; visibility:visible;">
	        ...
	        <li><a href='materialer.asp'><%=tsa_txt_478 %></a></li>

           <%if level <= 2 OR level = 6 then %>
            <li><a href='materialer.asp?func=opret'><%=tsa_txt_473 %></a></li>

           <li><a href='materiale_grp.asp'><%=tsa_txt_474 %></a></li>
           
           <li><a href='materialer_ordrer.asp'><%=tsa_txt_475 %></a></li>

           <li><a href="produktioner.asp"><%=tsa_txt_476 %></a></li>

           <li><a href="leverand.asp"><%=replace(tsa_txt_477, "|", "&") %></a></li>
           <%end if %>
      ...
      <h3><%=tsa_txt_479 %></h3>
           ...
           <h3><%=tsa_txt_480 %></h3>
             <li><a href="abonner.asp"><%=tsa_txt_480 %></a></li>

           <h3><%=tsa_txt_448 %></h3>

                  <li><a href="projektgrupper.asp"><%=tsa_txt_481 %></a></li>
                  <li><a href="akt_gruppe.asp?menu=job&func=favorit"><%=tsa_txt_482 %></a></li>
                  <li><a href="ulev_gruppe.asp?menu=job&func=favorit"><%=tsa_txt_483 %></a></li>
                  <li><a href="fomr.asp"><%=tsa_txt_460 %></a></li>
                            <li><a href="milepale_typer.asp"><%=tsa_txt_484 %></a></li>
                                
                             <li><a href="stfolder_gruppe.asp?ketype=e"><%=tsa_txt_485 %></a></li>

           <h3><%=tsa_txt_486 %></h3>

                    <li><a href="kundetyper.asp?ketype=e"><%=tsa_txt_487 %></a></li>
			...
			if cint(crmOnOff) = 1 then
                %>
                        ...
                        <li><a href="crmstatus.asp?menu=tok&ketype=e"><%=tsa_txt_488 %></a></li>
                            <li><a href="crmemne.asp?menu=tok&ketype=e"><%=tsa_txt_489 %></a></li>
                                <li><a href="crmkontaktform.asp?menu=tok&ketype=e"><%=tsa_txt_490 %></a></li>
		...
		<li><a href="javascript:NewWin_help('momskoder.asp');" target="_self"><%=tsa_txt_493 %></a></li>
		<li><a href="javascript:NewWin_help('nogletalskoder.asp');" target="_self"><%=tsa_txt_494 %></a></li>
		<li><a href="javascript:NewWin_help('momsafsluttet.asp');" target="_self"><%=tsa_txt_495 %></a></li>
	


           <h3><%=tsa_txt_471 %></h3>

             <li><a href='bgrupper.asp'><%=tsa_txt_496 %></a></li>
            <li><a href='medarbtyper.asp'><%=tsa_txt_497 %></a></li>
            <li><a href="medarbtyper_grp.asp"><%=tsa_txt_498 %></a></li>
           ...
           <h3><%=tsa_txt_499 %></h3>
            ...
            <li><a href="javascript:NewWin_help('sdsk_prioitet.asp?menu=tok');" target="_self"><%=tsa_txt_500 %></a></li> 
            <li><a href="javascript:NewWin_help('sdsk_prio_typ.asp?menu=tok');" target="_self"><%=tsa_txt_501 %></a></li>
            <li><a href="javascript:NewWin_help('sdsk_prio_grp.asp?menu=tok');" target="_self"><%=tsa_txt_502 %></a></li>
            <li><a href="javascript:NewWin_help('sdsk_status.asp?menu=tok');"><%=tsa_txt_503 %></a></li>
            
            <li><a href="javascript:NewWin_help('sdsk_typer.asp?menu=tok');" target="_self"><%=tsa_txt_504 %></a>
            <%
            end if
            %>
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-7" style="display:none; visibility:visible;">
	        ...
	        <li><a href='erp_tilfakturering.asp'><%=tsa_txt_506 %></a></li>
           <li><a href='erp_opr_faktura_fs.asp?reset=0'><%=tsa_txt_507 %></a></li>
           
            <li><a href='erp_fakhist.asp'><%=tsa_txt_508 %></a></li>
           <li><a href='erp_fakturaer_find.asp'><%=tsa_txt_509 %></a></li>

           <h3><%=tsa_txt_510 %></h3>
           <li><a href="erp_job_afstem.asp?menu=erp&show=joblog_afstem"><%=tsa_txt_511 %></a></li>
           <li><a href='erp_serviceaft_saldo.asp?menu=erp'><%=tsa_txt_512 %></a></li>

           <h3><%=tsa_txt_513 %></h3>

           <li><a href="kontoplan.asp?nolist=1"><%=tsa_txt_514 %></a></li>

           <li><a href="kontoplan.asp?menu=kon&func=opret"><%=tsa_txt_515 %></a></li>
           

		<li><a href="posteringer.asp?id=0"><%=tsa_txt_516 %></a></li>
	    <li><a href="posteringer.asp?id=0&kontonr=-1&kid=0"><%=tsa_txt_517 %></a></li>
		<li><a href="posteringer.asp?id=0&kontonr=-2&kid=0"><%=tsa_txt_518 %></a></li>
           <li><a href="resultatop.asp"><%=tsa_txt_519 %></a></li>
		
		
           <h3><%=tsa_txt_520 %></h3>
           <li><a href="budget_aar_dato.asp"><%=tsa_txt_521 %></a></li>

        <%if level <= 2 OR level = 6 then  %>
        <li><a href="budget_bruttonetto.asp"><%=replace(tsa_txt_522, "|", "&") %></a></li>
        <li><a href="budget_medarb.asp?menu=erp"><%=tsa_txt_523 %></a></li>
            <%if lto = "wwf" OR lto = "intranet - local" then %>
            <li><a href="timbudgetsim.asp">Budget simulering</a></li>
            <%end if %>
        <%end if %>
       ...
       <ul class="menupkt_n2" id="ul_menu-slider-9" style="display:none; visibility:visible;">
	        ...
	        <li><a href='sdsk.asp'><%=tsa_txt_524 %></a></li>
           <li><a href='sdsk.asp?func=opr&FM_kontakt=0'><%=tsa_txt_525 %></a></li>
           
            <li><a href='sdsk_stat.asp?menu=sdsk'><%=tsa_txt_526 %></a></li>
           <li><a href="sdsk_knowledge.asp?menu=sdsk&visikke=1"><%=tsa_txt_527 %></a></li>

              <li><a href="filer.asp"><%=tsa_txt_528 %></a></li>
        ...
        <nav>
            ...
            <ul id="ul_menu-slider-1">
                <li><a href="timereg_akt_2006.asp">Timeregistrering</a></li>
