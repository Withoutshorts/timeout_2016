...
<%
	...
	filnavnKlok = "_"&datepart("h", now)&"_"&datepart("n", now)&"_"&datepart("s", now)
				...
				if lto = "bowe" then
				strOskrifter = "Kontakt;Kontakt Id;Job;KA Nr;Böwe kode;Job Nr;Uge;Dato;Aktivitet;Type;Fakturerbar;Akt. tidslås;Antal;Tid/Klokkeslet;"
				else
				strOskrifter = "Kontakt;Kontakt Id;Job;Job Nr;Uge;Dato;Aktivitet;Type;Fakturerbar;Antal;Tid/Klokkeslet;"
				end if
				...
				strOskrifter = strOskrifter & "Timepris;Valuta;"
				end if 
