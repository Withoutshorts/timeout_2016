...
emMomail = emAFmail
    ...
    for f = 1 to UBOUND(fakids)
        ...
        oRec.close
            ...
            '*** Tilføjer PDF **'
             pdfurl = "d:\\webserver\wwwroot\timeout_xp\wwwroot\ver2_10\inc\upload\"&lto&"\faktura_"&lto&"_"&faknr&".pdf"
	    
	 
        	If (fs.FileExists(pdfurl))=true Then
                    
                    Mailer.AddAttachment "d:\\webserver\wwwroot\timeout_xp\wwwroot\ver2_10\inc\upload\"&lto&"\faktura_"&lto&"_"&faknr&".pdf"
                    bodyTXT = bodyTXT & vbcrlf &"faktura_"&lto&"_"&faknr&".pdf"
                        ...
                        ''Doc.ImportFromUrl "https://outzource.dk/timeout_xp/wwwroot/ver2_1/timereg/erp_fak_godkendt_2007.asp?nosession=9999&print=pdf&jobid="&jobid&"&aftid="&aftid&"&id="&id&"&FM_usedatointerval="&request("FM_usedatointerval")&"&FM_start_dag_ival="&request("FM_start_dag_ival")&"&FM_start_mrd_ival="&request("FM_start_mrd_ival")&"&FM_start_aar_ival="&request("FM_start_aar_ival")&"&FM_slut_dag_ival="&request("FM_slut_dag_ival")&"&FM_slut_mrd_ival="&request("FM_slut_mrd_ival")&"&FM_slut_aar_ival="&request("FM_slut_aar_ival")&"&FM_fakint_ival="&request("FM_fakint_ival")&"&FM_aftnr="&sogaftnr&"&kid="&kid
                        Doc.ImportFromUrl "https://outzource.dk/timeout_xp/wwwroot/ver2_1/timereg/erp_fak_godkendt_2007.asp?nosession=9999&media=pdf&jobid="&jobid&"&aftid="&aftid&"&id="&id&"&key="&session("lto")&"&FM_start_dag_ival="&request("FM_start_dag_ival")&"&FM_start_mrd_ival="&request("FM_start_mrd_ival")&"&FM_start_aar_ival="&request("FM_start_aar_ival")&"&FM_slut_dag_ival="&request("FM_slut_dag_ival")&"&FM_slut_mrd_ival="&request("FM_slut_mrd_ival")&"&FM_slut_aar_ival="&request("FM_slut_aar_ival")
                        ...
                        Filename = Doc.Save(Server.MapPath("../inc/upload/"&lto&"/faktura_"&lto&"_"&faknr&".pdf"), True ) 
            ...
            End If
             ...
             '*** Tilføjer XML **'
             xmlurl = "d:\\webserver\wwwroot\timeout_xp\wwwroot\ver2_10\inc\upload\"&lto&"\faktura_xml_"&lto&"_"&faknr&".xml"
	    
	 
        	If (fs.FileExists(xmlurl))=true Then
                   Mailer.AddAttachment "d:\\webserver\wwwroot\timeout_xp\wwwroot\ver2_10\inc\upload\"&lto&"\faktura_xml_"&lto&"_"&faknr&".xml"
                   bodyTXT = bodyTXT & vbcrlf &"faktura_xml_"&lto&"_"&faknr&".xml"
