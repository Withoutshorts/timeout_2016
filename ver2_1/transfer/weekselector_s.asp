...
thisfile = "webblik_joblisten.asp" OR thisfile = "webblik_milepale.asp" OR _
...
if useDatofilter = 1 then
        ...
        if thisfile = "joblog" AND bruguge = 1 then
        
        strMrd = stMduge
        strDag = stDaguge
        strAar = stAaruge
        strDag_slut = slMduge
        strMrd_slut = slDaguge
...
Fra: <select name="FM_start_dag" style="background-color : #ffffff; border : thin black; font : 10px verdana;">
		...
		<br>Til:<img src="../ill/blank.gif" width="6" height="1" alt="" border="0"> <select name="FM_slut_dag" style="background-color : #ffffff; border : thin black; font : 10px verdana;">
		...
		<option value="<%=useY%>"><%=right(useY, 2)%></option>
		<%next %>
		</select>&nbsp;<a href="javascript:NewWin_popupcal('../inc/regular/popupcalender_inc.asp?use=4')"><img src="../ill/popupcal.gif" alt="" border="0" width="16" height="15"></a>
