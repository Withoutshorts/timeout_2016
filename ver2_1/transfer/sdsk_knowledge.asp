...
if len(session("user")) = 0 then
	...
	<h3><img src='../ill/ac0056-24.gif' width='24' height='24' alt='' border='0'>&nbsp;Servicedesk - Knowledgebase</h3>
	<div style="position:relative; border-left:1px #8caae6 solid; border-top:1px #8caae6 solid; border-right:2px #5582d2 solid; border-bottom:2px #5582d2 solid; width:900;">
	...
	<tr>
		<td align=right style="padding-right:5px;"><b>Søg på emne ell. søgeord:</b></td><td><input type="text" name="FM_sog" id="FM_sog" value="<%=showSogeKri%>" style="font-family: arial; font-size: 10px; width:240px;"></td>
	</tr>
	<tr>
	...
	<tr>
		<td align=right style="padding-right:5px;"><b>Type:</b></td><td><select name="FM_type" style="font-family: arial; font-size: 10px; width:240px; height:12px;">
							<option value="0">Alle</option>
	...
	Emne: <b><%=SQLBless3(oRec("emne"), showSogeKri)%></b><br>
