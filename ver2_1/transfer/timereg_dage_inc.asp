...
'*******************************************************************************************
	...
	strWeek =  datepart("ww", useDate, 2, 3)
...
<tr>
<td align="center" colspan=8 align=center style="!background-color : #8DA7E5;" class=alt>
<b>Uge: 
<%
...
<tr>
<td bgcolor="#ffffff"><!--Aktivitet--></td>
...
for t = 1 to 7
	...
	<td valign="top" style="background-color: <%=borderColor%>; width:65px; border-right: 0px solid #003399; padding-left:2; padding-right:2;" class=lille>
	<%=writedagnavn(t)%> <br>
	<%
