...
<table border=0 cellpadding=0 cellspacing=0 width="450">
	...
	<td valign="bottom"><b>Timeout Kontrolpanel - Prioitets typer.</b><br>
	Tilføj, fjern eller rediger Prioitets typer.</td>
	</tr>
	</table><br>
<%
end sub
...
if len(session("user")) = 0 then
	...
	<tr>
	    <td>Du er ved at <b>slette</b> en Prioitets type. Er dette korrekt?</td>
	</tr>
	<tr>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="600">
	<tr>
    <td valign="top"><font class="pageheader">Kontrolpanel | Prioitets typer</font>
	<br>
	<br>
	<a href="sdsk_prio_grp.asp">Til gruppeoversigt...</a>
	<img src="../ill/blank.gif" width="350" height="1" alt="" border="0">
	<a href="sdsk_prio_typ.asp?menu=tok&func=opret">Opret ny type <img src="../ill/pillillexp_tp.gif" width="16" height="18" alt="" border="0"></a><br>
	<br>
	</td></tr>
	</table>
	...
	<tr bgcolor="#5582D2">
		...
		<td class=alt><b>Type</b> (Antal af denne type)</td>
