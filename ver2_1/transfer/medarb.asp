	                                ...
	                                while not oRec2.EOF 
	                                    ...
	                                    if oRec2("pid") <> 10 then
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center; "><input name="FM_progrp" value="<%=oRec2("pid") %>" class="prg_navn<%=orgvirclass %>" type="checkbox" <%=tilCHB %> /></td>                                                
...
<script src="js/medarb_jav_prg3.js" type="text/javascript"></script>
