...
idagErrTjek = day(now)&"/"&month(now)&"/"&year(now)
	...
	&" sltid = '"&sLtid&"', valuta = "& intValuta &", kurs = "& dblKurs &" WHERE Tid = " & Request.Form("id") 
	...
	'*** Opdaterer alle timepriser siden seneste fak. ****
		...
		strSQL = "UPDATE timer SET timepris = "& timepris &", valuta = "& intValuta &", kurs = "& dblKurs &" WHERE tmnr = "& medid &" AND tjobnr = "& jobnr &" AND taktivitetid = " & intAktId
		oConn.execute(strSQL)
