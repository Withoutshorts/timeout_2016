...
<%end if%>
		...
		call filterheader(dtop,0,700,pTxt)
		%>
		...
		<form id=filter name=filter method=post action="<%=thisfile%>?menu=kund&FM_soeg=<%=FM_soeg%>&func=<%=func%>">
				...
				<b>Kontakt:</b><br><select name="id" size="1" style="font-size : 9px; width:205 px;">
	...
	<%if s = 0 then%>
	<tr bgcolor="<%=bgt%>">
		<td height=1 valign="top" style="border-left:1px #8caae6 solid; border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
		<td colspan=8 style="border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
		<td valign="top" style="border-right:1px #8caae6 solid; border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
	</tr>
	<%end if%>
	...
	<tr bgcolor="<%=bgt%>">
		...
		<td style="padding-left:5px;"><img src="../ill/ac0038-16.gif" width="16" height="16" alt="" border="0">
		<%if thisfile = "serviceaft_osigt.asp" then%>
	...
	<!-------------------------------->	
	<tr bgcolor="<%=bgt%>">
	<td valign="top" colspan=9 bgcolor="<%=bgt%>" style="border-left:1px #8caae6 solid; padding:20px;">
	...
	while not oRec3.EOF 
		...
		<tr bgcolor="<%=bgt %>">
			...
			<td class=lille bgcolor=>&nbsp;<%=oRec3("tdato")%></td>
	...
	<tr bgcolor="<%=bgt%>">
		<td height=<%=hgt%> valign="top" style="border-left:1px #8caae6 solid; border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
		<td colspan=8 style="border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
		<td valign="top" style="border-right:1px #8caae6 solid; border-bottom:1px #8caae6 solid;"><img src="../ill/blank.gif" width="1" height="1" alt="" border="0"></td>
	</tr>
	<%
	...
	<br><br>
	<div style="position:relative; background-color:#ffffe1; visibility:visible; border:2px red dashed; padding:20px; width:550px;"><img src="../ill/ac0005-24.gif" width="24" height="24" alt="" border="0">&nbsp;<b>Side note(r):<br></b>
	...
	<tr>
		...
		<%else
		'pkt1oskrift = pkt1oskrift '** hentes fra job_k (kringit = serviceordre)%>
		Kun klip/enheder indtastet på <b>fakturerbare</b> aktiviteter er fremgår af listen.<br>&nbsp;
		<%end if%>
