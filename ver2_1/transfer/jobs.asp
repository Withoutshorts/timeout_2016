...
if len(session("user")) = 0 then
    ...
    &" syncslutdato, lukkedato, altfakadr, preconditions_met, laasmedtpbudget, filepath1, fomr_konto, jfak_moms, jfak_sprog "_
   ...
   <tr><td style="font-size:9px; color:#CCCCCC;"><input type="radio" name="st_sel" value="0" id="st_cls_0" />Lukket</td></tr> 
    ...
    <%if level = 1 then %>
     <tr style="background-color:#FFFFFF;"><td colspan=2>
        ...
        <br />
         <input id="Checkbox3" type="checkbox" name="FM_formr_opdater" value="1" /> Opdater alle job på listen med ovenstående forretningsområder. (forvalgt konto på job skal ændres manuelt)
