...
'frommonitor
        ...
        if len(trim(request("rdir"))) <> 0 then
          ...
          '    Response.write "HER logudDone: " & logudDone
'    Response.end
'end if
...
select case lto 
case "tec", "xintranet - local", "dencker", "epi2017", "miele" 
...
case "intranet - local", "cflow", "outz", "cool"
...
Response.Write("<script language=""JavaScript"">window.close();</script>")
          ...
          call browsertype()
          if browstype_client = "ip" AND (lto = "miele" OR lto = "esn") then
