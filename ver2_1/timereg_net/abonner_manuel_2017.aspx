...
<script runat="server" language="vbscript">
        ...
        If (func = "fromtimerservice") Then 'Reminder Service auto (bl.a TIA)
            ...
            While objDR.Read() = True
                ...
                If (lto = "tia") And CInt(antalloops) = 0 Then
                    ...
                    '** ER HELLIG ELLER en Lordag eller søndag
                ...
                'PKT. 2 FIRST reminder ALL monday 09.00 (ændret fra søndag 23:59) 
                ...
                'PKT. 5 ALL Timesheet default completed 10:00 - KLAR TIL TEST -- FEJL ved helligdag. Når den .feks kører tirsdag ska lden trække en dage mere fra, da den ellers lukker mandag, dvs. indeværende uge. == RETET 20190423
                ...
                'PKT. 2 FIRST reminder ALL monday 07.00 (ændret fra søndag 23:59)
                '** Rapport skal være = 105 når Webservice kaldes. Så den tjekker splithr
    ...
    Sub hentData(lto, emailto, rapporttype, manual_auto, reminder_rule_no)
        ...
        If t = 0 Then
            ...
            'GROUP BY init fjernet på rapporter 0,1,2,3,4 
            'Da en medarbejder godt kan abonnere på flere rapporter
            '20191120
            Select Case rapporttype
                Case 0, 1, 2, 3, 4
    ...
    Function sendmail(email, file, lto, ltofolder, thisuser, this_rapporttype) As String
        ...
        '** Lidt mærkelig løsning her, mend rapporttype bliver hardcoded = 1 på sendmail funktionen.
    ...
    Function sendmailDailyNotifyNoHours(weekday, lto, reminder_rule_no) As String
        ...
        While objDR3.Read()
            ...
            If CDbl(timer_real) = 0 And CDbl(timer_norm) <> 0 Then
                ...
                e_mail.IsBodyHtml = True
                e_mail.Body = "Kære " & objDR3("mnavn") & "<br><br>"
    ...
    Function sendmailWeeklyNotifyLM(email, file, lto, ltofolder, thisuser, reminder_rule_no, progrpId) As String
        ...
        Select Case CInt(reminder_rule_no)
            Case 109, 110, 113, 114, 112
                dd = DateAdd("m", -1, dd) 'Vær sikker på at komme tilbage til forrige måned
            Case Else
                If ddw = 1 Then
                    dd = DateAdd("d", -1, dd)
                Else
    ...
    Function defaultComplete(lto, reminder_rule_no) As String
        ...
        While objDR2.Read()
            ...
            If CInt(reminder_rule_no) = 8 Then '** Weekly
                ...
                '** AND splithr = 1??? 
                '*** AND splithr = 0 tilføje 20190911
            ...
            If CInt(weekclosedbyuser) = 0 Then
                ...
                If CInt(reminder_rule_no) = 8 Then
                    ...
                    '**** Den slåes fra 20190602, da LUK måned IKKE må åbnes igen ****
        ...
        While objDR2.Read()
            ...
            If objDR4.Read() = True Then
                ...
                If CInt(reminder_rule_no) = 11 Then
                    ...
                    '*** 20190911 Fjernet ligesom  ed complete. Måneden skal beholdes lukket.
                ...
                '***** Hvis aflsut måned / afslut uge er samme dag / weekend. Opdater Splithr = 0
                If CInt(reminder_rule_no) = 111 Then
  ...
  <table cellpadding=0 cellspacing=5 border=0 width=100%><tr><td>
    ...
    <br /><br />
        ...
        <% 
            ...
            '*** Sender alle de rapporter en medarbejder abonerer på hvis man vælger en medarb.
