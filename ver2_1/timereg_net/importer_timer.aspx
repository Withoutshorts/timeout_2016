...
<body style="font-family:Arial" leftmargin="20" topmargin="20">
  ...
  <table cellpadding=0 cellspacing=5 border=0 width=100%><tr><td>
    ...
    <div>
    <h4>Importer timer til TimeOut MAKS ca. 2500 linjer <span style="font-size:small; font-weight:normal;"><a href="../inc/xls/indlaestimerTemplate.csv">Download excel template her...</a></span></h4>
    *Bemærk at der skal være en overskriftslinje(header) med kolonne navne i excel filen.<br />
     <br />Det kan tage <b>op til 10 min.</b> at indlæse 2500 linjer.<br />
