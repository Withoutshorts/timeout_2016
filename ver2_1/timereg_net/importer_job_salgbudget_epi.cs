...
public partial class importer_job : System.Web.UI.Page
{
    ...
    {
        lblMtype.Text = "fundet kolonne: " + ddlMtype.SelectedValue;
        Application["mtype"] = ddlMtype.SelectedValue;
    }

    protected void ddlMtypeHours_SelectedIndexChanged(object sender, EventArgs e)
    {
        lblMtypeHours.Text = "fundet kolonne: " + ddlMtypeHours.SelectedValue;
        Application["MtypeHours"] = ddlMtypeHours.SelectedValue;
    }

    protected void ddlMtypeSalesPrice_SelectedIndexChanged(object sender, EventArgs e)
    {
        lblMtypeSalesPrice.Text = "fundet kolonne: " + ddlMtypeSalesPrice.SelectedValue;
        Application["MtypeSalesPrice"] = ddlMtypeSalesPrice.SelectedValue;
    }

    protected void ddlMtypeRevenue_SelectedIndexChanged(object sender, EventArgs e)
    {
        lblMtypeRevenue.Text = "fundet kolonne: " + ddlMtypeRevenue.SelectedValue;
        Application["MtypeRevenue"] = ddlMtypeRevenue.SelectedValue;
    }

    protected void ddlMtypeCost_SelectedIndexChanged(object sender, EventArgs e)
    {
        lblMtypeCost.Text = "fundet kolonne: " + ddlMtypeCost.SelectedValue;
        Application["MtypeCost"] = ddlMtypeCost.SelectedValue;
    }
    ...
    protected void ddlMtype_DataBound(object sender, EventArgs e)
    {
        lblMtype.Text = "fundet kolonne: " + ddlMtype.SelectedValue;
        Application["mtype"] = ddlMtype.SelectedValue;
    }

    protected void ddlMtypeHours_DataBound(object sender, EventArgs e)
    {
        lblMtypeHours.Text = "fundet kolonne: " + ddlMtypeHours.SelectedValue;
        Application["MtypeHours"] = ddlMtypeHours.SelectedValue;
    }

    protected void ddlMtypeSalesPrice_DataBound(object sender, EventArgs e)
    {
        lblMtypeSalesPrice.Text = "fundet kolonne: " + ddlMtypeSalesPrice.SelectedValue;
        Application["MtypeSalesPrice"] = ddlMtypeSalesPrice.SelectedValue;
    }

    protected void ddlMtypeRevenue_DataBound(object sender, EventArgs e)
    {
        lblMtypeRevenue.Text = "fundet kolonne: " + ddlMtypeRevenue.SelectedValue;
        Application["MtypeRevenue"] = ddlMtypeRevenue.SelectedValue;
    }
    ...
    protected void ddlMtypeCost_DataBound(object sender, EventArgs e)
    {
        lblMtypeCost.Text = "fundet kolonne: " + ddlMtypeCost.SelectedValue;
        Application["MtypeCost"] = ddlMtypeCost.SelectedValue;
    }
