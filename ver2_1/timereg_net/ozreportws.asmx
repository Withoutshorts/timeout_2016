...
Public Class ozreportws
    ...
    Public Function oz_report() As List(Of ozreportcls)
        ...
        Dim strSQLadmin As String = "SELECT email, navn, lto, rapporttype, medid, medarbejdertyper, projektgrupper FROM rapport_abo WHERE id <> 0 AND (rapporttype = 1 OR rapporttype = 0 OR rapporttype = 2 OR rapporttype = 3)" 'AND lto = 'epi2017'
        ...
        While objDR_admin.Read() = True
            ...
            Select Case CInt(rapporttype)
                ...
                Case 4 'rapporttype 4 - ressource forecast rapport
            ...
            'dgs = DatePart("yyyy", dgs) & "-" & DatePart("m", dgs) & "-" & DatePart("d", dgs)
