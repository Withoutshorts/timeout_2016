...
<body style="font-family:Arial" leftmargin="20" topmargin="20">
  ...
  <table cellpadding=0 cellspacing=5 border=0 width=100%><tr><td>
    ...
    <form id="form1" runat="server">
        <asp:Label runat="server"><%= ConfigurationManager.AppSettings["executionTimeout"]%> </asp:Label>

        HER: <%= ConfigurationManager.AppSettings["httpRuntime"]%>

        

    <div>
    <h4>TimeOut fil upload (Importer timer til TimeOut) <span style="font-size:small; font-weight:normal;"><a href="../inc/xls/indlaestimerTemplate.csv">Download excel template her...</a></span></h4>
