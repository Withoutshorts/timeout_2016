    ...
    public class Program
    {
        ...
        public void RunTest()
        {
            try
            {
                ...
                //
                const string projectServiceEndpoint = "https://contessa:8209/p6ws/services/ProjectService";
                const string activiyServiceEndpoint = "https://contessa:8209/p6ws/services/ActivityService";
                const string authenticationServiceEndpoint = "https://contessa:8209/p6ws/services/AuthenticationService";
        ...
        public static AuthenticationServicePortTypeClient CreateAuthenticationServiceClient(String url, String username, String password)
        {
            ...
            authenticationServiceClient.ChannelFactory.Endpoint.Behaviors.Remove<System.ServiceModel.Description.ClientCredentials>();
