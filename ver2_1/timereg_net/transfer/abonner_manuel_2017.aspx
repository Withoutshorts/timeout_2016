...
<script runat="server" language="vbscript">
    ...
    Sub hentData()
        ...
        'meMTxt.Text = "Number of mails sent this loop: " & a & "<br>"
        ...
        'Dim strConn As String = "timeout_dencker64"
  ...
  <table cellpadding=0 cellspacing=5 border=0 width=100%><tr><td>
    ...
    <br /><br />
        ...
        <% 
            ...
            Dim strSQLfilenames As String = "SELECT email FROM rapport_abo WHERE lto = '" & lto & "' AND (rapporttype = 1 OR rapporttype = 0 OR rapporttype = 2 OR rapporttype = 3 OR rapporttype = 4) ORDER BY email"
            objCmd = New OdbcCommand(strSQLfilenames, objConn)
            objDR = objCmd.ExecuteReader '(CommandBehavior.closeConnection)
