...
'			&" Husk! I er altid velkommen til at kontakte OutZourCE på "_
	'		&" +45 2684 2000 eller på email: <a href='mailto:timeout@outzource.dk' class=vmenu>timeout@outzource.dk</a>"
        ...
        <form action="login.asp" method="POST">
            ...
            <h2 style="color:black">Timeout</h2>
            <br />
       ...
       <!--  <div class="form-group clearfix">
            <div class="pull-left">					
            <label class="radio-inline" style="text-align:left">
                <input name="huskmig" type="radio" value="1" /> <small>Login extern</small><br />
                <input name="huskmig" type="radio" value="1" /> <small>Login uden løntid</small><br />
                <input name="huskmig" type="radio" value="1" /> <small>Normal</small><br />
                <input name="huskmig" type="radio" value="1" /> <small>Tilkald til maskiner</small>
            </label>
            </div>
        </div> -->
    ...
    'end if
			...
			if browstype_client = "ip" then
				...
				'New server response.redirect "http://timeout2.outzource.dk/timeout_xp/wwwroot/ver2_14/timetag_web/timetag_web.asp?flushsessionuser=1"
			    response.redirect "https://outzource.dk/timeout_xp/wwwroot/ver2_14/timetag_web/timetag_web.asp?flushsessionuser=1"	
