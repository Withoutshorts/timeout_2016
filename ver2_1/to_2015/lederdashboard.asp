...
<div class="wrapper">
    ...
    <div class="container">
         ...
         <div class="portlet">
        <h3 class="portlet-title"><u>Leder Dashboard</u></h3>

        <div class="well">
              <form action="lederdashboard.asp?sogsubmitted=1" method="POST">
                <div class="row">
                    <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                                 ...
                                 <select name="FM_medarb" class="form-control input-small" size="7">
                                <%
        ...
        JobSQLkri = jobidsStr
            ...
            if grp_jo_bruttofortj <> 0 AND isNull(grp_jo_bruttofortj) <> true then
