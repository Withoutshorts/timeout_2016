...
<%
    ...
    hidelist = request("hidelist")
     ...
     if hidelist = 2 then 'fra menu - nustiller helt 1: fra rediger slet, hsuker søgnng, men viser ikke liste før klik søg
    ...
    if len(trim(request("FM_kunde"))) <> 0 OR hidelist = 0 then
                ...
                if len(trim(request("FM_kunde"))) <> 0 then 'har slettet sin søgning på joblisten
    ...
    usedatoKri = "n"
    if len(request("FM_kunde")) <> 0 then 'Er der søgt
    ...
    ' Henter cookie om drop down menu skal være slået ud
...
<%end if %>
            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                        ...
                        <form action="job_list.asp?" method="post">       
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                             ...
                             </div><!-- SLUT søg projekter udviddet -->
                    ...
                    <form action="job_list.asp?" method="post">  
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <input name="jobnr_sog" type="text" class="form-control" value="<%=show_jobnr_sog %>" placeholder="Søg" style="width:60%; display:inline-block;" />
                ...
                <div id="actionMenu_jobstatus" class="modal">
                    <div class="modal-content" style="text-align:left; width:300px; height:175px; text-align:center">
                        ...
                        <form action="job_list.asp?func=jobstatusUpdate&jobnr_sog=<%=jobnr_sog %>&FM_kunde=<%=FM_kunde %>&FM_medarb_jobans=<%=medarb_jobans %>" method="post">
                            ...
                            <h4>Ændre Status på de valtge job til</h4>
                            <br />
                ...
                <div id="actionMenu_easyreg" class="modal">
                    <div class="modal-content" style="text-align:left; width:300px; height:175px; text-align:center">
                        ...
                        <form action="job_list.asp?func=easyregUpdate&jobnr_sog=<%=jobnr_sog %>&FM_kunde=<%=FM_kunde %>&FM_medarb_jobans=<%=medarb_jobans %>" method="post">
                            ...
                            Tilføj/Fjern alle aktiviteter på valgte job til easyreg<br />
                ...
                <div id="actionMenu_enddate" class="modal">
                    <div class="modal-content" style="text-align:left; width:300px; height:175px; text-align:center">
                        ...
                        <form action="job_list.asp?func=jobslutdatoUpdate&jobnr_sog=<%=jobnr_sog %>&FM_kunde=<%=FM_kunde %>&FM_medarb_jobans=<%=medarb_jobans %>" method="post">
                            ...
                            <h4>Ændre slutdatoen på de valgte job til</h4>
                            <br />
                ...
                <table class="table dataTable table-striped table-bordered table-hover ui-datatable" id="xjobliste">
                    ...
                    <tbody>
                        ...
                        <%
                            ...
                            select case lto '** Ændret 20190409 -- Alle skal kunne komme ind. De bliver tjekket inde på jobbet og kan ikke ændre status, tiæføje timer mm. hvis status IKKE er aktivt.
                            case "xmpt"
		...
		<%
			    ...
			    while not oRec3.EOF 
                    ...
                    fakDato = job_txt_623&": "& oRec3("labeldato") 'VIS IKKE Faktura sys dato på jioblsiten: Gnidret og manlger overblik & "<br><span style=""color:#999999; size:10px,"">"& oRec3("fakdato") &"</span>"
                    else
