                      ...
                      <table style="background-color:white;" class="table dataTable table-striped table-bordered table-hover ui-datatable">
                                  ...
                                  %>
                                        <tr id="aktvisfont_<%=medarbid(m) %>">
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                &nbsp;<span style="font-size:9px;">(<%=formatnumber(gktimerperiode, 2) %>)</span>
                          ...
                          <tfoot>
                              ...
                              <tr>
                                  ...
                                  <th colspan="2" style="text-align:right; width:20px;">
                                      <input type="submit" class="btn btn-success btn-sm" value="View updates (reload page) >>" />
