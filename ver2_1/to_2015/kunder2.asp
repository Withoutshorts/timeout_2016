...
<%
	...
	case "slet"
	    ...
	    oskrift = tsa_txt_kunder_001 
        slttxta = tsa_txt_kunder_126 & tsa_txt_kunder_127 & tsa_txt_kunder_128
        slttxtb = "" 
    ...
    <div class="container">
      <div class="portlet">
        ...
        <%if func = "red" then %>
         <a class="btn btn-sm btn-default" href="kontaktpers.asp?kid=<%=id %>&issogsubmitted=1" role="button" target="_blank"><%=tsa_txt_kontaktpers_008 %></a>
          ...
          case "epi", "epi_no", "epi_uk", "epi_ab", "intranet - local"
                ...
                <button type="submit" class="btn btn-success btn-sm pull-right" id="sbm_upd0"><b><%=tsa_txt_kunder_042 %></b></button>
                <%else %>
        ...
        <div class="portlet-body">
            ...
            <section>
                <div class="well well-white">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="panel-title-well"><%=tsa_txt_kunder_043 %></h4>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_044 %>&nbsp<span style="color:red;">*</span></div>
                        <div class="col-lg-3">   
                              <input type="text" name="FM_navn" class="form-control input-small" value="<%=strNavn %>" placeholder="Navn"/>
                            </div>
                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-1"><%=tsa_txt_kunder_046 %></div>
                  ...
                  <div class="row">
                         <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2 pad-t5"><%=tsa_txt_kunder_048 %>&nbsp<span style="color:red;">*</span>
                        ...
                        <div class="col-lg-3">   
                            ...
                            <%if func <> "red" then
		                        ...
		                        if kidAaben = 1 then %>
		                        <input type="text" class="form-control input-small" name="FM_knr" value="<%=strKnr%>" placeholder="<%=tsa_txt_kunder_049 %>">
		                        <%else %>
                        ...
                        <div class ="col-lg-1">&nbsp</div>
                        <div class="col-lg-1"><%=tsa_txt_kunder_050 %>:</div>
                        <div class="col-lg-4 pad-r30">   
                              <select class="form-control input-small" name="FM_type" id="FM_type">
                                ...
                                <option value="0" <%=ktype=SEL %>><%=tsa_txt_kunder_051 %></option>
            ...
            <section>
                ...
                <div class="panel-group accordion-panel" id="accordion-paneled">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_053 %></div>
                        <div class="col-lg-3">   
                              <input type="text" name="FM_adr" class="form-control input-small" value="<%=strAdr%>"/>
                            </div>
                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_054 %></div>
                        <div class="col-lg-2">   
                       ...
                       <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_055 %></div>
                        <div class="col-lg-3">   
                         <input type="text" name="FM_postnr" class="form-control input-small" value="<%=strPostnr%>" />
                        </div>
                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_056 %></div>
                        <div class="col-lg-2">   
                       ...
                       <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_057 %></div>
                        <div class="col-lg-3">   
                              <input type="text" name="FM_city" class="form-control input-small" value="<%=strcity%>"  />
                            </div>

                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_058 %></div>
                        <div class="col-lg-2">   
                            ...
                            <div class="row">
                                 <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_059 %></div>
                        <div class="col-lg-3">   
                              <select class="form-control input-small" name="FM_land">
		                        ...
		                        <%else%>
		                        <option SELECTED><%=tsa_txt_kunder_060 %></option>
		                        <%end if%>
		                     </select>
                            </div>
                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_061 %></div>
                        <div class="col-lg-2">   
                       ...
                       <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_062 %></div>
                        <div class="col-lg-3">   
                              <input type="text" name="FM_tlf" class="form-control input-small" value="<%=strtlf%>"  />
                            </div>
                        <div class="col-lg-1">&nbsp</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_063 %></div>
                        <div class="col-lg-2">   
                        ...
                        <div class="col-lg-1">&nbsp</div> 
                            ...
                            <div class="row">
                                <div class="col-lg-1">&nbsp;</div>
                                <div class="col-lg-2"><%=tsa_txt_kunder_064 %></div>
                                <div class="col-lg-3">   
                                      <input type="text" name="FM_mobil" class="form-control input-small" value="<%=strmobil%>"  />
                                    </div>

                                 <div class="col-lg-1">&nbsp;</div>
                                <div class="col-lg-2"><%=tsa_txt_kunder_065 %></div>
                                <div class="col-lg-2">   
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseTwo"><%=tsa_txt_kunder_066 %></a>
                          </h4>
                        </div> <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                         ...
                         <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_067 %></div>
                        <div class="col-lg-1"><%=tsa_txt_kunder_068 %></div>
                        <div class="col-lg-1">   
                             <input type="text" name="FM_regnr" class="form-control input-small" value="<%=intregnr%>"  />
                            </div>
                        <div class="col-lg-1"><%=tsa_txt_kunder_069 %></div>
                        <div class="col-lg-2">   
                            ...
                            <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_070 %></div>
                        <div class="col-lg-3">   
                            ...
                            <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_071 %></div>
                        <div class="col-lg-3">   
                            ...
                            <div class="row">
                        <div class="col-lg-1">&nbsp;</div>
                        <div class="col-lg-2"><%=tsa_txt_kunder_072 %></div>
                        <div class="col-lg-3">   
                            ...
                            <div class="row">
                               <div class="col-lg-1">&nbsp</div>
                                <div class="col-lg-2 pad-t10"><a href="#" id="visflkonti" ><%=tsa_txt_kunder_073 %></a></div>
                           ...
                           <div class="row tr_konti" id="tr_konto<%=konto_ext %>">
                            <div class="col-lg-1">&nbsp;</div>
                            <div class="col-lg-2"><br /><%=tsa_txt_kunder_067 %> <%=kontoalt %>:</div>
                            <div class="col-lg-1"><br /><%=tsa_txt_kunder_068 %></div>
                            <div class="col-lg-1"><br />   
                                 <input type="text" name="FM_regnr<%=konto_ext %>" class="form-control input-small" value="<%=intregnr%>"  />
                                </div>
                            <div class="col-lg-1"><br /><%=tsa_txt_kunder_069 %></div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseThree"><%=tsa_txt_kunder_074 %></a>
                          </h4>
                        </div> <!-- /.panel-heading -->
                    ...
                    <!--selectbox skal opdateres-->
                            ...
                            <div class="row">
                            <div class="col-lg-1">&nbsp</div>
                            <div class="col-lg-10"><br /><%=tsa_txt_kunder_077 %>:
                            ...
                            <div class ="row">
                                <div class="col-lg-1 pad-t20">&nbsp</div>
                                <div class="col-lg-2 pad-t20"><%=tsa_txt_kunder_078 %>
                                    <span style="color:#999999"><%=tsa_txt_kunder_080 %> <b><%=antalfoldere%> folder(e)</b> på denne kunde.
                                        <!--<br>
		                        ...
		                        <option value="0"><%=tsa_txt_kunder_079 %></option>
			                        <%
                            ...
                            <div class="row">
                                <div class="col-lg-1 pad-t20">&nbsp</div>
                                <div class="col-lg-2 pad-t20"><%=tsa_txt_kunder_083 %> 
                                    <span style="color:#999999;"><%=tsa_txt_kunder_086 %><%=tsa_txt_kunder_087 %><%=tsa_txt_kunder_088 %></span></div>
                                <div class="col-lg-2 pad-t20">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseFour"><%=tsa_txt_kunder_090 %></a>
                          </h4>
                        </div> <!-- /.panel-heading -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-1">&nbsp</div>
                                <div class="col-lg-2"><%=tsa_txt_kunder_091 %><br />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 pad-t10"><%=tsa_txt_kunder_092 %> <br />
                            ...
                            <div class="row">
                                <div class="col-lg-1 pad-t20">&nbsp</div>
                                <div class="col-lg-3 pad-t20"><%=tsa_txt_kunder_001 %>
                                    <% 
	                                select case lto
	                                case "execon", "immenso"
	                                betbetint = 8
                            ...
                            <div class="row">
                                <div class="col-lg-1 pad-t20">&nbsp</div>
                                <div class="col-lg-10 pad-t20"><%=tsa_txt_kunder_115 %>:
                            ...
                            <div class="row">
                                <div class="col-lg-1 pad-t20">&nbsp</div>
                                <div class="col-lg-10 pad-t20"><%=tsa_txt_kunder_016 %>
                    ...
                    <div class="panel panel-default">
		                ...
		                <%=tsa_txt_kunder_0118 %><br />
		             
		                <a href="../timereg/upload.asp?type=kundelogo&kundeid=<%=id%>&jobid=0" target="_blank"><%=tsa_txt_kunder_119 %></a>
                            <br />&nbsp;
                   ...
                   <div class="row">
                    <div class="col-lg-1">&nbsp</div>
                   <div class="col-md-2"><%=tsa_txt_kunder_120 %></div>
                   </div>
                   <%
    ...
    <br /><br /><br />
                     ...
                     <%if func = "red" then %>
                    <div style="font-weight: lighter;"><%=tsa_txt_kunder_123 %><b><%=strDato%></b> af <b><%=strEditor%></b></div>       
                    <%end if %>  
...
<div class="container">
     <div class="portlet">
        <h3 class="portlet-title">
         ...
         <section>
                <div class="row">
                    ...
                    <div class="col-lg-2">
                <button class="btn btn-sm btn-success pull-right"><b><%=tsa_txt_kunder_002 %> +</b></button><br />&nbsp;
                </div>
            </div>
        </section>
         </form>
          ...
          <section>
                <div class="well">
                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-2">
                               <%=tsa_txt_kunder_005 %>:<select name="medarb" class="form-control input-small" onchange="submit()">
				                    <option value="0">Alle</option>
				                    <%
                               ...
                               <div class="col-lg-2"><%=tsa_txt_kunder_006 %>:
                    ...
                    <%
                        ...
                        'call ktyper(name, 150, intuseasfak, autosubmit, level, lto) %></div>
                              <div class="col-lg-2">
                                  ...
                                  <%=tsa_txt_kunder_007 %>)<br /> <select name="ktype" class="form-control input-small" onchange="submit();">
				                    <option value="0">Alle</option>
				                    <%
						                    strSQL = "SELECT navn, id FROM kundetyper ORDER BY navn"
						                    oRec.open strSQL, oConn, 3
                               ...
                               <div class="col-lg-3"><br />
                                    <button type="submit" class="btn btn-secondary btn-sm pull-right"><b><%=tsa_txt_kunder_012 %> >></b></button>
                                   </div>
                              ...
                              <%if menu = "crm" then%>
                                           ...
                                           <div class="row">
                                        <div class="col-lg-4">Interesse:<!------------Skal også oversættes--------------><br /><select name="FM_hotnot" style="width:60px;" onchange="submit()">
        ...
        <div class="portlet-body">
          <script src="js/kundeliste.js" type="text/javascript"></script>
          <table id="kundeliste" class="table dataTable table-striped table-bordered table-hover ui-datatable"> 
             
            <thead>
              <tr>
                <th style="width: 12%"><%=tsa_txt_kunder_024 %></th>
                <th style="width: 15%"><%=tsa_txt_kunder_025 %></th>
                <th style="width: 5%"><%=tsa_txt_kunder_026 %></th>
                <th style="width: 15%"><%=tsa_txt_kunder_027 %></th>
                <th style="width: 5%"><%=tsa_txt_kunder_028 %></th>
                <th style="width: 2%"><%=tsa_txt_kunder_029 %></th>
                <th style="width: 3%"><%=tsa_txt_kunder_030 %></th>
                <th style="width: 10%"><%=tsa_txt_kunder_031 %></th>
                <th style="width: 10%"><%=tsa_txt_kunder_032 %></th>
                <th style="width: 10%"><%=tsa_txt_kunder_033 %></th>
              </tr>
            </thead>
              <tbody>
                   <%
            ...
            <tfoot>
               <tr>
                <th><%=tsa_txt_kunder_024 %></th>
                <th><%=tsa_txt_kunder_025 %></th>
                <th><%=tsa_txt_kunder_026 %></th>
                <th><%=tsa_txt_kunder_027 %></th>
                <th><%=tsa_txt_kunder_028 %></th>
                <th><%=tsa_txt_kunder_029 %></th>
                <th><%=tsa_txt_kunder_030 %></th>
                <th><%=tsa_txt_kunder_031 %></th>
                <th><%=tsa_txt_kunder_032 %></th>
                <th><%=tsa_txt_kunder_033 %></th>
                </tr>
            </tfoot>
            ...
            <section>
                <div class="row">
                  ...
                  <form action="../timereg/kunder_eksport.asp?kpers=1" method="post" target="_blank">
                    ...
                    <input id="Submit5" type="submit" value="<%=tsa_txt_kunder_038 %> (<%=tsa_txt_kunder_039 %>)" class="btn btn-sm" /><br />
