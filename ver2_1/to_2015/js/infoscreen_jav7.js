...
$(document).ready(function () {
    ...
    var frokostvisning = $("#frokostvisning").val();
    frokostvisning = parseInt(frokostvisning)
        ...
        if (lto == "cflow") {
            $.post("?medid=1", { control: "GetEmployeeTel", AjaxUpdateField: "true" }, function (data) {
               ...
               // alert(recipients)
                ...
                messege = "Hei - En alarm har blitt aktivert, vaar saa snill aa forlate bygningen - Med vennlig hilsen, Timeout"
               ...
               // smswin.close();
                ...
                $.post("https://gatewayapi.com/rest/mtsms?token=gAws4-yJSP-ySXOjoDRNcgKvWgTzAbnB1nFEuOdPusswBtRWDQRqiHk35uE8rdYO&message=" + messege + "&" + recipients, function (data) {

                });

                alert("Der er blevet sendt en sms til alle medarbejdere med telefonummer, at de skal forlade byggningen")
