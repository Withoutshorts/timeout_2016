...
$(document).ready(function () {
    ...
    function OmregnTimer() {
        ...
        var eval_fak_svendetimer_string = eval_fak_svendetimer.replace(',', '.')
        var eval_fak_svendetimer_pris_string = eval_fak_svendetimePris.replace(',', '.')
        ...
        var eval_lear_timer_string = lear_timer.replace(',', '.')
        var eval_lear_timepris_string = lear_timepris.replace(',', '.')
        ...
        var eval_easy_reg_timer_string = easy_reg_timer.replace(',', '.')
        var eval_easy_reg_timepris_string = easy_reg_timepris.replace(',', '.')
        ...
        var eval_ikke_fakbar_tid_timer_string = ikke_fakbar_tid_timer.replace(',', '.')
        var eval_ikke_fakbar_tid_timepris_string = ikke_fakbar_tid_timepris.replace(',', '.')
