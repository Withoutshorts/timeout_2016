$(function () {
  ...
  if (lang == '2057') {
      ...
      mondayTxt = "Man<br><br>" + "t:" + felt1 + "<br>n:" + felt8
      tuesdayTxt = "Tir " + felt2 + "t."
      wednedsdayTxt = "Ons " + felt3 + "t."
      thursdayTxt = "Tor " + felt4 + "t."
      fridayTxt = "Fre " + felt5 + "t."
      saturdayTxt = "Lør " + felt6 + "t."
      sundayTxt = "Søn " + felt7 + "t."
