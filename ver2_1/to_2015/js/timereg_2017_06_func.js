    ...
    $(".tjknorm").click(function () {
       ...
       // alert("Tjek med Norm")
        ...
        $('.dcls_1').each(function () {
            ...
            mandagtimer = parseFloat(mandagtimer) + parseFloat(indtastTimer) 
            //alert(thisid)
            ...
            timer_tastet_this_opr_mandag_tot = parseFloat(timer_tastet_this_opr_mandag_tot) + parseFloat(timer_tastet_this_opr) 

            //alert("før timer " + timer_tastet_this_opr + "<br> Ny timer " + indtastTimer)
        });

        // Vi skal minus de allerede oprettede timer, med de totalte timer for dagen, og lægge de nytastede timer til. 
        manTimer_tot = $("#manTimer_tot").val()
        manTimer_tot = manTimer_tot.replace(",", ".")
        if (manTimer_tot != 0) {
            manTimer_tot = manTimer_tot
        }
        else {
            manTimer_tot = 0
        }   

        //alert("total før " + timer_tastet_this_opr_mandag_tot + "total nu" + mandagtimer + "<br> Total indtastet før " + manTimer_tot)

        manTimer_tot_new = (parseFloat(manTimer_tot) - parseFloat(timer_tastet_this_opr_mandag_tot)) + parseFloat(mandagtimer)
        //alert("ny mandag timer " + manTimer_tot_new)

        if (mandagtimer > parseFloat(norm_man)) {
            $("#normTxt").append("<br> Mandag " + $("#datoMan").val())
            visPopup = 1
        }
        ...
        $('.dcls_2').each(function () {
            ...
            tirsdagtimer = parseFloat(tirsdagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_tirsdag_tot = parseFloat(timer_tastet_this_opr_tirsdag_tot) + parseFloat(timer_tastet_this_opr)

        });

        // Vi skal minus de allerede oprettede timer, med de totalte timer for dagen, og lægge de nytastede timer til. 
        
        tirTimer_tot = $("#tirTimer_tot").val()
        //alert("HepHep" + tirTimer_tot)
        tirTimer_tot = tirTimer_tot.replace(",", ".")
        if (tirTimer_tot != 0) {
            tirTimer_tot = tirTimer_tot
        }
        else {
            tirTimer_tot = 0
        }
        //alert("total før " + timer_tastet_this_opr_tirsdag_tot + "total nu" + tirsdagtimer + "<br> Total indtastet før " + tirTimer_tot)

        tirTimer_tot_new = (parseFloat(tirTimer_tot) - parseFloat(timer_tastet_this_opr_tirsdag_tot)) + parseFloat(tirsdagtimer)
        //alert("ny tirsdag timer " + tirTimer_tot_new)

        if (tirsdagtimer > parseFloat(norm_tir)) {
            $("#normTxt").append("<br> Tirsdag " + $("#datoTir").val())
            visPopup = 1
        }
        ...
        $('.dcls_3').each(function () {
            ...
            onsdagtimer = parseFloat(onsdagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_onsdag_tot = parseFloat(timer_tastet_this_opr_onsdag_tot) + parseFloat(timer_tastet_this_opr)
           // alert("herher2")
        });
        ...
        onsTimer_tot = $("#onsTimer_tot").val()
        //alert("HepHep" + onsTimer_tot)
        onsTimer_tot = onsTimer_tot.replace(",", ".")
        if (onsTimer_tot != 0) {
            onsTimer_tot = onsTimer_tot
        }
        else {
            onsTimer_tot = 0
        }
        //alert("før " + timer_tastet_this_opr_onsdag_tot + "nu" + onsdagtimer + "<br> Total indtastet før " + onsTimer_tot)

        onsTimer_tot_new = (parseFloat(onsTimer_tot) - parseFloat(timer_tastet_this_opr_onsdag_tot)) + parseFloat(onsdagtimer)
        //alert("ny onsdag timer " + onsTimer_tot_new)


        if (onsTimer_tot_new > parseFloat(norm_ons)) {
            $("#normTxt").append("<br> Onsdag " + $("#datoOns").val())
            visPopup = 1
        }
        ...
        $('.dcls_4').each(function () {
            ...
            torsdagtimer = parseFloat(torsdagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_torsdag_tot = parseFloat(timer_tastet_this_opr_torsdag_tot) + parseFloat(timer_tastet_this_opr)
        ...
        torTimer_tot = $("#torTimer_tot").val()
       // alert("HepHep" + torTimer_tot)
        torTimer_tot = torTimer_tot.replace(",", ".")
        if (torTimer_tot != 0) {
            torTimer_tot = torTimer_tot
        }
        else {
            torTimer_tot = 0
        }
       // alert("før " + timer_tastet_this_opr_torsdag_tot + "nu" + torsdagtimer + "<br> Total indtastet før " + torTimer_tot)

        torTimer_tot_new = (parseFloat(torTimer_tot) - parseFloat(timer_tastet_this_opr_torsdag_tot)) + parseFloat(torsdagtimer)
       // alert("ny torsdag timer " + torTimer_tot_new)


        if (torsdagtimer > parseFloat(norm_tor)) {
            $("#normTxt").append("<br> Torsdag " + $("#datoTor").val())
            visPopup = 1
        }
        ...
        $('.dcls_5').each(function () {
            ...
            fredagtimer = parseFloat(fredagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_fredag_tot = parseFloat(timer_tastet_this_opr_fredag_tot) + parseFloat(timer_tastet_this_opr)

        });

        // Vi skal minus de allerede oprettede timer, med de totalte timer for dagen, og lægge de nytastede timer til. 

        freTimer_tot = $("#freTimer_tot").val()
       // alert("HepHep" + freTimer_tot)
        freTimer_tot = freTimer_tot.replace(",", ".")
        if (freTimer_tot != 0) {
            freTimer_tot = freTimer_tot
        }
        else {
            freTimer_tot = 0
        }
        //alert("før " + timer_tastet_this_opr_fredag_tot + "nu" + fredagtimer + "<br> Total indtastet før " + freTimer_tot)

        freTimer_tot_new = (parseFloat(freTimer_tot) - parseFloat(timer_tastet_this_opr_fredag_tot)) + parseFloat(fredagtimer)
        //alert("ny fredag timer " + freTimer_tot_new)



        if (freTimer_tot_new > parseFloat(norm_fre)) {
            $("#normTxt").append("<br> Fredag " + $("#datoFre").val())
            visPopup = 1
        }
        ...
        $('.dcls_6').each(function () {
            ...
            lordagtimer = parseFloat(lordagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_lordag_tot = parseFloat(timer_tastet_this_opr_lordag_tot) + parseFloat(timer_tastet_this_opr)
        });

        // Vi skal minus de allerede oprettede timer, med de totalte timer for dagen, og lægge de nytastede timer til. 

        lorTimer_tot = $("#lorTimer_tot").val()
       // alert("HepHep" + lorTimer_tot)
        lorTimer_tot = lorTimer_tot.replace(",", ".")
        if (lorTimer_tot != 0) {
            lorTimer_tot = lorTimer_tot
        }
        else {
            lorTimer_tot = 0
        }
       // alert("før " + timer_tastet_this_opr_lordag_tot + "nu" + lordagtimer + "<br> Total indtastet før " + lorTimer_tot)

        lorTimer_tot_new = (parseFloat(lorTimer_tot) - parseFloat(timer_tastet_this_opr_lordag_tot)) + parseFloat(lordagtimer)
       // alert("ny lordag timer " + lorTimer_tot_new)

        if (lorTimer_tot_new > parseFloat(norm_lor)) {
            $("#normTxt").append("<br> Lørdag " + $("#datoLor").val())
            visPopup = 1
        }
        ...
        $('.dcls_7').each(function () {
            ...
            sondagtimer = parseFloat(sondagtimer) + parseFloat(indtastTimer)
            ...
            timer_tastet_this_opr_sondag_tot = parseFloat(timer_tastet_this_opr_sondag_tot) + parseFloat(timer_tastet_this_opr)
        });


        // Vi skal minus de allerede oprettede timer, med de totalte timer for dagen, og lægge de nytastede timer til. 

        sonTimer_tot = $("#sonTimer_tot").val()
        //alert("HepHep" + sonTimer_tot)
        sonTimer_tot = sonTimer_tot.replace(",", ".")
        if (sonTimer_tot != 0) {
            sonTimer_tot = sonTimer_tot
        }
        else {
            sonTimer_tot = 0
        }
        //alert("før " + timer_tastet_this_opr_sondag_tot + "nu" + sondagtimer + "<br> Total indtastet før " + sonTimer_tot)

        sonTimer_tot_new = (parseFloat(sonTimer_tot) - parseFloat(timer_tastet_this_opr_sondag_tot)) + parseFloat(sondagtimer)
        //alert("ny sondag timer " + sonTimer_tot_new)


        if (sonTimer_tot_new > parseFloat(norm_son)) {
            $("#normTxt").append("<br> Søndag " + $("#datoSon").val())
            visPopup = 1
        }


       /* if ((mandagtimer > parseFloat(norm_man)) || (tirsdagtimer > parseFloat(norm_tir)) ) {
            alert("Du har indstatere flere timer end din norm")
        } */
