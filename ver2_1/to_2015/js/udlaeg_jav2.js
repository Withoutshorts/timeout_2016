$(document).ready(function () {
    ...
    $("#matsub").click(function () {
        ...
        if (error == 0)
        {
            $.post("?jobid=" + jobid + "&aktid=" + aktid + "&mid=" + mid + "&navn=" + navn + "&FM_pris=" + FM_pris + "&valuta=" + valuta + "&gruppe=" + gruppe + "&personlig=" + personlig + "&intkode=" + intkode + "&matregid=" + matregid + "&mat_func=" + mat_func, { control: "indlasmat", AjaxUpdateField: "true" }, function (data) {
