                ...
                $.ajax({
                    ...
                    success: function (json) {
                      ...
                      //  alert(basic_kurs + ' ' + basic_valuta + ' ' + basic_belob);
                       ...
                       $.post("?jobid=" + jobid + "&aktid=" + aktid + "&mid=" + mid + "&navn=" + navn + "&FM_pris=" + FM_pris + "&valuta=" + valuta + "&gruppe=" + gruppe + "&personlig=" + personlig + "&intkode=" + intkode + "&matregid=" + matregid + "&mat_func=" + mat_func + "&basic_valuta=" + basic_valuta + "&basic_kurs=" + basic_kurs + "&basic_belob=" + basic_belob, { control: "FN_indlasmat_matudlaeg2015", AjaxUpdateField: "true" }, function (data) {
