...
$(document).ready(function () {
    ...
    //alert("HER" + $.cookie("showavanceret2"))
    ...
    $(".planlaeg").click(function () {
       ...
       //alert("HEPHEP")
        ...
        //alert(arr[0] + ":" + arr[1] + " HasClass:" + $(this).hasClass("chk"))

        if ($(this).hasClass("chk") == true) {
            ...
            if ($(this).hasClass("a0") == true) {
                $(this).css('background-color', '#003399');
            }

            if ($(this).hasClass("a1") == true) {
                $(this).css('background-color', 'yellowgreen');
            }

            if ($(this).hasClass("a2") == true) {
                $(this).css('background-color', 'yellow');
            }

            if ($(this).hasClass("a3") == true) {
                $(this).css('background-color', 'lightblue');
            }

            if ($(this).hasClass("a4") == true) {
        ...
        jobid = $("#planlaeg_jobid_" + arr[3] + "").val()
        aktid = $("#planlaeg_aktid_" + jobid +"_"+ arr[1]+"").val()
        

        //alert(jobid + " aktid: " + aktid)

        medid = 0
        var datoThis = new Date($("#ddplan_0").val());
       
        var yyyy = datoThis.getFullYear().toString();
        var mm = (datoThis.getMonth()+1).toString(); // getMonth() is zero-based
        var dd = (datoThis.getDate() + arr[2]*1).toString();
        datoThis = dd + "/" + mm + "/" + yyyy

        //alert(datoThis.addDays(arr[2]))
        //alert(dd + "/"+ mm + "/" + yyyy)
        //datoThis = datoThis.addDays(arr[2])
        //datoThis = 
            
        
        //var newRekvnr = $("#aa_job_rekvnr_" + thisid).val();
        //alert(newRekvnr);

        $.post("?medid=" + medid + "&jobid=" + jobid + "&aktid=" + aktid + "&dothis=" + dothis + "&datothis=" + datoThis, { control: "FN_updaterplan", AjaxUpdateField: "true" }, function (data) {
    ...
    $("#sp_avanceret_1").click(function () {
        ...
        if ($(".dv_avanceret_1").css('display') == "none") {
            ...
            //$.cookie("showavanceret", "1");
            document.cookie = "showavanceret=1"; 

        } else {

            $(".dv_avanceret_1").hide("fast");
            //$.cookie("showavanceret", "0");
            document.cookie = "showavanceret=0";
        }
    ...
    //var username = getCookie("showavanceret");
    //if (username != "") {
    ...
    $(".aa_job_rekvnr").click(function () {
       ...
       // alert("HEPHEP")
        ...
        $.post("?jobid=" + thisid + "&newRekvnr=" + newRekvnr, { control: "FN_updaterekvnrkom", AjaxUpdateField: "true" }, function (data) {

            $("#rekvnrGemt_" + thisid).show();
            $("#rekvnrGemt_" + thisid).hide(3000);
          //  alert("Updated");
    ...
    $(".Xstadeupdate").change(function () {
        ...
        $.post("?jobid=" + jobid, { control: "FN_update_stadeopdateret", AjaxUpdateField: "true" }, function (data) {
        });


        $("#sp_stadeopt_" + thisval).css("visibility", "visible")


        setTimeout(function () {
            // Do something after 5 seconds

            $("#sp_stadeopt_" + thisval).css("visibility", "hidden")
        }, 1000);
