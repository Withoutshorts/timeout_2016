...
$(document).ready(function () {
    ...
    function afvisgodkendAll() {
        ...
        medidsnew = stripDuplicateValues(medids)
        alert("medier " + medidsnew)

        //alert("afvist");

        $.post("?multi=1&tid=" + tids + "&medid=" + medids, { control: "afvisuge", AjaxUpdateField: "true" }, function (data) {
            ...
            alert("id'er " + tids + " Medid'er " + medids)
