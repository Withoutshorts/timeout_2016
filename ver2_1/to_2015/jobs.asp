                         ...
                         '****************************************
                            ...
                            syncaktdatoer = 0
                                ...
                                if func = "dbred" then
                                    ...
                                    'Rediger nuværeende aktiviteter
                                    ...
                                    next
                                    'response.End
                                    ' Opretter tilføjede aktiviteter
                                ...
                                '******* Opret folder **************'    
                                'Skal Måske kun være hvis slået til i kontrol-panel 
                                    ...
                                    'if request("FM_opret_folder") <> "" then 'Opretter hvis slået til i kontrol panel.
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row pad-b5">
                                    <div class="col-lg-1">
                                        ...
                                        <%'else %>
                                       <!-- Jobansvarlig:<br />
                                        <span style="font-size:8px; white-space:nowrap;">Tilføj flere ved rediger</span> -->
                                        <%'end if %>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <div class="row pad-b5">   
                                    ...
                                    <div class="col-lg-2"><span id="modal_fomr" class="picmodal"><u>Forretningsområder</u></span> &nbsp <!--<span id="modal_fomr" style="color:cornflowerblue;" class="fa fa-plus picmodal"></span>--></div>
                                    <div class="col-lg-3">
                                        <%
                                            if func = "red" then
                                ...
                                <table id="activtyTable" class="table dataTable table-striped table-bordered table-hover ui-datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="akttable akttable_alloker" id="aktheader_alloker">Allokér</th>
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="100" style="text-align:center;">Opret Job før aktiviteter</td>
                                        </tr>
                                        <%
