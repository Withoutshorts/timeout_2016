...
case "FN_getKunder"
                             ...
                             if len(trim(request("sogkunde"))) <> 0 then
                             kundesog = request("sogkunde")
                             else
                             kundesog = "X345dfg5542"
                             end if


    
                                k = 0
                                 strSQLkpersCount = "SELECT kid, kkundenavn FROM kunder WHERE kid <> 0 AND ketype <> 'e' AND (useasfak <= 2) AND kstatus = 1 AND (kkundenavn LIKE '%"& kundesog &"%' OR kkundenr = '"& kundesog &"') ORDER BY kkundenavn"
				                ...
				                oRec2.open strSQLkpersCount, oConn, 3
					               ...
					               if k = 0 then
                                   Response.Write "<option value='0'>Ingen kunder fundet / No customers found</option>"
                                   end if
...
<!--
	...
	<%if cdbl(visaspopup) = 0 then %>
                ...
                <SCRIPT language=javascript src="js/fak_func_2007_1.js"></script>
             ...
             <div class="container">
            <div class="portlet">
                <h3 class="portlet-title">Create/edit Invoice</h3>
