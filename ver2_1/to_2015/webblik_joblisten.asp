...
if len(session("user")) = 0 then
    ...
    Ved visning af mange job (+300), kan der være lidt ekstra ventetid efter siden er loadet. Først når denne boks forsvinder helt er siden klar.<br /><br />
	...
	<% 
		...
		if len(request("FM_kunde")) <> 0 then 'Er der submitted
            ...
            if jobnr_sog <> "-1" then '** ER DER SØGT eller er feltet tomt? 
...
<div class="wrapper">
      <div class="content">
          <div class="container" style="width:90%;"> <!-- <%=containerWdt %> -->
              <div class="portlet">
                  <h3 class="portlet-title"><u>Igangværende Job</u></h3>
    ...
    <b>Job / kundeansvarlig</b> vis kun job hvor valgte medarb. er: <br />
        ...
        %>
         ...
         <b>Søg på jobnavn ell. jobnr.:<br /><span style="font-size:9px; font-weight:lighter; line-height:14px;">(% wildcard, <b>231, 269</b> specifik, <b>201--225</b> (dobbelt bindestreg) interval, eller <b>< ></b> - MAX 5000 job)</span></b>
	...
	<td valign=top style="padding-left:20px;">
        ...
        Viser kun job der opfylder følgende kriterie:
    ...
    <%if print <> "j" then %>
        ...
        <select name="st_sl_dato" class="form-control input-small" style="width:400px;">
            ...
            <option value="4" <%=st_sl_DatoChk4 %>>Der var aktivt: alle job + lukkede job hvor Lukkedato > Slutdato i periode. (igangværende arb.)</option>
   ...
   <%else 
    ...
    <%if print <> "j" then %>
            ...
            <select name="visSimpel" class="form-control input-small" style="width:300px;">
                ...
                <!--<option value="3" <%=visSimpelCHK3 %>>Nøgletal ÅTD</option>-->
        ...
        <br />
          <input type="checkbox" value="1" name="visKol_planlagning" <%=visKol_planlagning_CHK %> /> Vis Planlægning
    ...
    <tr>
        ...
        <br /><br /><div id="dv_projektgrp" style="position:relative; width:350px; left:20px; background-color:#F7F7F7; padding:20px; display:<%=dv_prg_dsp%>; visibility:<%=dv_prg_vzb%>;"><b>Vælg projektgrupper:</b> (og klik "vis joblisten >> ")<br />
   ...
   <%end if 'print
	...
	<thead>
        ...
        <%end select %>
         ...
         <%if cint(visKol_rekvnr) = 1 then%>
        <th >Rekvitisions nr.<br />Pre. konditioner mødt.</th>
        <%end if %>
       ...
       <th>&nbsp;</th>
        ...
        case 2%>
        <th>Realiseret</th>
		<th>WIP - (Igangværende arb.<br /> baseret på restestimat)</th>
	...
	<tr bgcolor="<%=bgthis%>">
       ...
       <!--  <td valign=top style="padding:6px 3px 3px 3px; border-top:<%=btop%>px #cccccc solid; border-left:1px #cccccc solid; white-space:nowrap;">
        ...
        joDbbelob = oRec("jo_bruttofortj")%>
          ...
          <tr><td  style="background-color:#FFFFFF;">DB beløb: </td>
      ...
      <%end select%>
		...
		<%if print <> "j" then %>
        <input type="text" style="width:160px; color:#999999; font-style:italic; font-size:10px;" maxlength="60" value="Job tweet..(åben for alle)" class="FM_job_komm form-control input-small" name="FM_job_komm_<%=oRec("id")%>" id="FM_job_komm_<%=c%>">
        ...
        <%
            if lto = "dencker" OR lto = "intranet - local" OR lto = "hidalgo" then %>
                <td valign="top" style="padding-left:10px; border-left:1px #CCCCCC solid;">
                    ...
                    <%
                      '*** Henter de 3 planlægnings aktivieter 
                        ...
                        &" WHERE fase = 'planlæg' AND fakturerbar = 91 AND a.job = "& oRec("id") &" GROUP BY fr2.for_aktid ORDER BY a.sortorder, fr1.for_fomr"
                        ...
                        '*** Hvis bare en er aktiv er den grøn. 
                            ...
                            <td style="padding-left:10px;">
                                <%
                                 ...
                                 ill = "dot_gron.gif"
                                        ...
                                        if fomr_sumtimer(fot) <> 0 then 'Der INGEN aktive og ingen timer = HVID eller RØD
                    ...
                    <input id="Hidden6" name="visSimpel" value="<%=visSimpel%>" type="hidden" />
                     ...
                     <tr>
                        ...
                        <td>
                          ...
                          <input type="checkbox" value="1" name="eksDataNrl" <%=eksDataNrlCHK %> /> Nøgletal (Salgsomk mm. hvis udviddet valgt)<br />
                            <input type="checkbox" value="1" name="eksDataNr3" <%=eksDataNr3CHK %> /> WIP (Kun hvis nøgletal og udviddet valgt)<br />
