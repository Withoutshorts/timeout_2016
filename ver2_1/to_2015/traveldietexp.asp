                ...
                <table class="table-stribed table" width="100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><%=tsa_txt_traveldp_033 %></th>
                            <th><%=tsa_txt_traveldp_034 %></th>
                        </tr>
                ...
                %>
                      ...
                      <div class="row">
                             <div class="col-lg-10">&nbsp;
                                ...
                                <p style="color:green;"><%=tsa_txt_traveldp_032 %></p>
                                <%end if %>

                             </div>
                             <div class="col-lg-1">
                            <input type="submit" value="<%=tsa_txt_traveldp_004 %> >>" class="btn btn-sm btn-success pull-right"><br />&nbsp;
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="porlet">
            ...
            <h3 align="center" class="portlet-title">
               <%=tsa_txt_traveldp_001 %>
            </h3>
            
            <div class="portlet-body" style="width:400px;">
                <div align="center"><%=tsa_txt_traveldp_035 %>
                </div><br />
                <div align="center"><b><a href="traveldietexp.asp?func=sletok&id=<%=id%>&aar=<%=aar%>&medarb=<%=usemrn%>"><%=tsa_txt_traveldp_038 %></a></b>&nbsp&nbsp&nbsp&nbsp<b><a href="kundetyper.asp?"><%=tsa_txt_traveldp_039 %></a></b>
                </div>
                <br /><br />
                </div>
            </div>
...
<div class="container">
    <div class="porlet">
        <h3 class="portlet-title"><u><%=tsa_txt_traveldp_001 %></u></h3>
        ...
        <%if media <> "export" then %>
                       ...
                       <form method="post" action="traveldietexp.asp?issubmitted=1">
                        ...
                        <section>
                            <div class="well">
                                 <div class="row">
                                         <div class="col-lg-4 pad-t5"><%=tsa_txt_traveldp_002 %><br /> 
                                             <%
                                             ...
                                             <option value="0" <%=visAlleSel%>><%=tsa_txt_traveldp_037 %></option>
                                            <%end if %>
                                         </select>    
                                         </div>
                                                ...
                                                <div class="col-lg-2 pad-t5"><%=tsa_txt_traveldp_030 %>
                                              ...
                                              <div class="col-lg-1 pad-t20">
                                                    <button type="submit" class="btn btn-secondary btn-sm pull-right"><b><%=tsa_txt_traveldp_031 %> >></b></button>
                                             </div>
        ...
        <form action="traveldietexp.asp?func=opdaterlist" method="post">
            ...
            <section>
                         <div class="row">
                             ...
                             <div class="col-lg-2">
                            <input type="submit" value="<%=tsa_txt_traveldp_027 %> >>" class="btn btn-sm btn-success pull-right"><br />&nbsp;
                            </div>
                        </div>
                </section>
               ...
               <thead>
                    ...
                    <tr style="background-color:#FFFFFF;">
                      ...
                      <th style="border:0;">&nbsp;</th>
                       ...
                       <th colspan="4" style="border-bottom:0; background-color:#D6DFf5;"><%=tsa_txt_traveldp_016 %></th>
                   ...
                   <tr>
                      <th style="width: 5%"><%=tsa_txt_traveldp_005 %></th>
                       <th style="width: 15%"><%=tsa_txt_traveldp_006 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_007 %></span></th>
                       <th style="width: 15%"><%=tsa_txt_traveldp_008 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_007 %></span></th>
                       <th style="width: 15%"><%=tsa_txt_traveldp_010 %></th>
                       <th style="width: 15%"><%=tsa_txt_traveldp_011 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_012 %></span></th>
                       <!--
                       <th style="width: 10%">Kontonr</th>
                       -->
                       <th style="width: 5%"><%=tsa_txt_traveldp_013 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_014 %></span></th>
                       <th><%=tsa_txt_traveldp_015 %></th>
                      
                       <th style="width: 7%; background-color:#D6DFf5;"><%=tsa_txt_traveldp_017 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_018 %></span></th>
                       <th style="width: 7%; background-color:#D6DFf5;"><%=tsa_txt_traveldp_019 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_018 %></span></th>
                       <th style="width: 7%; background-color:#D6DFf5;"><%=tsa_txt_traveldp_021 %><br /><span style="font-size:9px;"><%=tsa_txt_traveldp_018 %></span></th>
                       <th style="background-color:#D6DFf5;"><%=tsa_txt_traveldp_023 %></th>
                       <th><%=tsa_txt_traveldp_024 %></th>
                           ...
                           tj_percent = 0
                            ...
                            if media <> "export" then
                                    %>
                                       ...
                                       <a href="#" onclick="Javascript:window.open('traveldietexp.asp?func=addmoorejobs&trvlid=<%=oRec("diet_id")%>&medarb=<%=oRec("diet_mid")%>', '', 'width=600,height=600,top=100,left=400,resizable=no')" target="_blank" class="small"><%=tsa_txt_traveldp_036 %> >></a>
                                   </td>
                ...
                <form action="traveldietexp.asp?media=export&aar=<%=aar%>&medarb=<%=usemrn %>" method="post" target="_blank">
                 ...
                 <div class="row">
                     <div class="col-lg-12 pad-r30">
                         <input id="Submit6" type="submit" value="<%=tsa_txt_traveldp_029 %>" class="btn btn-sm" />
