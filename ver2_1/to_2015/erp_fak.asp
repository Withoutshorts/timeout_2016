...
if len(session("user")) = 0 then
			...
			isInt = 0
					...
					isInt = 0
							...
							'*** Hvis alle required er udfyldt ***'
							        ...
							        istDato = request("FM_istdato") 'request("FM_istdato_aar") & "/" & request("FM_istdato_mrd") & "/" &request("FM_istdato_dag") 
									showistDato = istDato 'request("FM_istdato_dag") & "/" & request("FM_istdato_mrd") & "/" &request("FM_istdato_aar") 
									
									istDato2 =  request("FM_istdato2") 'request("FM_istdato2_aar") & "/" & request("FM_istdato2_mrd") & "/" &request("FM_istdato2_dag") 
									showistDato2 = istDato2 'request("FM_istdato2_dag") & "/" & request("FM_istdato2_mrd") & "/" &request("FM_istdato2_aar") 
									
									labelDato = request("FM_labelDato") 'request("FM_labelDato_aar") & "/" & request("FM_labelDato_mrd") & "/" &request("FM_labelDato_dag") 
									
									
									fakDato = Request("FM_fakdato") 'Request("FM_fakdato_aar") & "/" & Request("FM_fakdato_mrd") & "/" & Request("FM_fakdato_dag") '& time 
	...
	%>
	 ...
	 <div id=menu style="position:absolute; top:31px; width:1200px; display:none; visibility:hidden;">

                   

	                <div id="knap_joblogdiv" style="position:absolute; display:<%=sideDivDsp%>; visibility:<%=sideDivVzb%>; top:-60px; width:50px; left:813px; border:1px #8cAAe6 solid; padding:3px 3px 3px 3px; background-color:#FFFFFF;">
                    <a href="#" onclick="showdiv('joblogdiv')" class=vmenu><%=erp_txt_038 %></a>
	                </div>
	                
	                <div id="knap_matlogdiv" style="position:absolute; display:<%=sideDivDsp%>; visibility:<%=sideDivVzb%>; top:-60px; width:150px; left:873px; border:1px #8cAAe6 solid; padding:3px 3px 3px 3px; background-color:#FFFFFF;">
                    <a href="#" onclick="showdiv('matlogdiv')"  class=vmenu><%=erp_txt_198 %></a>
	                </div>

                    <div id="knap_faksogdiv" style="position:absolute; display:<%=sideDivDsp%>; visibility:<%=sideDivVzb%>; top:-60px; width:100px; left:1233px; border:1px #8cAAe6 solid; padding:3px 3px 3px 3px; background-color:#FFFFFF; z-index:2000000;">
  ...
  <ul class="navbar-nav">
    <li class="nav-item" id="knap_fidiv" style="padding:10px; background-color:#FFFF99;">
      <a class="nav-link" href="#"  onclick="showdiv('fidiv')"><span style="font-size:75%;"><%=erp_txt_200 %></span><br />
          <%=erp_txt_001 &" "& erp_txt_201 %></a>
    </li>
    <li class="nav-item" id="knap_modtagdiv" style="padding:10px;">
      <a class="nav-link" href="#" onclick="showdiv('modtagdiv')"><span style="font-size:75%;"><%=erp_txt_202 %></span><br />
          <%=erp_txt_203 &" "& erp_txt_204 %></a>
    </li>
    <li class="nav-item" id="knap_jobbesk" style="padding:10px;">
      <a class="nav-link" href="#" onclick="showdiv('jobbesk')"><span style="font-size:75%;"><%=erp_txt_205 %></span><br />
          <%=erp_txt_206 &" "& erp_txt_207 %></a>
    </li>

    <li class="nav-item" id="knap_aktdiv" style="padding:10px;">
      <a class="nav-link" href="#" onclick="showdiv('aktdiv')"><span style="font-size:75%;"><%=erp_txt_205 %></span><br />
          <%=erp_txt_001 &" "& erp_txt_124%></a>
    </li>

    <li class="nav-item" id="knap_matdiv" style="padding:10px;">
         ...
         <%select case lto
                            case "epi", "epi2017"
                                ...
                                %>
                            <span style="color:#999999;"><%=erp_txt_210 &" "& erp_txt_211 %></span>
                            <%case else %>
                              <a class="nav-link" href="#" onclick="showdiv('matdiv')"><span style="font-size:75%;"><%=erp_txt_209 %></span><br /> 
                                 <%=erp_txt_210 &" "& erp_txt_211 %></a>
                            <%end select %>
    ...
    <li class="nav-item" id="knap_betdiv" style="padding:10px;">
      <a class="nav-link" href="#" onclick="showdiv('betdiv')"><span style="font-size:75%;"><%=erp_txt_212 %></span><br />
          <%=erp_txt_213 &" "& erp_txt_214 %></a>
    </li>
	    ...
	    <div id="genindlaes" style="position:absolute; display:<%=sideDivDsp%>; visibility:<%=sideDivVzb%>; top:120px; left:15px; z-index:2;">
        ...
        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseFiDiv">
		                        ...
		                        %>
			                       ...
			                       <%=erp_txt_082 & " ("&strFaktypeNavn&")" %>

                            </a>                           
                          </h4>
                        </div> 
                        <div id="collapseFiDiv" class="panel-collapse collapse">
    ...
    <!--
	<div id="fidiv" style="position:absolute; display:<%=sideDivDsp%>; visibility:<%=sideDivVzb%>; top:205px; width:100%; left:5px; border:1px #8cAAE6 solid; background-color:#FFFFFF;">
        -->
	...
	<tr>
        ...
        '** Start dato    
		call datofindes(dd_fakopr,request("FM_start_mrd"),request("FM_start_aar"))
        ...
        '** Start dato
        'dd_fakopr = day(now) & "/" & month(now) & "/" & year(now)  
        dd_fakopr = dateAdd("m", -1, now)
		stdato = year(dd_fakopr) & "/" & month(dd_fakopr) & "/" & day(dd_fakopr) 'request("FM_start_aar")&"/"&request("FM_start_mrd")&"/"&dagparset
		showStDato = dd_fakopr 'dagparset&"/"&request("FM_start_mrd")&"/"&request("FM_start_aar")
		
		
		'** Slut dato
		 slutdato = dateAdd("m", 1, stdato)
        slutDagparset = day(slutdato)
        showSlutDato = day(slutdato) & "/" & month(slutdato) & "/" & year(slutdato)
		...
		<!--<input type="text" name="FM_fakdato" id="FM_fakdato" value="<%=strDag%>.<%=strMrd%>.<%=strAar%>" style="display:none; margin-right:5px; width:80px; color:<%=fntCol%>;" <%=readOnly %> />-->
                                        ...
                                        <div class='input-group date' style="width:100px;">
                                              <input class="form-control input-small" type="text" name="FM_fakdato" value="<%=strDag%>-<%=strMrd%>-<%=strAar%>"/>
		...
		istSlutDato = istDato2
            ...
            <div class="form-inline">
                                        ...
                                        <div class='input-group date' style="width:100px;">
                                              <input class="form-control input-small" type="text" name="FM_istdato" value="<%=day(istDato)%>-<%=month(istDato)%>-<%=year(istDato)%>" />
                                              <span class="input-group-addon input-small">
                                                <span class="fa fa-calendar">
                                                </span>
                                            </span>
		 ...
		 &nbsp;&nbsp;<%=erp_txt_090 %>&nbsp;&nbsp;
                                         <div class='input-group date' style="width:100px;">
                                              <input class="form-control input-small" type="text" name="FM_istdato2" value="<%=day(istSlutDato)%>-<%=month(istSlutDato)%>-<%=year(istSlutDato)%>" />
                                              <span class="input-group-addon input-small">
                                                <span class="fa fa-calendar">
                                                </span>
                                            </span>
		...
		</td><td valign=top style="padding:4px 5px 2px 5px;">
                                        
                                        <div class='input-group date' style="width:100px;">
                                              <input class="form-control input-small" type="text" name="FM_labeldato" value="<%=day(labelDato)%>-<%=month(labelDato)%>-<%=year(labelDato)%>"/>
                                              <span class="input-group-addon input-small">
                                                <span class="fa fa-calendar">
                                                </span>
                                            </span>
                                        </div>     	
            <!--include file="inc/erp_labeldato_inc.asp"--></td></tr>
 ...
 <table cellspacing=0 cellpadding=5 border=0 width=100% bgcolor="#ffffff">
	...
	<!-- Faktura indstillinger SLUT -->
        ...
        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseModtagDiv">
                            <%=erp_txt_216 &" & "& erp_txt_070 %>                 
                            </a>                           
                          </h4>
                        </div> 
                        <div id="collapseModtagDiv" class="panel-collapse collapse">
                          <div class="panel-body">
        ...
        %>
	  <!--<div id="modtagdiv" style="position:absolute; display:<%=sideDivDspMod%>; visibility:<%=sideDivVzbMod%>; top:205px; width:720px; left:5px; border:1px #8cAAe6 solid;">-->
	...
	<!-- Job / aftale beskrivelse -->
        ...
        <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapsejobbeskDiv">
                            <%=erp_txt_206 &" "& erp_txt_207  %>                 
                            </a>                           
                          </h4>
                        </div> 
                        <div id="collapsejobbeskDiv" class="panel-collapse collapse">
                          <div class="panel-body">
    ...
    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapsebetdivDiv">
                            <%=erp_txt_213 &" "& erp_txt_214 %>                 
                            </a>                           
                          </h4>
                        </div> 
                        <div id="collapsebetdivDiv" class="panel-collapse collapse">
                          <div class="panel-body">
    ...
    <!--
    <div id=betdiv style="position:absolute; visibility:hidden; top:105px; width:720px;"> 
      -->
    ...
    %>
          <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-target="#collapseaktdivDiv">
                            <%=erp_txt_001 &" "& erp_txt_124%>                
                            </a>                           
                          </h4>
                        </div> 
                        <div id="collapseaktdivDiv" class="panel-collapse collapse">
                          <div class="panel-body">
                ...
                <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                              ...
                              <%if cint(showMat) = 1 then %>
                              <a class="accordion-toggle" data-toggle="collapse" data-target="#collapsematdivDiv">
                                <%=erp_txt_210 &" "& erp_txt_211 %>                
                              </a>
                              <%else %>
                              <%=erp_txt_210 &" "& erp_txt_211 %> 
                              <%end if %>
                        ...
                        <div id="collapsematdivDiv" class="panel-collapse collapse">
                          <div class="panel-body">
    ...
    <!--
     <div id="faksubtotal" style="position:absolute; left:1030px; top:264px; width:200px; z-index:2000; border:1px #8caae6 solid; background-color:#ffffff; padding:5px;">
         -->
