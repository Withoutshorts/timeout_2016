...
<!-- <table id="scrollable" class="table datatable table-bordered" style="background-color:#FFFFFF;">

    <thead>
        <tr>
            <th style="visibility:hidden; display:none">Header 4</th>
            <th>Header 1</th>
            <th>Header 2</th>
            <th>Header 3</th>           
        </tr>
