                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                   <!-- <select id="per_interval" name="per_interval" class="form-control input-small">
                                        <option value="1" <%=per_i_enCHK %>>1 måneder frem</option>
                                        <option value="3" <%=per_i_treCHK %>>3 måneder frem</option>
                                        <option value="6" <%=per_i_6CHK %>>6 måneder frem</option>
                                        <option value="12" <%=per_i_tolvCHK %>>12 måneder frem</option>
                                    </select> -->
