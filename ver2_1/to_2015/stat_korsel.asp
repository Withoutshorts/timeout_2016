...
<%
    ...
    startdato = request("fradato")
    else
    startdato = day(now) &"-"& month(now) &"-"& year(now)
    end if
    
    if len(request("tildato")) <> 0 then
    slutdato = request("tildato")
    else
    slutdato = day(now) &"-"& month(now) &"-"& year(now)  
    end if


    %>
    <script src="js/stat_korsel_jav.js"></script>
    <%
    function ArTilDatoKm()
	%>
	 År -> Dato (<%=formatdatetime(slutdato) %>) :
...
%>
    ...
    <div class="container">
        <div class="portelt">
            <h3 class="portlet-title"><u>Kørsels statistik</u></h3>
            <div class="portlet-body">
                <div class="well">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                                ...
                                <input name="fradato" type="text" class="form-control input-small" placeholder="dd-mm-yyyy" value="<%=startdato %>" />
                            ...
                            <div class="col-lg-2">
                                <div class='input-group date' id='datepicker_stdato'>
                                <input name="tildato" type="text" class="form-control input-small" placeholder="dd-mm-yyyy" value="<%=slutdato %>" />
                                <span class="input-group-addon input-small">
                                        <span class="fa fa-calendar">
                                        </span>
                                    </span>
                    ...
                    <%if media <> "print" then %>
                    <div class="row">
                        <div class="col-lg-4"><input type="checkbox" name="FM_sumprmed" id="FM_sumprmed" value="1" <%=sumChk%>> Vis sum fordelt pr. medarbejder og 60 dages regel.
			            24 md. forud for slut dato i valgt interval.</div>
                        <div class="col-lg-3">&nbsp</div>
                        <div class="col-lg-2 pad-b10">
                        <button type="submit" class="btn btn-secondary btn-sm pull-right"><b>Vis</b></button>
                        </div>
                    </div>
                    </form>
                    <%else %>
                    <%dontshowDD = "1" %>
                    <!--#include file="../timereg/inc/weekselector_s.asp"-->
                    <%end if %>
                </div>
                ...
                sqlDatoStart = year(startdato)&"/"&month(startdato)&"/"&day(startdato)
	            sqlDatoSlut = year(slutdato)&"/"&month(slutdato)&"/"&day(slutdato)
                ...
                datoStart = "2017-01-01" 'skal laves i de nye datovælgere
                datoSlut = "2018-01-01" 'skal laves i de nye datovælgere
 
	            if showTot = 0 then 
                %>
                <div class="row">
                    <div class="col-lg-1">Periode:</div><div class="col-lg-4"><%=formatdatetime(startdato, 1)%> til <%=formatdatetime(slutdato, 1)%></div>
                </div>
                ...
                <table class="table dataTable table-bordered ui-datatable">
                    <thead>
                        <tr>
                            <th valign=bottom class=alt style="border-bottom:1px #cccccc solid;"><b>Dag</b></th>
                            <th valign=bottom class=alt style="border-bottom:1px #cccccc solid;"><b>Medarbejder</b></th>
                            <th valign=bottom class=alt style="border-bottom:1px #cccccc solid;"><b>Kontakt</b>(kunde)<br />Job</th>
                            <th valign=bottom class=alt style="border-bottom:1px #cccccc solid;"><b>Aktivitet</b></th>
                            <th valign=bottom class=alt style="width:200px; border-bottom:1px #cccccc solid;"><b>Kommentar</b></th>
                            <th valign=bottom valign=bottom class=alt style="border-bottom:1px #cccccc solid;"><b>Bopælstur</b><br />
                            (60 dages regel)</th>
                            <th valign=bottom class=alt style="width:200px; border-bottom:1px #cccccc solid;"><b>Destination</b><br />
                            (60 dages regel)</th>
                            <th valign=bottom class=alt align=right style="border-bottom:1px #cccccc solid;"><b>Km</b></th>
                        </tr>
                    </thead>
                    <tbody>
                        <%
                ...
                %>
                <div class="row"><div class="col-lg-2">Periode</div><div class="col-lg-4"><%=formatdatetime(startdato, 1)%> til <%=formatdatetime(slutdato, 1)%></div></div>
                <table class="table dataTable table-striped table-bordered ui-datatable">
                    <thead>
                        <tr bgcolor="#5582d2">
	                       <th class=alt style="width:120px;"><b>Medarbejder</b></th>
	                       <th class=alt style="width:180px;"><b>Kørsel til destination</b></th>
	                       <th class=alt style="width:150px;"><b>Periode</b></th>
	                        <th class=alt align=right style="padding-right:20px;"><b>Antal dage med<br /> kørsel i periode</b></th>
	                       <th class=alt align=right style="padding-right:20px;"><b>Antal dage med <br />skattefri godtgørelse</b></th>
	                       <th class=alt align=right style="padding-right:20px;"><b>Akkumuleret pr. destination</b><br />
	                       (foregående 24 md. periode<br />nulstillet af mellemlig.<br /> periode på min. arb. 60 dage)
	                       </th>
	                       <th class=alt align=right style="padding-right:20px;"><b>Resterende dage</b></th>
                        </tr>
                    </thead>
                ...
                <div class="row">
                    <div class="col-lg-2"><a href="#" onclick="Javascript:window.open('stat_korsel.asp?media=export&FM_sumprmed=<%=showtot %>&medarbSel=<%=medarbSel %>', '', 'width=100,height=100,resizable=no,scrollbars=no')" class="btn btn-default btn-sm"><b>.csv fil export</b></a></div>                    
                </div>
                <div class="row">
                    <div class="col-lg-2"><a href="stat_korsel.asp?media=print&FM_sumprmed=<%=showtot %>&medarbSel=<%=medarbSel %>" target="_blank" class="btn btn-default btn-sm"><b>Print version</b></a></div>                    
                </div>
                <br /><br />
