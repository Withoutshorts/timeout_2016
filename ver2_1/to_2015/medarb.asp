    ...
    response.end
		...
		SQLBless = tmp
            ...
            if medarb_RFID <> 0 then
                strSQL = "SELECT Mid FROM medarbejdere WHERE medarbejder_rfid = "& medarb_RFID
                oRec.open strSQL, oConn, 3
                if not oRec.EOF then          
                    errortype = 188 'Vi skal have en ny error type
			        call showError(errortype)
                    response.end
                    end if
                oRec.close
			...
			if strMnrOK = "y" AND strLoginOK = "y" AND cint(InitFindes) = 0 then
                ...
                '** Finder medarbejdertypegrp (hvis findes) **'
                    ...
                    &" create_newemployee = "& create_newemployee &", med_lincensindehaver = "& med_lincensindehaver &", medarbejder_rfid = "& medarb_RFID &""_
			        &" WHERE Mid = "& id &""
			    ...
			    if func = "dbopr" then
						    ...
						    &" madr, mpostnr, mcity, mland, mtlf, mcpr, mkoregnr, visskiftversion, medarbejdertype_grp, timer_ststop, create_newemployee, med_lincensindehaver, medarbejder_rfid) VALUES ("_
						    &" '"& strNavn &"',"_
						    &" "& strMnr &","_
						    &" '"& strAnsat &"',"_
						    &" '"& strLogin &"',"_
					        ...
					        &" '"& mtlf &"', '"& mcpr &"', '"& mkoregnr &"', "& visskiftversion &", "& intMedarbejdertype_grp &", "& timer_ststop &", "& create_newemployee &", "& med_lincensindehaver &","& medarb_RFID &")"
...
<%
	...
	if func = "red" then
		...
		&" madr, mpostnr, mcity, mland, mtlf, mcpr, mkoregnr, visskiftversion, timer_ststop, create_newemployee, med_lincensindehaver, medarbejder_rfid "_
