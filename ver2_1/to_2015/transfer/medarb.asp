                ...
                '** Finder medarbejdertypegrp (hvis findes) **'
					...
					if request.servervariables("PATH_TRANSLATED") <> "C:\www\timeout_xp\wwwroot\ver2_1\timereg\medarb_red.asp" then
                        ...
                        if cint(int_glemtpassword_visning) = 1 then                            
                            ...
                            strmailtekst = strmailtekst & medarb_txt_012 &" "& strLogin & vbCrLf
                            strmailtekst = strmailtekst & medarb_txt_150 &": "& newpasswordlink & vbCrLf & vbCrLf
                        else
					        strmailtekst = strmailtekst & medarb_txt_012 &" "& strLogin &" "& medarb_txt_013 &" "& strPw & vbCrLf & vbCrLf
                            strmailtekst = strmailtekst & medarb_txt_014  & vbCrLf
					        strmailtekst = strmailtekst & medarb_txt_015 & vbCrLf & vbCrLf                           
					    ...
					    strmailtekst = strmailtekst & medarb_txt_120 & vbCrLf & vbCrLf & strEditor & vbCrLf 
                         ...
                         if cint(strAnsat) = 1 then 'kun mail til aktive brugere
                              ...
                              if request.servervariables("PATH_TRANSLATED") <> "C:\www\timeout_xp\wwwroot\ver2_1\to_2015\medarb.asp" then
                                    ...
                                    if cint(int_glemtpassword_visning) = 1 then                            
                                        ...
                                        strmailtekst = "" & medarb_txt_009 &" "& strNavn & vbCrLf
                                        strmailtekst = strmailtekst & medarb_txt_010 & vbCrLf & vbCrLf
                                        strmailtekst = strmailtekst & medarb_txt_011 & vbCrLf
                                        strmailtekst = strmailtekst & medarb_txt_012 &" "& strLogin & vbCrLf
                                        strmailtekst = strmailtekst & "Klik her for at lave dit password " & newpasswordlink & vbCrLf & vbCrLf
                                    else
					                     strmailtekst = "" & medarb_txt_009 &" "& strNavn & vbCrLf _ 
                                    ...
                                    mailtextbody = mailtextbody & medarb_txt_135 &": "& to_help & vbCrLf & vbCrLf 
            ...
            <thead>
              ...
              <tbody>
                ...
                <%
                   ...
                   <%strSQL = "SELECT mnavn, mid, email, lastlogin, init, mnr, mansat, brugergruppe, firma, medarbejdertype, mt.type AS mtypenavn, b.navn AS brugergruppenavn, ansatdato, m.editor FROM medarbejdere AS m "_
