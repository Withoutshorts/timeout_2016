                  ...
                  <div class="portlet-body">
                      ...
                      <%if lto = "foa" then
                        if version = 0 AND (level > 2 AND level <> 6) then
                            response.Write "Du har ikke adgang til denne side <a href='medarb_protid.asp?version=1'>Klik for at gå tilbage</a>"
                            response.End
                        end if
                      end if %>
                      ...
                      <table class="table dataTable table-bordered table-hover">
                          ...
                          <tbody>
                              <tr>
                                  <td colspan="15" style="text-align:center;">Ingen søgekriterier valgt</td>
                              </tr>
                          </tbody>
                          <%end if %>
