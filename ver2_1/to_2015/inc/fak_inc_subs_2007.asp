...
'*********************************************'
  ...
  function godkendknap()
    %>
     ...
     <div id="knap_godkend" style="float:right;> <!-- style="position:absolute; visibility:visible; display:; top:46px; width:225px; left:580px; border:1px #6CAE1C solid; padding:3px 5px 10px 5px; background-color:#DCF5BD;" -->
                   
                            <input id="Submit1" class="btn btn-success" type="submit" value="<%=erp_txt_464 %> >>" />
