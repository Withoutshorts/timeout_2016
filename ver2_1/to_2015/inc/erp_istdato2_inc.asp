...
<input type="text" id="FM_istdato2" value="<%=day(istSlutDato)%>.<%=month(istSlutDato)%>.<%=year(istSlutDato)%>" style="display:none; margin-right:5px; width:80px; color:<%=fntCol%>;" <%=readOnly %> />
