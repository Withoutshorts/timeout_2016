                                        ...
                                        <tr>
                                            ...
                                            <%
                                                ...
                                                for d = 0 TO antalmaaned
                                                        ...
                                                        months = months + 1
                                                        dato_medid(d) = dateadd("m",1,dato_medid(d))
                                                        ...
                                                        tjekdatoym = Stryear & (months - 1)       

                                                        if dato_medid(d) = tjekdatoym then
                                                         %>
                                                        <td><%=timer_md(d) %> <%response.write "<br>" & dato_medid(d) %> </td>
                                                    <% 
                                                        else
                                                        
                                                    %>
                                                         
                                                        <td><%response.Write tjekdatoym & "<br>" & dato_medid(d) %></td>
                                                    <%
                                                        end if
