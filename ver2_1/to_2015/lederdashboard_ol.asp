    ...
    <div class="container">
        ...
        <div class="well">
              <form action="lederdashboard.asp?sogsubmitted=1" method="POST">
                <div class="row">
                <div class="col-lg-2">
                <h4 class="panel-title-well">Periode</h4></div>
                    <div class="col-lg-6">&nbsp</div>
                    <div class="col-lg-2"><h4 class="panel-title-well"><input id="viskundogpro" type="checkbox" value="1" /> Kunder og projekter</h4></div>
                </div>
                ...
                <div class="col-lg-2 txt" style="display: none;">Projekter:</div>
                <div class="col-lg-2 txt" style="display: none;">Kunder:</div>
                  ...
                  <div class="row">
                    ...
                    <%strSQLm = "SELECT mid, mnavn, init FROM medarbejdere WHERE mansat = 1 AND (medarbejdertype = 3 OR medarbejdertype = 10 OR medarbejdertype = 28) OR mid  < 60 ORDER BY mnavn"
                      ...
                      <div class="col-lg-2">
                      <select name="FM_medarb" class="form-control input-small txt" style="display: none;" onchange="submit()">
                    <%strSQLm = "SELECT mid, mnavn, init FROM medarbejdere WHERE mansat = 1 AND (medarbejdertype = 3 OR medarbejdertype = 10 OR medarbejdertype = 28) OR mid  < 60 ORDER BY mnavn"
                       oRec3.open strSQLm, oConn, 3
                        while not oRec3.EOF 
