...
<%end if %>
        ...
        <%
            ...
            select case func
                ...
                case "slet"
                    '*** Her spørges om der skal slettes ***
	                    oskrift = "Udlæg" 
...
'******************* Eksport **************************' 
                ...
                if media = "eksport" then
	                ...
	                filnavnKlok = "_"&datepart("h", now)&"_"&datepart("n", now)&"_"&datepart("s", now)
				               ...
				               ' strOskrifter = "Job / akt.; Navn; Dato; Medarbejder; type; Beløb; Valuta; Basis beløb; Basis valuta; Personlig; Godkendt; Afvist; Afregnet"
