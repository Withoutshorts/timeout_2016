    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!string.IsNullOrEmpty(Request["comments"]))
            {
                ...
                //if (!string.IsNullOrEmpty(Request["thisfile"])) {
...
<head runat="server">
    ...
    <%
        string thisfile = Request.QueryString["thisfile"];

        if (thisfile == "favorit") {
                  %>
    <script type="text/javascript" src="../to_2015/js/favorit_jav.js"></script>
    <%

                                     }  else { 
           %>
    <script type="text/javascript" src="inc/timereg_2017_05_func.js"></script>
    <%
    };%>
