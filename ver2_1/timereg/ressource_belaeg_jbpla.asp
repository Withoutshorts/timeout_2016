    ...
    <form action="ressource_belaeg_jbpla.asp?media=print&<%=lnk%>" method="post" target="_blank">   
         ...
         <%if cint(level) = 1 then %>
          ...
          <form action="ressource_belaeg_jbpla.asp?func=overfor&<%=lnk%>" method="post">   
                <tr>
                <td colspan="2"><br /><br /><b><%=resbelaeg_txt_066 %>:</b><br />
                <input type="checkbox" value="1" name="FM_overfor" /><%=resbelaeg_txt_067 %>
                    <span style="color:#999999;"><%=resbelaeg_txt_068 %> </span><br /><br />


                    <%if periodeSel = 3 then %>
                    <%=resbelaeg_txt_069 %>: <select name="FM_overforfra" style="font-size:10px;">
                                    <%for u = 1 to 53 
                                    ...
                                    <%next %>
                                     ...
                                     </select> <br /><%=resbelaeg_txt_070 %>

                    <%else %>

                           <%=resbelaeg_txt_071 %>: <select name="FM_overforfra" style="font-size:10px;">
                                    <%for u = 1 to 12 
