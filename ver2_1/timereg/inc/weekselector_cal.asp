...
<select name="FM_start_dag" style="background-color : #ffffff; border : thin black; font : 10px verdana;">
		...
		<option value="2022">2022</option></select></td>
		<td><input type="image" src="<%=illpath%>ill/soeg-knap.gif">
