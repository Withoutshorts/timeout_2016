...
sub projektberegner
          ...
          if func = "red" OR step = "2" then
                ...
                call bdgmtypon_fn()
                        ...
                        'select case lto
                        'case "epi", "epi_osl", "epi_sta", "intranet - local", "xwwf", "epi_ab", "epi_cati"
               ...
               if cint(grpId) <> cint(lastGrpId) then
                ...
                <!--
                  <tr class="tr_budgetmtyp" style="visibility:<%=budgetmtyp_vzb%>; display:<%=budgetmtyp_dsp%>;"><td colspan=6 align="right" style="border:0px; padding:10px 10px 30px 5px;">
                    ...
                    <%else %>
                     ...
                     <table width=100% cellspacing=0 cellpadding=0 border=0>
                     <tr>
                         <td style="padding:12px 2px 2px 2px; font-size:11px; width:460px;"><b>Bruttoomsætning:</b><br />(nettooms. + salgsomkostninger)</td>
                         <td align=right style="padding:12px 20px 2px 2px; font-size:11px;">= <input type="text" id="FM_budget" name="FM_budget" value="<%=replace(formatnumber(jo_bruttooms, 2), ".", "")%>" style="width:75px; font-size:11px; font-family:arial; border:1px #cccccc solid;" onkeyup="tjektimer('FM_budget'), dbManuel()">&nbsp;&nbsp;&nbsp;&nbsp; <%=basisValISO %></td>
				...
				<tr bgcolor="#FFFFFF">
                    ...
                    %>
                    <td id="xpb_jobnavn">
                    Gns. timepris / kostpris: <span style="color:#999999; font-size:9px;"><%=gnsSalgsogKostprisTxt &" "& basisValISO %></span>
                    </td>
						  
					<td style="padding:3px;"><input type="text" id="FM_budgettimer" name="FM_budgettimer" value="<%=replace(formatnumber(strBudgettimer, 2), ".", "")%>" style="width:60px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd %>" onkeyup="tjektimer('FM_budgettimer'), beregnintbelob()" class="nettooms"></td>
					<td class=lille><input type="text" id="FM_gnsinttpris" name="FM_gnsinttpris" value="<%=replace(formatnumber(jo_gnstpris, 2), ".", "")%>" style="width:67px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd2 %>" onkeyup="tjektimer('FM_gnsinttpris'), beregnintbelob()" class="nettooms"> <%=basisValISO %></td>
               ...
               <!-- <tr>
                ...
                <%
                 ...
                 select case lto
                   case "epi", "epi_osl", "epi_sta", "xintranet - local", "epi_ab", "epi_cati"
				...
				<tr bgcolor="#FFFFFF" id="jq_stamaktgrp" style="visibility:<%=stgrpWzb%>; display:<%=stgrpDsp%>;">
					<td colspan="6" style="padding:5px 5px 5px 2px; border:0px #CCCCCC solid;">
                                ...
                                <%end if %>
                                    ...
                                    select case lto
                                    case "epi", "epi_osl", "epi_sta", "epi_ab", "epi_cati"
                                    opfodCHK0 = ""
                                    opfodCHK1 = "CHECKED"
                                    case else
                                    opfodCHK0 = "CHECKED"
                                ...
                                <b>Projektgrupper:</b><br />
					                ...
					                select case lto
					                case "dencker", "acc", "essens", "fe", "jttek", "wwf", "intranet - local", "epi", "epi_osl", "epi_sta", "epi_ab", "epi_cati"
					                tpCHK1 = ""
					                tpCHK2 = "CHECKED"
				...
				if func = "red" then
                    ...
                    'select case lto
                    'case "epi", "epi_osl", "epi_sta", "intranet - local", "epi_ab", "epi_cati"
                    if cint(showMtberegn) = 1 then
                    aktlist_wzb = "hidden"
                    aktlist_dsp = "none"
                    else
                ...
                <tr class="dv_aktlisten" style="visibility:<%=aktlist_wzb%>; display:<%=aktlist_dsp%>;"><!-- #FFC0CB -->
                    ...
                    <td style="border:0px;" colspan="6">
					    ...
					    <td style="width:335px; padding:5px 0px 5px 5px; font-size:14px;"><b>Aktiviteter & Faser ialt:</b></td>
					    <td style="width:180px; padding:2px 0px 3px 10px;"><span style="padding:2px 2px 2px 2px; background-color:#FFFFFF; width:100px; border-bottom:2px #999999 solid;" id="fasertimertot"><b>0,00</span></td>
                        <input id="FM_fasertimertot" value="0" type="hidden" />
					
					    <td style="padding:2px 0px 3px 10px; white-space:nowrap;">= <span style="padding:2px 2px 2px 2px; background-color:#FFFFFF; width:100px; border-bottom:2px #999999 solid;;" id="fasersumtot"><b>0,00</b></span></td>
...
sub minioverblik
    ...
    <%
        ...
        <%if ((thisfile <> "jobprintoverblik" AND lto = "synergi1") OR lto <> "synergi1") AND intprio > -1 then%>
        <tr>
		    <td><br /><b>Joblog</b></td>
		</tr>
		...
		<b>Timefordeling fordelt på måneder:</b>
        ...
        <tr bgcolor="#FFFFFf">
         <td style="width:40px; border-bottom:1px #cccccc solid; border-right:1px #cccccc solid; padding:2px; font-size:8px;" valign=top>Kvo.: <br /><%=hgtKvo%></td>
            ...
            '*** StDato ***'
            if strStatus <> 1 AND cDate(strUdato) <> cdate("1-1-2044") AND cDate(lkdato) <> "01-01-2002" then 'passiv / lukket og uendelig
            stDatoKriGrf = lkdato 'strUdato 
            stDatoKriGrfDiff = datediff("m", strTdato, lkdato, 2, 2) 'strUdato
            ...
            if (lto = "epi" OR lto = "epi_osl" OR lto = "epi_sta" OR lto = "epi_ab" OR lto = "epi_cati") AND strjobnr = "3" then
            mts = 3
            end if
        ...
        <%end if %>
	        ...
	        '** Kun aktiviteter timer, enh. stk. IKKE mateiler og KM
                  ...
                  if cDate(oRec2("fakdato")) < cDate("01-06-2010") AND (lto = "epi" OR lto = "epi_osl" OR lto = "epi_sta" OR lto = "epi_ab" OR lto = "epi_cati") then
	    ...
	    <br />&nbsp;
	     ...
	     <tr>
	        ...
	        &" antalstk, tidslaas, a.fase, a.sortorder, a.bgr, aktbudgetsum, sum(t.timer) AS realiseret, SUM(timer * timepris *(kurs/100)) AS realbelob, SUM(timer * kostpris *(kurs/100)) AS realtimerkost, aktstartdato, aktslutdato, aty_desc "_
	        ...
	        <tr bgcolor="#FFDFDF">
               ...
               <td align=right class=lille><b><%=formatnumber(totTimerforkalk,2) %> t.</b></td>
                <td>&nbsp;</td>
                <td align=right class=lille><b><%=formatnumber(totSum, 2) %></b> <%=basisValISO %></td>

                <td align=right class=lille><b><%=formatnumber(totReal,2) %></td>
                <td align=right class=lille><b><%=formatnumber(totRealbel, 2) %></b> <%=basisValISO %></td>
	        </tr>    
        ...
        %>
            ...
            %>
                ...
                <tr bgcolor="#FFCC66">
                    ...
                    <td class=lille align="center"><b>Dato</b></td>
	            ...
	            <tr>
                    ...
                    salgsomkostSalg = 0
                    salgsomkostKost = 0
                    strSQLudl = "SELECT matnavn, forbrugsdato, matenhed, matantal AS antal, (matkobspris * (kurs/100)) AS stkkobspris, matkobspris * matantal * (kurs/100) AS matkobspris, matsalgspris * matantal * (kurs/100) AS matsalgspris FROM materiale_forbrug WHERE jobid = "& id & " GROUP BY id" 
                    ...
                    <td class=lille align="center"><%=oRec2("forbrugsdato")%></td>
...
sub timepriser
                   ...
                   <table cellspacing="0" cellpadding="0" border="0" bgcolor="#EFF3FF" width="100%">
					...
					<tr>
                       ...
                       &" WHERE mt.id <> 0 GROUP BY mt.id ORDER BY mt.type" 
