...
$(document).ready(function() {
    ...
    $("#rap_epi_blueg").click(function () {
        ...
        $("#FM_akttype_id_1_0").attr('checked', true);
        $("#FM_akttype_id_1_1").attr('checked', true);
    ...
    $("#rap_cflow_huldt").click(function () {
        ...
        $("#FM_akttype_id_4_21").attr('checked', false); //Overtid ønsket betalt skal ikke med 
    ...
    $("#rap_dencker_datalon").click(function () {
        ...
        $("#FM_akttype_id_0_0").attr('checked', true);

        $("#FM_akttype_id_1_3").attr('checked', true);
        $("#FM_akttype_id_1_4").attr('checked', true);
        $("#FM_akttype_id_1_5").attr('checked', true);
        $("#FM_akttype_id_1_6").attr('checked', true);
        $("#FM_akttype_id_1_9").attr('checked', true);

        $("#FM_akttype_id_2_1").attr('checked', true);

        $("#FM_akttype_id_3_4").attr('checked', true);
        $("#FM_akttype_id_3_5").attr('checked', true);
        $("#FM_akttype_id_3_7").attr('checked', true);
        $("#FM_akttype_id_3_8").attr('checked', true);
        ...
        $("#FM_akttype_id_5_7").attr('checked', true);
        $("#FM_akttype_id_5_8").attr('checked', true);
    ...
    $("#rap_plan_datalon, #rap_intr_datalon").click(function () {
        ...
        $("#FM_akttype_id_0_4").attr('checked', true);
        $("#FM_akttype_id_0_70").attr('checked', true);
        ...
        $("#FM_akttype_id_2_0").attr('checked', true);
        $("#FM_akttype_id_2_1").attr('checked', true);
