...
'*** Fastpris job 1 / Lbn. Timer 0 **'
'*** 100? er den udkommenteret ?
if cint(usefastpris) = 100 then
    ...
    '********************************************************************************'
	 ...
	 '*** aktiviteten ***'
		...
		'*** Kun fakturaer, IKKE kreditnotaer **'
		...
		&" AND (Tdato BETWEEN '" & stdatoKri &"' AND '"& slutdato &"') "_
		&" ORDER BY timepris" 
		'AND tfaktim = 1
		...
		end if '***intType Faktura ell. Kreditnota
