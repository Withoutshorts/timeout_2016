...
function getKundelisten() {
    ...
    if (sog_val.val() != "") {
        ...
        $.post("?jq_sogkunde=" + visalle + "&sog_val=" + sog_val.val(), { control: "FN_getKundelisten_2013", AjaxUpdateField: "true", cust: sog_val.val() }, function (data) {
...
$(document).ready(function () {
    ...
    if ($("#jq_level").val() != 1) {
            ...
            $(".FM_listestatus_1").each(function () {

               
                
                var thisJobdArr = this.id.split("_")
                //alert(thisJobdArr[3])

                if ($(this).is(':checked')) {
                    //alert(this.id)
                    //$("#FM_listestatus_2_" + thisJobdArr[3]).attr('disabled', true);
                } else {
                    //$(':radio:not(:checked)').attr('disabled', true);
                    $("#FM_listestatus_0_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_1_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_2_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_3_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_4_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_5_" + thisJobdArr[3]).attr('disabled', true);
                    $("#FM_listestatus_6_" + thisJobdArr[3]).attr('disabled', true);
                }
