          ...
          if func = "red" OR step = "2" then
				...
				if func = "red" then
                 ...
                 <td style="border:0px;" colspan="6">
                     ...
                     <tr>
                         <td style="padding:12px 2px 2px 2x; font-size:11px;"><b>Bruttoomsætning:</b><br />(nettooms. + salgsomkostninger)</td>
                         <td align=right style="padding:12px 20px 2px 2x; font-size:11px;">= <input type="text" id="FM_budget" name="FM_budget" value="<%=replace(formatnumber(jo_bruttooms, 2), ".", "")%>" style="width:75px; font-size:11px; font-family:arial; border:0px; border:1px red solid;" onkeyup="tjektimer('FM_budget')">&nbsp;&nbsp;&nbsp;&nbsp; DKK</td>
                ...
                <%strSQLmtyp = "SELECT typeid, timer, mt_tb.timepris, faktor, belob, mt.type, belob_ff, mt_tb.kostpris FROM medarbejdertyper_timebudget AS mt_tb "_
                &" LEFT JOIN medarbejdertyper mt ON (mt.id = typeid) WHERE mt_tb.jobid = "& id &" ORDER BY mtsortorder"
                ...
                %>
                <tr><td style="width:300px; font-size:9px;"><%=oRec3("type") %> <span style="font-size:9px; color:#999999;">(kost: <%=formatnumber(kostpris) %>)</span>

                    <input type="hidden" id="FM_mtype_kp_<%=oRec3("typeid") %>" name="FM_mtype_kostpris_<%=oRec3("typeid") %>" value="<%=formatnumber(kostpris) %>" />
                <input type="hidden" id="FM_mtype_ids_<%=tpno%>" name="FM_mtype_ids" value="<%=oRec3("typeid")%>" class="mt_belob" />
                <input type="hidden" id="Hidden2" name="FM_mtype_id" value="<%=oRec3("typeid") %>" /></td>
                    <td><input type="text" id="FM_mtype_ti_<%=oRec3("typeid") %>" name="FM_mtype_timer_<%=oRec3("typeid") %>" style="width:50px; font-size:9px;" value="<%=formatnumber(timerThis, 2) %>" class="mt_belob" /></td>
                     <td style="width:150px; font-size:9px; white-space:nowrap;"><input type="text" id="FM_mtype_tp_<%=oRec3("typeid") %>" class="mt_belob" name="FM_mtype_timepris_<%=oRec3("typeid") %>" value="<%=formatnumber(timepris, 2) %>" style="width:75px; font-size:9px;" /> DKK</td>
                      <td style="width:50px; font-size:9px; white-space:nowrap;"> (<input type="text" class="mt_timer" value="<%=formatnumber(belob_for_fakor, 2) %>" id="FM_mtype_ff_<%=oRec3("typeid") %>" name="FM_mtype_belob_ff_<%=oRec3("typeid") %>" style="width:40px; color:#999999; font-size:9px; border:0px;" maxlength="0" />)</td>
                      <td style="width:50px; font-size:9px; white-space:nowrap;"> x <input type="text" class="mt_faktor" value="<%=formatnumber(faktor, 2) %>" id="FM_mtype_fa_<%=oRec3("typeid") %>" name="FM_mtype_faktor_<%=oRec3("typeid") %>" style="width:40px; font-size:9px;" maxlength="0" /></td>
                      <td style="width:120px; font-size:9px; white-space:nowrap;">= <input type="text" class="mt_timer" id="FM_mtype_be_<%=oRec3("typeid") %>" value="<%=formatnumber(belob, 2) %>" name="FM_mtype_belob_<%=oRec3("typeid") %>" style="width:75px; font-size:9px;" maxlength="0" /> DKK</td>
                </tr>
                ...
                <%strSQLmtyp = "SELECT type, id, timepris, kostpris FROM medarbejdertyper WHERE id <> 0 "& typeidWrt &" AND sostergp = 0 ORDER BY mtsortorder"
                ...
                <%end if %>
                <tr><td style="width:300px; font-size:9px;"><%=oRec3("type") %> <span style="font-size:9px; color:#999999;">(kost: <%=formatnumber(kostpris) %>)</span>
                <input type="hidden" id="FM_mtype_kp_<%=oRec3("id") %>" name="FM_mtype_kostpris_<%=oRec3("id") %>" value="<%=formatnumber(kostpris) %>" />
                <input type="hidden" id="FM_mtype_ids_<%=tpno%>" name="FM_mtype_ids" value="<%=oRec3("id")%>" class="mt_belob" />
                <input type="hidden" id="FM_mtype_id_<%=oRec3("id")%>" name="FM_mtype_id" value="<%=oRec3("id")%>" class="mt_belob" /></td>
                    <td><input type="text" id="FM_mtype_ti_<%=oRec3("id") %>" name="FM_mtype_timer_<%=oRec3("id") %>" value="0" style="width:50px; font-size:9px;" class="mt_belob" /></td>
                     <td style="width:150px; font-size:9px; white-space:nowrap;"><input type="text" id="FM_mtype_tp_<%=oRec3("id") %>" class="mt_belob" name="FM_mtype_timepris_<%=oRec3("id") %>" value="<%=formatnumber(timepris, 2) %>" style="width:75px; font-size:9px;" /> DKK</td>
                       <td style="width:50px; font-size:9px; white-space:nowrap;"> (<input type="text" value="0" id="FM_mtype_ff_<%=oRec3("id") %>" class="mt_timer" name="FM_mtype_belob_ff_<%=oRec3("id") %>" style="width:40px; font-size:9px; color:#999999; border:0px;" maxlength="0" />)</td>
                     
                      <td style="width:50px; font-size:9px; white-space:nowrap;"> x <input type="text" value="1" id="FM_mtype_fa_<%=oRec3("id") %>" class="mt_faktor" name="FM_mtype_faktor_<%=oRec3("id") %>" style="width:40px; font-size:9px;" maxlength="0" /></td>
                      <td style="width:120px; font-size:9px; white-space:nowrap;">= <input type="text" value="0" id="FM_mtype_be_<%=oRec3("id") %>" class="mt_timer" name="FM_mtype_belob_<%=oRec3("id") %>" style="width:75px; font-size:9px;" maxlength="0" /> DKK</td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td style="height:22px;"><input type="button" value=">>" id="mt_calc" style="font-size:8px;" /></td>
                    <td></td>
                    <td style="font-size:9px;"> <!-- sum medarbejdertyper før faktor ff -->
                    ...
                    <td></td>
                    <td style="font-size:9px;">= <input type="text" value="<%=formatnumber(beltot,2) %>" id="FM_mtype_belob_tot" name="FM_mtype_belob_tot" style="width:75px; border:0px; color:#999999; font-size:9px;" /> DKK</td>
                </tr>
                ...
                <!--
                  <tr class="tr_budgetmtyp" style="visibility:<%=budgetmtyp_vzb%>; display:<%=budgetmtyp_dsp%>;"><td colspan=6 align="right" style="border:0px; padding:10px 10px 30px 5px;">
                    ...
                    <%else %>
                     ...
                     <tr>
                         <td style="padding:12px 2px 2px 2x; font-size:11px;"><b>Bruttoomsætning:</b><br />(nettooms. + salgsomkostninger)</td>
                         <td align=right style="padding:12px 20px 2px 2x; font-size:11px;">= <input type="text" id="FM_budget" name="FM_budget" value="<%=replace(formatnumber(jo_bruttooms, 2), ".", "")%>" style="width:75px; font-size:11px; font-family:arial; border:0px; border-bottom:1px #cccccc solid;" onkeyup="tjektimer('FM_budget'), dbManuel()">&nbsp;&nbsp;&nbsp;&nbsp; DKK</td>
				...
				<tr>
                    ...
                    <tr>
					    <td style="width:270px; padding:10px 5px 2px 2px; font-size:11px;"><b>Nettoomsætning, timer:</b> <br />(oms. før salgsomk.)</td>
					    ...
					    <td valign="bottom" style="width:100px; font-size:9px;"><span style="color:Red;">*</span><b> Beløb DKK</b></td>
				...
				<tr bgcolor="#FFFFFF">
					<td id="xpb_jobnavn" style="color:#999999; font-size:9px; height:20px;">
                    ...
                    if antalM <> 0 AND virkgnskostpris <> 0 then  
                        ...
                        Gns. timepris / kostpris: 
                        <%=formatnumber(virkgnssalgspris/antalM, 2) %> / <%=formatnumber(virkgnskostpris/antalM, 2) %> 
					...
					<td><input type="text" id="FM_budgettimer" name="FM_budgettimer" value="<%=replace(formatnumber(strBudgettimer, 2), ".", "")%>" style="width:60px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd %>" onkeyup="tjektimer('FM_budgettimer'), beregnintbelob()" class="nettooms"></td>
					<td class=lille><input type="text" id="FM_gnsinttpris" name="FM_gnsinttpris" value="<%=replace(formatnumber(jo_gnstpris, 2), ".", "")%>" style="width:67px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd2 %>" onkeyup="tjektimer('FM_gnsinttpris'), beregnintbelob()" class="nettooms"> DKK</td>
					<td>x <input type="text" id="FM_intfaktor" name="FM_intfaktor" value="<%=replace(formatnumber(jo_gnsfaktor, 2), ".", "")%>" style="width:30px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd2 %>" onkeyup="tjektimer('FM_intfaktor'), beregnintbelob()" class="nettooms"></td>
					<td>= <input type="text" id="FM_interntbelob" name="FM_interntbelob" value="<%=replace(formatnumber(jo_gnsbelob, 2), ".", "")%>" style="width:75px; font-size:<%=netto_fz %>px; font-family:arial; color:<%=netto_fc %>; <%=netto_bd %>" onkeyup="tjektimer('FM_interntbelob'), beregninttp()" class="nettooms"></td>
                ...
                <tr>
					<td colspan=6 style="border:0x;"> <input id="FM_ign_tp" value="1" type="checkbox" /> Åbn for manuel indtastning og beregning af Brutto- og Netto -omsætning.</td>
				</tr>
                <%else %>
                <tr>
					<td colspan=6 style="border:0x;"><br /><br />&nbsp;</td>
				</tr>
                <%end if
                ...
                <tr class="dv_aktlisten" style="visibility:<%=aktlist_wzb%>; display:<%=aktlist_dsp%>;"><!-- #FFC0CB -->
                    ...
                    <td style="border:0px;" colspan="6">
					    ...
					    <td style="width:330px; padding:5px 0px 5px 5px; font-size:11px;" bgcolor="#FFCOCB"><b>Aktiviteter & Faser ialt:</b></td>
					    <td style="width:180px; padding:2px 0px 3px 10px;"><span style="padding:2px 2px 2px 2px; background-color:#FFFFFF; width:40px; border-bottom:2px #FFC0CB solid;" id="fasertimertot"><b>0,00</span></td>
                        <input id="FM_fasertimertot" value="0" type="hidden" />
					
					    <td style="padding:2px 0px 3px 10px; white-space:nowrap;">= <span style="padding:2px 2px 2px 2px; background-color:#FFFFFF; width:60px; border-bottom:2px #FFC0CB solid;;" id="fasersumtot"><b>0,00</b></span></td>
					...
					<td style="padding:20px 0px 10px 2px; border:0px;"" colspan="6">
                      <!--<input id="sync" type="button" value="Sync. forkalkulation >> " />--><input id="sync" type="checkbox" <%=syncCHK %> /><b>Sync. med nettoomsætning</b> <br />Overfør budget på aktiviteter til nettoomsætning på job.
                    </td>
                    </tr>
               ...
               <tr class="dv_aktlisten" style="visibility:<%=aktlist_wzb%>; display:<%=aktlist_dsp%>;"><td colspan=6 align="right" style="border:0px; padding:0px 10px 20px 5px;">
                    ...
                    <input id="showtpalert" value="0" type="hidden" />
               ...
               %>
		        ...
		        <tr>
                    ...
                    <!--<input id="FM_budget" name="FM_budget" value="<%=replace(formatnumber(jo_bruttooms, 2), ".", "")%>" type="hidden" />-->
						<td style="width:25px;">&nbsp;DKK</td>
							
		        </tr>
		        
                 <tr>
						    
					<td colspan=4 style="padding:10px 0px 3px 5px; width:460px; font-size:11px; font-family:arial;"><b>Nettoomsætning:</b></td>
                ...
                <tr bgcolor="#ffffff">
					<td colspan=4 style="padding:10px 0px 3px 5px; font-size:11px; font-family:arial;">Udgifter (intern kost.):</td>
                ...
                <tr bgcolor="#ffffff">
					<td colspan=4 style="padding:10px 0px 3px 5px; font-size:11px; font-family:arial;"><b>Udgifter ialt:</b> (intern kost. + salgsomk.)</td>
					<td style="padding:2px 2px 2px 20px;">= <span style="padding:2px 2px 2px 2px; background-color:#FFFFFF; width:60px; border:0px; border-bottom:0px #999999 solid; font-size:9px; font-family:arial;" id="SP_udgifter"><b><%=replace(formatnumber(udgifter, 2), ".", "")%></b></span></td>
...
sub minioverblik
	...
	call tableDivAbs(oTop,oLeft,oWdth,oHgt,oId, oVzb, oDsp, oZindex)
        ...
        <a href="jobprintoverblik.asp?menu=job&id=<%=id%>&media=printjoboverblik" class=vmenu target="_blank"><span style="background-color:#FFFF99;">Print joboverblik >></span></a><br />
       ...
       <tr bgcolor="#5582d2">
        ...
        <b><%=strKnavn & " ("& strKnr &")</b><br>"& strNavn & " ("& strjobnr &")"  %>

        <br />
        <br />Status: <%=strStatusNavn %>
    ...
    <%
        ...
        <tr>
		    <td><br /><b>Joblog</b> (seneste 15 md. hvis job er aktivt, ellers jobperiode dog maks 15 md., timer er afrundet)</td>
		</tr>
        ...
        <%call timer_fordeling_medarb_typer(strjobnr,0) %>
        ...
        <a href="medarbtyper.asp" class=vmenu target="_blank">Ret kostpriser her >></a><br />
         <%end if %>
        <a href="ressource_belaeg_jbpla.asp?FM_sog=<%=strJobnr %>" class=vmenu target="_blank">Ressource timer / Forecast >></a>
        </td>
		</tr>
		...
		<tr>
		    <td class=lille width=300><b>Folder</b></td>
		    <td class=lille><b>Fil</b></td>
		    <td class=lille align=right><b>Dato</b></td>
		</tr>
		<%strSQLdok = "SELECT f.filnavn, f.id AS fid, f.dato, fo.navn AS foldernavn FROM foldere fo  "_
        &" LEFT JOIN filer AS f ON (f.folderid = fo.id) WHERE fo.jobid =" & id & " ORDER BY foldernavn, filnavn" 
	    ...
	    <tr>
	        <td class=lille>
            <%if thisfile <> "jobprintoverblik" then %>
            <a href="erp_fak_godkendt_2007.asp?id=<%=oRec2("fid")%>&aftid=<%=oRec2("aftaleid")%>&jobid=<%=oRec2("jobid")%>" class="rmenu" target="_blank">
            <b><%=oRec2("faknr") %></b>
            </a>
            <%else %>
            <b><%=oRec2("faknr") %></b>
		...
		<tr bgcolor="#DBDB70">
		    ...
		    <td class=lille align=right colspan=2><b><%=formatnumber(totFakbel)%></b> DKK</td>
	    ...
	    <br />&nbsp;
	     ...
	     <tr>
	        ...
	        &" antalstk, tidslaas, a.fase, a.sortorder, a.bgr, aktbudgetsum, sum(t.timer) AS realiseret, SUM(timer * timepris *(kurs/100)) AS realbelob, aktstartdato, aktslutdato, aty_desc "_
	        ...
	        while not oRec2.EOF  
               ...
               <tr bgcolor="#FFFFFF">
	            ...
	            <td align=right class=lille><b><%=formatnumber(lastFaseRealbel, 2) %></b> DKK</td>

                </tr>

              <tr>
                <td colspan=9 style="padding:2px; font-size:9px;">&nbsp;</td></tr>
                <%
                lastFaseForkalkTimer = 0
                lastFaseRealTimer = 0
                end if %>
	            ...
	            <td class=lille align=right><%=formatnumber(oRec2("realbelob"), 2) %> DKK </td>
	        ...
	        <tr bgcolor="#FFFFFF">
             ...
             <table cellpadding=0 cellspacing=0 border=0 width=100%>
             <tr><td bgcolor="#FFFFFF" colspan=9 style="padding:2px; font-size:9px;">&nbsp;</td></tr>

	        <tr bgcolor="#FFDFDF">
	            <td class=lille width=300><b>Ialt:</b></td>
	            <td>&nbsp;</td>
	            <td>&nbsp;</td>
                <td>&nbsp;</td>
               <td align=right class=lille><b><%=formatnumber(totTimerforkalk,2) %> t.</b></td>
                <td>&nbsp;</td>
                <td align=right class=lille><b><%=formatnumber(totSum, 2) %></b> DKK</td>

                <td align=right class=lille><b><%=formatnumber(totReal,2) %></td>
                <td align=right class=lille><b><%=formatnumber(totRealbel, 2) %></b> DKK</td>
	        </tr>    
            ...
            <tr>
		    <td bgcolor="#FFFFFF" style="padding:5px 4px 5px 0px;"><br /><br /><b>Salgsomkostninger realiseret</b> (materialer & udlæg) &nbsp; 
            <%if thisfile <> "jobprintoverblik" then %>
        ...
        <%if thisfile <> "jobprintoverblik" then %>
                 <a href="materialer_indtast.asp?id=<%=id%>&fromsdsk=0&aftid=<%=intServiceaft%>" target="_blank" class="vmenu"><span style="color:green; font-size:16px;"><b>+</b></span> Opret salgsomkostning</a><br />
        <%end if
        %>
		     <br />&nbsp;
            ...
            %>
	            ...
	            <tr>
                    ...
                    salgsomkostSalg = 0
                    salgsomkostKost = 0
                    strSQLudl = "SELECT matnavn, matenhed, matantal AS antal, ((matkobspris * (kurs/100)) / matantal) AS stkkobspris, matkobspris * (kurs/100) AS matkobspris, matsalgspris * (kurs/100) AS matsalgspris FROM materiale_forbrug WHERE jobid = "& id & " GROUP BY id" 
                    ...
                    %>
                     ...
                     <table cellpadding=1 cellspacing=0 border=0 width=100%>
                    <tr><td class=lille colspan=4><b>Ialt: <%=antalmatreg%></b><img src="ill/blank.gif" width="200" height="1" border="0" /></td>
                    <td class=lille align=right><b><%=formatnumber(salgsomkostKost, 2)%> DKK</b></td>
                    <td class=lille align=right style="padding-right:<%=pdRight%>px;"><b><%=formatnumber(salgsomkostSalg, 2)%> DKK</b></td></tr>
                   </table>
         ...
         <tr>
		    <td style="padding:5px 4px 5px 0px;"><br /><br /><b>Salgsomkostninger budgetteret</b></td>
		</tr>
        <tr>
        <td style="padding:4px 4px 5px 4px; border:1px #cccccc solid;"><br />
            ...
            <% strSQLUlev = "SELECT ju_id, ju_navn, ju_ipris, ju_faktor, "_
                ...
                <tr bgcolor="<%=bgthis %>">
                    ...
                    <td align=right class=lille><%=formatnumber(oRec2("ju_stkpris"), 2) %> DKK</td>
                    <td align=right class=lille><%=formatnumber(oRec2("ju_ipris"), 2) %> DKK</td>
                    <td align=right class=lille><%=oRec2("ju_faktor") %></td>
                    <td align=right class=lille><%=formatnumber(oRec2("ju_belob"), 2) %> DKK</td>
                    <td></td>
                </tr>
                <%
                ...
                if u <> 0 then%>
                 ...
                 <tr>
                    ...
                    <td align=right class=lille>&nbsp;</td>
                    <td align=right class=lille><b><%=formatnumber(salgsomkostninger_tot, 2) %> DKK</b></td>
                    <td align=right class=lille>&nbsp;</td>
                    <td align=right class=lille><b><%=formatnumber(salgspris_tot, 2) %> DKK</b></td>
                    <td></td>
                </tr>
        ...
        <tr><td>
          ...
          <%if totReal <> 0 then 
	        ...
	        <tr>
                ...
                <tr><td> <b>Timer budgetteret:</b> (job)</td><td align=right> <%=formatnumber(strBudgettimer, 2) %> t.</td></tr>
                <tr><td> <b>Timer realiseret:</b> (job)</td><td align=right> <%=formatnumber(totReal, 2) %> t.</td></tr>
                 <tr><td colspan=2>&nbsp;</td></tr>
                
                <tr><td> <b>Bruttoomsætning budgetteret:</b> (job)</td><td align=right> <%=formatnumber(jo_bruttooms, 2) %> DKK</td></tr>
                <tr><td> <b>Nettoomsætning budgetteret:</b> (job)</td><td align=right> <%=formatnumber(jo_gnsbelob, 2) %> DKK</td></tr>
                
                <tr><td><span style="color:#999999;"><b>Omsætning budgetteret:</b> (aktiviteter)</span></td><td align=right><span style="color:#999999;"><%=formatnumber(totsum, 2) %> DKK</span></td></tr>
                <tr><td><b>Omsætning realiseret</b> (timer):</td><td align=right><%=formatnumber(totRealbel, 2) %></b> DKK</td></tr>
                <tr><td colspan=2>&nbsp;</td></tr>
                <tr><td><b>Salgsomkostninger budgetteret:</b></td><td align=right><%=formatnumber(salgspris_tot, 2) %></b> DKK</td></tr>
                <tr><td><b>Salgsomkostninger realiseret:</b></td><td align=right><%=formatnumber(salgsomkostReal, 2) %></b> DKK</td></tr>
                <tr><td colspan=2>&nbsp;</td></tr>
                <tr><td><b>Faktureret</b></td><td align=right><%=formatnumber(totFakbel)%> DKK</td></tr>
                <tr><td><b>Faktisk timepris:</b><br />
                  (fakturet beløb ekskl. materialer og km. / realiseret timer)</td><td align=right><%=formatnumber(gnstpris) & " DKK"%></td></tr>
               <tr><td colspan=2>&nbsp;</td></tr>

               <tr><td><b>DB budgetteret:</b></td><td align=right><%=formatnumber(jo_dbproc,0)%> %</td></tr>
              <!--<tr><td><b>DB realiseret:</b></td><td align=right><%=formatnumber(gnstpris) & " DKK"%></td></tr>
              <tr><td><b>DB forventet:</b></td><td align=right><%=formatnumber(gnstpris) & " DKK"%></td></tr>
              <tr><td><b>DB faktisk:</b></td><td align=right><%=formatnumber(gnstpris) & " DKK"%></td></tr>-->
...
sub timepriser
                   ...
                   <table cellspacing="0" cellpadding="0" border="0" bgcolor="#EFF3FF" width="100%">
					...
					<td colspan=4 bgcolor="#FFFFFF" style="border-top:0px #CCCCCC solid; padding:20px 40px 10px 10px;">
                                ...
                                uTxt = "<b>En medarbejder kan kun have en timepris pr. aktiviet. </b><br />"_
