...
$(document).ready(function () {
    ...
    */
    ...
    function show_dv_gdpr_data_outside_eu() {

        

        if ($("#FM_data_outside_eu").val() == "1") {

            $("#dv_gdpr_data_outside_eu").css("visibility", "visible");
            $("#dv_gdpr_data_outside_eu").css("display", "");
            $("#dv_gdpr_data_outside_eu").show(2000)


        } else {


            $("#dv_gdpr_data_outside_eu").css("visibility", "hidden");
            $("#dv_gdpr_data_outside_eu").css("display", "none");
            $("#dv_gdpr_data_outside_eu").hide(1000);

        }
    }

    show_dv_gdpr_data_outside_eu();
    


    $("#FM_data_outside_eu").change(function () {
    ...
    $("#FM_categories_process").change(function () {


        //alert("her")
        show_dv_gdpr_categories_process();


    });


    function show_dv_gdpr_categories_process() {



        if ($("#FM_categories_process").val() == "Ordinary personal data") {

            $("#dv_ordinary_personal_data").css("visibility", "visible");
            $("#dv_ordinary_personal_data").css("display", "");
            $("#dv_ordinary_personal_data").show(2000)

            $("#dv_sensitive_personal_data").css("visibility", "hidden");
            $("#dv_sensitive_personal_data").css("display", "none");
            $("#dv_sensitive_personal_data").hide(1000);


        } else {


            $("#dv_sensitive_personal_data").css("visibility", "visible");
            $("#dv_sensitive_personal_data").css("display", "");
            $("#dv_sensitive_personal_data").show(2000)

            $("#dv_ordinary_personal_data").css("visibility", "hidden");
            $("#dv_ordinary_personal_data").css("display", "none");
            $("#dv_ordinary_personal_data").hide(1000);
    ...
    function show_dv_filepath2() {

        //alert("HER")

        if ($("#FM_gdpr_personaldata").val() == "0") {

            $("#dv_filepath2").css("visibility", "visible");
            $("#dv_filepath2").css("display", "");
            $("#dv_filepath2").show(2000)


        } else {


            //$("#dv_filepath2").css("visibility", "hidden");
            //$("#dv_filepath2").css("display", "none");
            $("#dv_filepath2").hide(1000)
            $("#dv_gdpr_data_outside_eu").hide(1000)

            $("#FM_data_outside_eu").val('No')

            //alert(":" + $("#FM_data_outside_eu").val())
    ...
    $("#FM_gdpr_personaldata").change(function () {
