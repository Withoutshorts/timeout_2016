...
tdWdthTBF = tdWdthF + 5
                ...
                if antal_orders = 0 then 
                    ...
                    <header class="panel-heading"><%=rapporttypeTxt %></header>-->
                     ...
                     <div id="table_header" style="position:fixed; top:458px;">
                ...
                <%end if 'antal_orders%>
                        ...
                        <thead >
                            ...
                            <tr>
                                <th colspan="1" style="text-align:left;"> <span id="to_top" style="color:#999999;">[=]</span> </th>
                                <th colspan="15" style="text-align:left;" ><%=rapporttypeTxt %></th>
                                <th colspan="1" style="text-align:right;" align="right">  <select id="bulk_jobid_action" style="width:70px;">
                            ...
                            <tr>
                                <th style="width:<%=tdWdthD%>px;">Sta. <%if media <> "print" then %><a href="job_nt.asp?sort=2">></a><%end if %><br /><span style="font-size:9px;">Status</span></th>
                                <th style="width:<%=tdWdthC%>px; text-align:left;">Buyer  <%if media <> "print" then %><a href="job_nt.asp?sort=1">></a><%end if %><br /><span style="font-size:9px;">Collection</span></th></th>
                                <th style="width:<%=tdWdthC%>px;">Order/PO no <%if media <> "print" then %><a href="job_nt.asp?sort=15">></a><%end if %><br /><span style="font-size:9px;">Destination</span></th>
                                <th style="width:<%=tdWdthA%>px;">Supplier <%if media <> "print" then %><a href="job_nt.asp?sort=16">></a><%end if %><br /><span style="font-size:9px;">Sup. inv. no.</span></th>
                                <!--<th style="width:<%=tdWdthC%>px;">Product grp. <%if media <> "print" then %><a href="job_nt.asp?sort=17">></a><%end if %></th>-->
                                <th style="width:<%=tdWdthC%>px; text-align:left;">Style <%if media <> "print" then %><a href="job_nt.asp?sort=7">></a><%end if %> <br /><span style="font-size:9px;">Prod.grp <%if media <> "print" then %><a href="job_nt.asp?sort=17">></a><%end if %></span></th>
                                <th style="width:<%=tdWdthA%>px;">Order No. <%if media <> "print" then %><a href="job_nt.asp?sort=18">></a><%end if %><br /><span style="font-size:9px;">Order type</span>
                                </th>

                               

                                    <%if cint(rapporttype) = 0 OR cint(rapporttype) = 3 then 'Overview%>
                                <th style="width:<%=tdWdthF%>px;">Order date <%if media <> "print" then %><a href="job_nt.asp?sort=11">></a><%end if %></th>
                                
                                <!--<th style="width:<%=tdWdthB%>px;">Dest.</th>-->
                                    
                                <!--<th style="width:<%=tdWdthA%>px;">Coll.<br /><span style="font-size:9px;">Collection</span></th>-->
                             
                                <th style="width:<%=tdWdthD%>px;">Rep.<br /><span style="font-size:9px;">Sales</span></th>
                                 <%end if %>
                            
                                <%if cint(rapporttype) = 1 then 'Prod / Enquery %>
                            
                               <!--<th>Src DL <%if media <> "print" then %><a href="job_nt.asp?sort=3">></a><%end if %></th>-->
                                <th style="width:<%=tdWdthF%>px;">Proto DL <%if media <> "print" then %><a href="job_nt.asp?sort=4">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">Photo Buyer DL <%if media <> "print" then %><a href="job_nt.asp?sort=5">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">Photo Suppl. DL <%if media <> "print" then %><a href="job_nt.asp?sort=12">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">SMS Buyer DL <%if media <> "print" then %><a href="job_nt.asp?sort=6">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">SMS Suppl. DL <%if media <> "print" then %><a href="job_nt.asp?sort=13">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">PP App <%if media <> "print" then %><a href="job_nt.asp?sort=9">></a><%end if %></th>
                                <th style="width:<%=tdWdthF%>px;">SHS App <%if media <> "print" then %><a href="job_nt.asp?sort=10">></a><%end if %></th>
                                <%end if %>


                                <%if cint(rapporttype) = 0 OR cint(rapporttype) = 1 OR cint(rapporttype) = 3 then%>
                                <th style="width:<%=tdWdthF%>px;">ETD Buyer <%if media <> "print" then %><a href="job_nt.asp?sort=14">></a><%end if %></th>
                                <%end if %>

                                 <%if cint(rapporttype) = 0 OR cint(rapporttype) = 3 then%>
                                <th style="width:<%=tdWdthF%>px;">Actual ETD <%if media <> "print" then %><a href="job_nt.asp?sort=19">></a><%end if %></th>
                                <%end if %>

                                 <%if cint(rapporttype) = 1 OR cint(rapporttype) = 3 then 'Prod / Enquery + ext. %>
                                 <th style="width:<%=tdWdthF%>px;">ETD Suppl <%if media <> "print" then %><a href="job_nt.asp?sort=20">></a><%end if %></th>
                                ...
                                <th style="width:<%=tdWdthA%>px;">Order<br /><span style="font-size:9px;">Odr. Qty.</span></th>
                                <th style="width:<%=tdWdthA%>px;">Ship.<br /><span style="font-size:9px;">Shp. Qty.</span></th>
                                <%end if %>
                                ...
                                <%if cint(rapporttype) = 3 then %>
                                 <th style="width:<%=tdWdthE%>px;">Cost<br /><span style="font-size:9px;">Cost Price PC</span></th>
                                <%end if %>

                                <%if cint(rapporttype) = 0 OR cint(rapporttype) = 3 then %>
                                <th style="width:<%=tdWdthA%>px;">Sales PC<br /> <span style="font-size:9px;">Sales Price PC</span></th>
                                <%end if %>

                                <%if cint(rapporttype) = 3 then %>
                                 <th style="width:<%=tdWdthE%>px;">Comm. PC</th>
                                <th style="width:<%=tdWdthE%>px;">Profit PC</th>
                                <th style="width:<%=tdWdthE%>px;">Total<br /><span style="font-size:9px;">Total Price</span></th>
                                
                                <%end if %>

                                <%if cint(rapporttype) = 0 OR cint(rapporttype) = 3 then %>
                                 <th style="width:<%=tdWdthA%>px;">Total Sale<br /><span style="font-size:9px;">Tot. Salesprice</span></th>
                                <%end if %>

                                <%if cint(rapporttype) = 3 then %>
                                <th style="width:<%=tdWdthE%>px;">Total Profit</th>
                                <th style="width:<%=tdWdthE%>px;">Total Profit %</th>
                                <%end if %>
                            
                                   <th style="width:<%=tdWdthA%>px;">Invoice</th>
                    ...
                    <div style="position:fixed; top:544px; height:300px; overflow:auto;" id="table_body">
