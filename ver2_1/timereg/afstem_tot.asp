...
<%
   ...
   'end if
	...
	<td valign=top><h4><%=afstem_txt_011 &" " %> (<%=afstem_txt_012 %>) <%=afstem_txt_001 %><br />
  ...
  <!--
	 ...
	 <%if instr(akttype_sel, "#27#") <> 0 OR instr(akttype_sel, "#28#") <> 0 OR instr(akttype_sel, "#29#") <> 0 then %>
        ...
        <td valign=bottom style="border-bottom:1px silver solid; width:50px;" class=lille>
         ...
         <% if visning = 77 then  %>
                 ...
                 <td valign=bottom style="border-bottom:1px silver solid; width:50px;" class=lille>her
	            <%call akttyper(29, 1) %>
	             <b><%=left(akttypenavn, 10)%>.<br />
     ...
     %>
       ...
       <%if instr(akttype_sel, "#27#") <> 0 OR instr(akttype_sel, "#28#") <> 0 OR instr(akttype_sel, "#29#") <> 0 then %>
        ...
        <%end if %>
         ...
         <%if show = 77 then%>
        <td align=right class=lille style="white-space:nowrap;"><b><%=formatnumber(aldersreduktionUdbTot, 2)%></b>her</td>
   ...
   %>
    ...
    <%
        ...
        if lto <> "tia" then '= Ingne fleks, ligemeget md GT
