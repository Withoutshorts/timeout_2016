...
Class CuteEditor
	...
	Sub GetBrowserType ()	
		...
		if InStr(1, userAgent, "MSIE", 1) > 0 AND InStr(1, userAgent, "Win", 1) > 0 AND InStr(1, userAgent, "Opera", 1) = 0 then
			if CLng(Trim(Mid(userAgent, inStr(1, userAgent, "MSIE", 1)+5, 3))) >= 5.5 then
				s_BrowserType = "winIE"
			end if
		...
		ElseIf inStr(1, userAgent, "Gecko", 1) > 0 AND inStr(1, userAgent, "Safari", 1) = 0 then
		    if isNumeric(Trim(Mid(userAgent, CInt(inStr(1, userAgent, "Gecko/", 1)+6), 8))) then
			    if CLng(Trim(Mid(userAgent, CInt(inStr(1, userAgent, "Gecko/", 1)+6), 8))) => 20030312 then
				    s_BrowserType = "Gecko"
			    end if
			end if
			If inStr(1, userAgent, "Firefox", 1) > 0 AND isNumeric(Trim(Mid(userAgent, CInt(inStr(1, userAgent, "Firefox/", 1)+8), 2))) then
			    if CLng(Trim(Mid(userAgent, CInt(inStr(1, userAgent, "Firefox/", 1)+8), 2))) => 17 then
				    s_BrowserType = "Gecko"
			    end if
			end if
