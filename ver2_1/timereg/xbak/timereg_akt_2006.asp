    ...
    '******************************************************************************
                ...
                jobid = request("seljobid") &", "& request("jobid") & ", 0"
                ...
                jobids = split(jobid, ", ") 
                for j = 0 to UBOUND(jobids)
                seljobidSQL = seljobidSQL & " OR j.id = "& jobids(j) &" "
 ...
 '************************************************************************************************** 
  ...
  '**************************************************************************************************
	...
	<select name="FM_kontakt" id="FM_kontakt" style="font-size:9px; width:250px;" size=8 onchange="renssog();"> <!-- onChange="renssog()" --> 
	  ...
	  <!--
       ...
       -->
        ...
        <br />
        Maks. 100 job i oversigten.
	    
            
         
         <input id="seljobid" name="seljobid" type="text" value="<%=jobid %>" />
    ...
    '**************** TODO LIST ********'
     %>
        ...
        <div id="div_todolist" style="position:absolute; left:779px; top:418px; width:210px; height:200px; visibility:<%=jinf_knap_vzb%>; display:<%=jinf_knap_dsp%>; z-index:100; border:1px #cccccc solid; padding:2px; background-color:#ffffff; overflow:auto;">
  ...
  <div id="s" style="position:relative; left:25px; top:122px; width:200px; visibility:<%=sVzb%>; display:<%=sDsp%>; z-index:2;">
    ...
    <!--<input id="showjobinfo" name="showjobinfo" type="hidden" value="<=showjobinfo %>" />-->
     ...
     <div id="timereg_job" style="position:relative; width:780px; border:0px; top:153px; visibility:visible; left:20px; display:; z-index:1000">
   ...
   <tr>
    ...
    &" j.serviceaft, j.beskrivelse AS jobbesk, j.jobans1, jobans2, jobstartdato, jobslutdato, j.fastpris, jo_bruttooms, j.rekvnr, "_
	...
	aktdata(iRowLoop, 32) = oRec("kkundenavn") & " ("& oRec("kkundenr") &")"
    ...
    strSQLttot = "SELECT SUM(timer) AS timertot, SUM(timer*kostpris*(kurs/100)) AS internKost FROM timer WHERE taktivitetid = "& aktdata(iRowLoop, 3) & " GROUP BY taktivitetid"
	...
	for iRowLoop = 1 TO UBOUND(aktdata)
            ...
            <td style="background-color:#D6Dff5; border-bottom:0px #cccccc solid; padding:10px 5px 0px 0px;" valign="bottom" align=right class=lille><input class="fjern_job" type="checkbox" value="1" id="fjern_job_<%=aktdata(iRowLoop, 4)%>"/>Fjern job</td>
            </tr>     
                ...
                <tr>
                    ...
                    <td style="width:255px; background-color:#5C75AA; border-bottom:2px #8caae6 solid; border-top:1px #CCCCCC solid; padding:3px 3px 0px 4px;" valign=top> <a class="a_treg" id="a_timereg_<%=aktdata(iRowLoop, 4)%>" href="#">[+] <%=left(aktdata(iRowLoop, 5), 35) %> (<%=aktdata(iRowLoop, 31) %>)</a>
                       
                    <br /><span style="color:#cccccc; font-size:9px;"><%=aktdata(iRowLoop, 32) %></span></td>
                    <td style="background-color:#5C75AA; border:0px #cccccc solid; border-bottom:2px #8caae6 solid; border-top:1px #CCCCCC solid; border-right:2px #cccccc solid; padding:3px 3px 0px 4px;" valign=top><a class="a_det" id="a_det_<%=aktdata(iRowLoop, 4)%>" href="#"><img src="../ill/document.png" border="0" alt="Stamdata, job beskrivelse & Materiale registrering"/></a></td>
                    <td valign="bottom" align=right style="background-color:#FFFFFF; width:490px; border-bottom:2px #8caae6 solid; border-top:10px #d6dff5 solid; height:4px; padding:2px 2px 0px 30px;">
                    <textarea style="width:300px; font-size:9px; font-family:Arial; height:30px;" name="" id="" >17/6-2011
Hus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf 
12/5-2011
sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdfHus ks sd asd sdf sdf sdf sdf
                    </textarea></td>
                </tr>
                <!--
                <tr>
                    
                    <td style="background-color:#5C75AA; height:1px;" colspan=2><img src="../ill/blank.gif" width=1 height=1 border="0" /></td>
                    <td style="background-color:cccccc; height:1px;"><img src="../ill/blank.gif" width=1 height=1 border="0" /></td>
                </tr>

                <tr>
                  <td colspan=3 style="background-color:#8caae6; height:2px;">
                    <img src="../ill/blank.gif" width=1 height=1 border="0" /></td>  </tr>
                
                -->
                <!--
                  <tr>
                  <td colspan=2 style="background-color:#D6dff5; background-image:url('../ill/stripe_10.png'); height:2px;">
                    <img src="../ill/blank.gif" width=1 height=1 /></td>  </tr>
                    -->
            ...
            <div id="div_timereg_<%=aktdata(iRowLoop, 4)%>" style="position:relative; background-color:#ffffff; padding:0px 3px 3px 3px; width:745px; border:1px #8caae6 solid; visibility:<%=job_vzb %>; display:<%=job_dsp%>; z-index:2000">
			...
			for x = 1 to 7
                ...
                fmborcl = "1px #999999 solid"
						...
						<%			
								...
								if maxl <> 0 then
								felt = felt &"&nbsp;<a href=""#anc_s0"" name='anc_"&iRowLoop&"_"&x&"' onClick=""expandkomm('"&iRowLoop&"', '"&x&"')"">"& kommtrue &"</a>"
								end if
						...
						<%else
								...
								if maxl <> 0 then
								felt = felt &"&nbsp;<a href=""#anc_s0"" name='anc_"&iRowLoop&"_"&x&"' onClick=""expandkomm('"&iRowLoop&"', '"&x&"')""><font color='#999999'>+</font></a>"
								end if
	...
	<%end if 'iRowLoop%>
     ...
     <div id="dagstotaler" style="position:relative; background-color:#ffffff; padding:3px 3px 3px 3px; width:745px; border:1px #8caae6 solid; left:20px; top:253px; visibility:visible; display:; z-index:1000">
	...
	<tr bgcolor="#FFDFDF">
		...
		<td style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_1" type="text" size=4 value="<%=formatnumber(totTimMan, 2)%>" style="border:0px #8caae6 solid; background-color:#FFDFDF;" /></td>
	<td style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_2" type="text" size=4 value="<%=formatnumber(totTimTir, 2)%>" style="border:0px #8caae6 solid; background-color:#FFDFDF;" /></td>
	<td style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_3" type="text" size=4 value="<%=formatnumber(totTimOns, 2)%>" style="border:0px #8caae6 solid; background-color:#FFDFDF;" /></td>
	<td style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_4" type="text" size=4 value="<%=formatnumber(totTimTor, 2)%>" style="border:0px #8caae6 solid; background-color:#FFDFDF;" /></td>
	<td style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_5" type="text" size=4 value="<%=formatnumber(totTimFre, 2)%>" style="border:0px #8caae6 solid; background-color:#FFDFDF;" /></td>
	<td bgcolor="#cccccc" style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_6" type="text" size=4 value="<%=formatnumber(totTimLor, 2)%>" style="border:0px #8caae6 solid; background-color:#cccccc;" /></td>
	<td bgcolor="#cccccc" style="border-bottom:1px #8caae6 solid; border-right:1px #8caae6 solid;"><input id="timer_7" type="text" size=4 value="<%=formatnumber(totTimSon, 2)%>" style="border:0px #8caae6 solid; background-color:#cccccc;" /></td>
	</tr>
	...
	<tr bgcolor="#ffffff"><td colspan=9><br />Antal aktivitetslinier: <%=antalaktlinier %> (<%=loops %>)</td></tr>
...
%>
            ...
            <b>Der er mere end 100 aktiviteter på denne liste</b><br><br />
	        Hvis der er mere end 100 aktive aktiviteter på et job eller på en Easyreg. liste, bliver visningen 
                meget langsom. <br /><br />Du skal også være opmærksom på at der kan ikke faktureres mere end 100 aktiviteter pr. faktura.<br /><br />
            Du bør derfor overveje en anden struktur på dette job eller rydde op i antallet af aktiviteter.
            <br><br>
