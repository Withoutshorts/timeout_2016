...
if len(session("user")) = 0 then
	...
	case "dbkopier"
                    ...
                    &" virksomheds_proc, syncslutdato, altfakadr, fomr_konto, jfak_sprog, jfak_moms, lincensindehaver_faknr_prioritet_job, jo_valuta, jo_valuta_kurs "_
					...
					if not oRec.EOF then	
						...
						jo_valuta_kurs = replace(oRec("jo_valuta_kurs"), ",", ".")
				...
				'Response.end
					...
					strDato = session("dato")
                            ...
                            &" salgsans1, salgsans2, salgsans3, salgsans4, salgsans5, "_
                            &" salgsans1_proc, salgsans2_proc, salgsans3_proc, salgsans4_proc, salgsans5_proc, fomr_konto, jfak_sprog, jfak_moms, lincensindehaver_faknr_prioritet_job, jo_valuta, jo_valuta_kurs "_
                            &") VALUES "_
							&"('"& strJobNavn &"', "_
							&"'"& newjobnr &"', "_ 
							&""& trim(kids(x)) &", "_  
