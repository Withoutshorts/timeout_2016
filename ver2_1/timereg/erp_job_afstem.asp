...
<%else%>
			...
			'Redim ikfbtimer(0)
			redim realtimer(1350)
			Redim fbtimer(1350)
			Redim tknavn(1350)
			Redim faktimerKunde(1350)
			Redim fakbeloebKunde(1350)
			Redim medfaktimer(1350)
			Redim medfakbel(1350)
			Redim tkid(1350)
			'Redim realtimer(1350)
			Redim tknr(1350)
			Redim timerOmsKunde(1350)
            redim kundeFaknrs(1350)
            redim fakmatBeloeb(1350), fakaktBeloeb(1350), fakaktKorsBeloeb(1350)
