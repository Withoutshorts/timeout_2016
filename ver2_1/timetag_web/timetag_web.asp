...
<%
        ...
        case "FN_sogjobogkunde"
          ...
          case "FN_sogakt"
               ...
               &" WHERE a.job = " & jobid & " AND a.job <> 0 "& strSQlAktSog &" AND aktstatus = 1 AND ("& replace(aty_sql_realhours, "tfaktim", "a.fakturerbar") &") AND ("& aty_sql_hide_on_treg &") ORDER BY sortorder, navn LIMIT 150"      
