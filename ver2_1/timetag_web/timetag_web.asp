                ...
                <div class="portlet-body">
                    ...
                    <form id="container" action="../timereg/timereg_akt_2006.asp?func=db&rdir=timetag_web" method="post">
                         ...
                         <%if cint(indlast) = 1 then %>
                           <div class="row">
                               <div class="col-lg-12" style="text-align:center">Timer indlæst</div>
                           </div>
                         <%
                        ...
                        <%if cint(mobil_week_reg_job_dd) = 1 then %>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <select id="dv_job" name="FM_jobid" class="lt_font_size form-control">
                        ...
                        <%if cint(mobil_week_reg_akt_dd) = 1 then %>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <select id="dv_akt" name="FM_aktivitetid" class="lt_font_size form-control"> <!-- DISABLED -->
                                        <option>..</option>
                                    </select>
                                </div>
                            </div>
                        <%else %>
                            <div class="row">
                                <div class="col-lg-12"><input type="text" id="FM_akt" name="activity" value="" placeholder="Aktivitet" class="form-control"/></div>
                            </div>
                            <input type="hidden" id="FM_aktid" name="FM_aktivitetid" value="0"/>
                            <div id="dv_akt" class="dv-closed"></div>
                        <%end if %>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <table width="100%"><tr>
                                            <td style="width:60%;"><input type="text" id="FM_matnavn" name="FM_matnavn" value="Tilføj Materiale" style="width:100%;" class="form-control"/></td> 
                                            <td style="width:20%;"><input type="text" id="FM_matantal" name="FM_matantal" value="Ant." style="width:100%;" class="form-control"/></td>
                                            <td style="width:20%;"><input type="button" value=">>" id="sbmmat" class="btn btn-secondary btn-sm" style="width:100%;" /></td></tr>
                                        </table>
