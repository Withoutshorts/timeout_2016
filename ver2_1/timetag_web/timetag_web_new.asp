...
<script src="js/less.js" type="text/javascript"></script>
        ...
        <div class="container">
            <form action="../timereg/timereg_akt_2006.asp?func=db&rdir=timetag_web" method="post">
            <div class="portlet">
                <h2 class="portlet-title"><u>Timeout mobile</u></h2>
                <div class="portlet-body">


                 <%if cint(indlast) = 1 then %>
                <div class="row">
                    <h4 class="col-lg-12">Timer indlæst</h4>
                </div>               
                 <%
               ...
               <div class="row">
                    <div class="col-lg-12"><input type="text" name="FM_datoer" id="jq_dato" value="<%=day(now) &"/"& month(now) &"/"& year(now) %>" placeholder="dd-mm-yyyy" class="form-control input-small"/></div>
                </div>               
                <%case else%>
                ...
                <%end select %>
                    ...
                    <!-- indtastning af timer -->
                    <div class="row">
                        <div class="col-lg-12"><input type="text" id="FM_job" name="FM_job" value="Kunde/job" class="form-control input-small"/></div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" id="FM_akt" name="activity" value="Aktivitet" class="form-control input-small"/>
                            <input type="hidden" id="FM_aktid" name="FM_aktivitetid" value="0"/>
                        </div>
                    </div>
                    <%if cint(showStop) = 1 then%>
                    <div class="row">
                        <div class="col-lg-2"><button id="bt_stst" class="btn btn-md btn-success"><b>St. / Stop</b></button></div>
                        <div class="col-lg-1"><input type="text" id="FM_sttid" name="FM_sttid" value="00:00" style="color:#cccccc;" class="form-control input-small"/></div>
                        <div class="col-lg-1"><input type="text" id="FM_sltid" name="FM_sltid" value="00:00" style="color:#cccccc;" class="form-control input-small"/></div>
                        <div class="col-lg-1"></div>
                        <div class="col-lg-1">Timer:</div>
                        <div class="col-lg-1"><span id="FM_timerlbl" style="color:#999999;" class="form-control input-small">0</span>
                        <input type="hidden" id="FM_timer" name="FM_timer" value="0" style="color:#cccccc;" class="form-control input-small"/></div>
                    </div>
                    <%else %>
                    <div class="row">
                        <div class="col-lg-12">
                          ...
                          <input type="text" id="FM_timer" name="FM_timer" value="Antal timer" class="form-control input-small"/><!-- brug type number for numerisk tastatur -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <input type="text" id="FM_kom" name="FM_kom_0" value="Kommentar" class="form-control input-small"/>
                        </div>
                    </div>
                    <!-- indtastning af timer slut -->
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <h3 class="panel-title">
                                <a style="font-size:100%" class="accordion-toggle" data-toggle="collapse" data-target="#collapse4">
                                    Tilføj materialeforbrug
                                </a>
                              </h3>
                            </div> <!-- /.panel-heading -->
                            <div id="collapse4" class="panel-collapse collapse">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12"> <input type="text" id="FM_matnavn" name="FM_matnavn" value="Tilføj Materiale" class="form-control input-small"/></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12"><input type="text" id="FM_matantal" name="FM_matantal" value="Antal" class="form-control input-small"/></div>
                                    </div>
                                    <br />
                                    <div class="row">
                                        <div class="col-lg-2"><button id="sbmmat" class="btn btn-md btn-default"><b>Tilføj</b></button></div>
                                    </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                              <h4 class="panel-title">
                                <a style="font-size:100%" class="accordion-toggle" data-toggle="collapse" data-target="#udlaag">
                                    Rejseafregning
                                </a>
                              </h4>
                            </div> <!-- /.panel-heading -->
                            <div id="udlaag" class="panel-collapse collapse">
                                ...
                                <div class="panel-body">                                  
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12"><input type="text" name="" id="" value="Beløb" class="form-control input-small"/></div>
                                    </div>

                                     <div class="row">
                                        <div class="col-lg-12">
                                            <select style="font-size:150%; height:150%" class="form-control input-small">
                                    ...
                                    <div class="row">                                     
                                        <div class="col-lg-12">
                                            <select style="font-size:150%; height:150%" class="form-control input-small">
                                                <option value="v">Ikke fakturabar</option>
                                    ...
                                    <div class="row">                                     
                                        <div class="col-lg-12">
                                            <select style="font-size:150%; height:150%" class="form-control input-small">
                                                <option value="v">Personlig udlæg</option>
                                                <option value="1">Firmabetalt</option>                                             
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button type="submit" id="sbm_timer" class="btn btn-md btn-success" style="width: 100%"><b>Gem registrering >></b></button>
                        </div>
                    </div>
        ...
        <%
            ...
            %>                 
            <div id="" style="font-size:32px; width:100%; text-align:right; border:0px; color:#999999;"><span style="font-size:12px; line-height:13px; vertical-align:baseline; color:#999999;"><%=meNavn %><br />Timer i dag:<br /></span> <a href="../to_2015/ugeseddel_2011.asp?usemrn=<%=session("mid")%>&varTjDatoUS_man=<%=varTjDatoUS_man_tt %>"><%=timerIdag%></a> </div>
            <%
