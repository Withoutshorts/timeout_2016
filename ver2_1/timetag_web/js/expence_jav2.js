...
$(document).ready(function() {
    ...
    $("#sbmExpence").click(function () {
       ...
       //alert("Click3")
        ...
        if (error == 0)
        {        
            $.post("?jq_jobid=" + jq_jobid + "&aktid=" + aktid + "&FM_udlaeg_valuta=" + FM_udlaeg_valuta + "&FM_udlaeg_form=" + FM_udlaeg_form + "&FM_udlaeg_belob=" + FM_udlaeg_belob + "&FM_udlaeg_navn=" + FM_udlaeg_navn + "&FM_udlaeg_gruppe=" + FM_udlaeg_gruppe + "&unikId=" + unikId, { control: "FN_createOutlay", AjaxUpdateField: "true" }, function (data) {
