        ...
        <div class="container" style="height:100%">
            <div class="portlet">
                <div class="portlet-body">
                   ...
                   <!-- <script src="js/imageuploader3.js" type="text/javascript"></script> -->
			        ...
			        <FORM ENCTYPE="multipart/form-data" action="../timereg/upload_udlaeg_bin.asp?pictureName=<%=pictureName %>" METHOD="POST">


                    <table cellspacing="4" cellpadding="2" border="0">
			        <tr>
			        <td>
			        <INPUT id="image-file" NAME="fileupload1" TYPE="file" style="width:400px;"><br><br />
                    ...
                    <input id="submit-file" type="submit" value=" Upload >> " /><br>&nbsp;
                    </td>
                    </tr>
