      ...
      <div class="panel-group accordion-panel" id="accordion-paneled">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a class="accordion-toggle" data-toggle="collapse" data-target="#udlaag">
                        Udlæg
                    </a>
                    </h4>
                </div> 
                <div id="udlaag" class="panel-collapse collapse">
                    ...
                    <div class="panel-body">                                  
                        ...
                        <div class="row">
                            <div class="col-lg-12"><input type="text" name="" id="" value="" placeholder="Antal" class="form-control input-small"/></div>
                        </div>

                        <div class="row">
                            <div class="col-lg-12">
                                <select style="font-size:125%" class="form-control input-small">
                        ...
                        <div class="row">                                     
                            <div class="col-lg-12"><input type="text" id="" name="" value="" placeholder="Type" class="form-control input-small"/></div>
                        </div>
                        <div class="row">                                     
                            <div class="col-lg-12"><input type="text" id="" name="" value="" placeholder="Projekt" class="form-control input-small"/></div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-lg-2"><button id="" class="btn btn-sm btn-default"><b>Tilføj</b></button></div>
                        </div>
