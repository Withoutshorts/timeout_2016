...
<%
    ...
    function MatTest (matregid, otf, medid, jobid, aktid, aftid, matId, strEditor, strDato, intAntal, regdato, valuta, intkode, personlig, bilagsnr, pris, salgspris, navn, gruppe, varenr, opretlager, betegnelse, mat_func, matreg_opdaterpris, matava)

       strSQL = "SELECT jobnavn FROM job WHERE id = "& jobid
            ...
            <div class="portlet">
                ...
                <form id="container" action="../timereg/timereg_akt_2006.asp?func=db&rdir=timetag_web" method="post">
                        ...
                        <div class="panel-group accordion-panel" id="accordion-paneled">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a class="accordion-toggle" data-toggle="collapse" data-target="#udlaag">Tilføj udlæeg id<%=session("mid") %></a></h4>
                                </div> <!-- /.panel-heading -->
                                <div id="udlaag" class="panel-collapse collapse">
                                    ...
                                    <div class="panel-body">                                  
                                       ...
                                       <!-- <form action="timetag_web.asp?func=FN_createOutlay2&FM_jobid=936" method="post"> -->
                                        ...
                                        <form ENCTYPE="multipart/form-data" action="www.google.dk" method="post" id="image_upload">
                                            <INPUT id="image-file" NAME="fileupload1" TYPE="file" style="width:400px;">
                                        </form>
