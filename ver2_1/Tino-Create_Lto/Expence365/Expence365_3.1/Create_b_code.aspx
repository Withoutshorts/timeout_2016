                ...
                <div class="row">
					...
					<!-- Form Wizard -->
                    	<form role="form" runat="server" method="POST">
                    		...
                    		<p>Udfyld alle fælterne forneden før du går vidre til næste side.</p>
						...
						<!-- Form Step 1 -->
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" runat="server" id = "CVRNumber" name="CVR Number" placeholder="CVR Number" class="form-control required"/>
                                </div>
								<div class="form-group">
                    			    <label>EAN Number:</label>
                                    <input type="text"  runat="server" id = "EANNumber" name="EAN Number" placeholder="EAN Number" class="form-control"/>
                                </div>               
                                <div class="form-group">
                    			    <label>Company Phone: <span>*</span></label>
                                    <input type="text" runat="server" id = "CompanyPhone" name="Phone" placeholder="Phone" class="form-control required"/>
                                </div>
						...
						<!-- Form Step 2 -->
                             <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" runat="server" id = "Address" name="Address" placeholder="Address" class="form-control required"/>
                                </div>
								<div class="form-group">
                    			    <label>Company Zip Code: <span>*</span></label>
                                    <input type="text" runat="server" id = "ZipCode" name="Zip Code" placeholder="Zip Code" class="form-control required"/>
                                </div>
								<div class="form-group">
						...
						<!-- Form Step 3 -->
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" runat="server" id = "Email" name="Email" placeholder="Email" class="form-control required"/>
                                </div>
								<div class="form-group">
                    			    <label>Phone: <span>*</span></label>
                                    <input type="text" runat="server" id = "ContactPersonPhone" name="Phone" placeholder="Phone" class="form-control required"/>
                                </div>
